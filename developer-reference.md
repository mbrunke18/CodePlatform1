...
*Last updated: May 26, 2026 (rev 50) | Single source of truth for engineers onboarding to or extending this codebase.*
...
- **Enterprise Pricing Tiers (LOCKED — May 2026):** Three tiers for enterprise buyers — the product capability layer is what differentiates them, NOT relationship depth or support level. Old names (Enterprise / Enterprise Plus / Global) are **RETIRED**. New canonical names:
  ...
  - **Oracle Pro** — $450K/yr — Everything in Core + **Digital Twin simulation** (Shadow Strategy Simulator) + **predictive foresight alerts** — war-gaming responses to triggers that haven't fired yet. This is a product capability tier, not just a support tier.
  - **Enterprise** — $750K–$1.5M/yr — Everything in Oracle Pro + **autonomous evolution network**: protocols that improve in aggregate across every client activation, proprietary compounding dataset. Multi-entity + global deployments.
  ...
  - Any developer writing pricing copy must use Core / Oracle Pro / Enterprise. The word "Global" as a tier name is retired. "Enterprise Plus" is retired.
