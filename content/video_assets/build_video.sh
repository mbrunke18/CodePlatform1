...
# Duration extended to 18.0s (from 10s) to hold for the closing voiceover lines
ffmpeg -y -f lavfi -i "color=c=${NAVY}:s=1920x1080:d=18.0:r=25" -vf "
