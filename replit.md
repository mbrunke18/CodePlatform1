...
- **Playbook Public Access Model:** 3 playbooks are fully public (no auth required): "Aggressive Pricing Disruption", "AI Competitive Disruption", "Compound: Geopolitical + Supply Chain Disruption". All 167 others are locked behind `/pilot-program`. Authenticated users see all 170 with Deploy/Preview actions.
