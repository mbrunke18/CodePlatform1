...
- **Homepage streamlining**: Reduced validation quotes from 15 to 6 (IBM, PwC, Gartner, McKinsey, Accenture, Forrester). Removed redundant "Industry Consensus" banner section. Firm pills updated to match.
