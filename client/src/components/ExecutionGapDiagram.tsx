...
const ExecutionGapDiagram: FC<{ className?: string }> = ({ className = '' }) => (
  ...
  >
    ...
    <text x="240" y="96" textAnchor="middle" fontSize="10" fontWeight="700" letterSpacing="0.12em" fill={RED}
      fontFamily="'Barlow', Arial, sans-serif">TRADITIONAL ENTERPRISE</text>
    <text x="920" y="96" textAnchor="middle" fontSize="10" fontWeight="700" letterSpacing="0.12em" fill={TEAL}
      fontFamily="'Barlow', Arial, sans-serif">READINESS OS</text>
    ...
    <text x="240" y="130" textAnchor="middle" fontSize="11" fontWeight="700" fill={WHITE}
      fontFamily="'Barlow', Arial, sans-serif">STRATEGIC TRIGGER FIRES</text>
    <text x="240" y="148" textAnchor="middle" fontSize="10" fill={GOLD}
      fontFamily="'Barlow', Arial, sans-serif">"Activist investor takes 8% stake"</text>
    <text x="240" y="163" textAnchor="middle" fontSize="9" fill="rgba(255,255,255,0.6)"
      fontFamily="'Barlow', Arial, sans-serif">Board notified. Clock starts.</text>
    ...
    <text x="240" y="262" textAnchor="middle" fontSize="12" fontWeight="700" fill={RED}
      fontFamily="'Barlow', Arial, sans-serif">30 DAYS LATER — STILL FIGURING IT OUT</text>
    <line x1="90" y1="269" x2="390" y2="269" stroke={RED} strokeWidth="1" opacity="0.2" />

    <text x="96" y="288" fontSize="10" fontWeight="600" fill={NAVY} fontFamily="'Barlow', Arial, sans-serif">Who owns this response?</text>
    <text x="96" y="288" fontSize="10" fill={RED} fontFamily="'Barlow', Arial, sans-serif" opacity="0">·</text>
    <text x="96" y="306" fontSize="10" fill="#555" fontFamily="'Barlow', Arial, sans-serif">  → Unclear. Three VPs believe they own it.</text>
    <text x="96" y="324" fontSize="10" fontWeight="600" fill={NAVY} fontFamily="'Barlow', Arial, sans-serif">What are the actual tasks?</text>
    <text x="96" y="342" fontSize="10" fill="#555" fontFamily="'Barlow', Arial, sans-serif">  → Still being debated in committee.</text>
    <text x="96" y="360" fontSize="10" fontWeight="600" fill={NAVY} fontFamily="'Barlow', Arial, sans-serif">What do we communicate, to whom?</text>
    <text x="96" y="378" fontSize="10" fill="#555" fontFamily="'Barlow', Arial, sans-serif">  → Legal review not started. Comms on hold.</text>
    <text x="96" y="396" fontSize="10" fontWeight="600" fill={NAVY} fontFamily="'Barlow', Arial, sans-serif">When does execution begin?</text>
    ...
    <text x="240" y="488" textAnchor="middle" fontSize="11" fontStyle="italic" fill={RED} opacity="0.85"
      fontFamily="'Barlow', Arial, sans-serif">Still scheduling the kickoff meeting.</text>
    <text x="240" y="507" textAnchor="middle" fontSize="10" fontStyle="italic" fill={RED} opacity="0.6"
      fontFamily="'Barlow', Arial, sans-serif">Execution has not started.</text>
    ...
    <text x="240" y="557" textAnchor="middle" fontSize="9" fontWeight="700" letterSpacing="0.14em"
      fill="rgba(255,255,255,0.75)" fontFamily="'Barlow', Arial, sans-serif">WHAT 30 DAYS GETS YOU</text>
    ...
    <text x="240" y="582" textAnchor="middle" fontSize="11" fill="rgba(255,255,255,0.9)"
      fontFamily="'Barlow', Arial, sans-serif">A meeting agenda.</text>
    <text x="240" y="599" textAnchor="middle" fontSize="11" fill="rgba(255,255,255,0.9)"
      fontFamily="'Barlow', Arial, sans-serif">A draft RACI. Unresolved ownership.</text>
    <text x="240" y="616" textAnchor="middle" fontSize="11" fill="rgba(255,255,255,0.9)"
      fontFamily="'Barlow', Arial, sans-serif">No tasks staged. No comms sent.</text>
    <text x="240" y="633" textAnchor="middle" fontSize="13" fontWeight="700" fill={GOLD}
      fontFamily="'Barlow', Arial, sans-serif">Execution hasn't started.</text>
    ...
    <text x="920" y="163" textAnchor="middle" fontSize="9" fill="rgba(255,255,255,0.6)"
      fontFamily="'Barlow', Arial, sans-serif">Readiness OS detects. Readiness Protocol activates.</text>
    ...
    <text x="662" y="302" textAnchor="middle" fontSize="11" fontWeight="700" fill={NAVY}
      fontFamily="'Barlow', Arial, sans-serif">ROLES ASSIGNED</text>
    <line x1="558" y1="309" x2="766" y2="309" stroke="#E8E4DC" strokeWidth="1" />
    <text x="566" y="326" fontSize="9" fill="#555" fontFamily="'Barlow', Arial, sans-serif">Every stakeholder notified.</text>
    <text x="566" y="342" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  CFO — financial exposure lead</text>
    <text x="566" y="357" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  General Counsel — legal strategy</text>
    <text x="566" y="372" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  IR lead — investor comms</text>
    <text x="566" y="387" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Board secretary — filings</text>
    <text x="662" y="406" textAnchor="middle" fontSize="8" fontWeight="700" fill="#999"
      fontFamily="'Barlow', Arial, sans-serif">No ambiguity. No overlap.</text>
    ...
    <text x="920" y="302" textAnchor="middle" fontSize="11" fontWeight="700" fill={NAVY}
      fontFamily="'Barlow', Arial, sans-serif">TASKS STAGED</text>
    <line x1="802" y1="309" x2="1038" y2="309" stroke="#E8E4DC" strokeWidth="1" />
    <text x="810" y="326" fontSize="9" fill="#555" fontFamily="'Barlow', Arial, sans-serif">Full execution sequence ready:</text>
    <text x="810" y="342" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Phase 1 tasks assigned with owners</text>
    <text x="810" y="357" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Dependencies mapped end-to-end</text>
    <text x="810" y="372" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Decision gates pre-configured</text>
    <text x="810" y="387" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Budget pre-authorized</text>
    <text x="920" y="406" textAnchor="middle" fontSize="8" fontWeight="700" fill="#999"
      fontFamily="'Barlow', Arial, sans-serif">Teams already executing.</text>
    ...
    <text x="1178" y="302" textAnchor="middle" fontSize="11" fontWeight="700" fill={NAVY}
      fontFamily="'Barlow', Arial, sans-serif">COMMS DRAFTED</text>
    <line x1="1074" y1="309" x2="1282" y2="309" stroke="#E8E4DC" strokeWidth="1" />
    <text x="1082" y="326" fontSize="9" fill="#555" fontFamily="'Barlow', Arial, sans-serif">All communications ready:</text>
    <text x="1082" y="342" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Board memo drafted</text>
    <text x="1082" y="357" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Investor statement ready</text>
    <text x="1082" y="372" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Internal briefing sent</text>
    <text x="1082" y="387" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Regulatory filing staged</text>
    <text x="1178" y="406" textAnchor="middle" fontSize="8" fontWeight="700" fill="#999"
      fontFamily="'Barlow', Arial, sans-serif">Legal-approved. Ready to send.</text>
    ...
    <text x="920" y="490" textAnchor="middle" fontSize="13" fontWeight="700" fill={WHITE}
      fontFamily="'Barlow', Arial, sans-serif">EXECUTION IS LIVE</text>
    <text x="920" y="510" textAnchor="middle" fontSize="10" fill="rgba(255,255,255,0.85)"
      fontFamily="'Barlow', Arial, sans-serif">Teams moving. Strategy preserved end-to-end.</text>
    ...
    <text x="920" y="566" textAnchor="middle" fontSize="9" fontWeight="700" letterSpacing="0.14em" fill={TEAL}
      fontFamily="'Barlow', Arial, sans-serif">WHAT 12 MINUTES DELIVERS</text>
    <line x1="790" y1="573" x2="1050" y2="573" stroke={TEAL} strokeWidth="1" opacity="0.3" />
    <text x="800" y="591" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Roles assigned across the full org</text>
    <text x="800" y="607" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Tasks staged and already in motion</text>
    <text x="800" y="623" fontSize="9" fill={TEAL} fontFamily="'Barlow', Arial, sans-serif">✓  Communications drafted and approved</text>
    <text x="920" y="641" textAnchor="middle" fontSize="13" fontWeight="700" fill={TEAL}
      fontFamily="'Barlow', Arial, sans-serif">Execution underway.</text>
    ...
    {[
      ...
      <g key={label}>
        ...
        <text x={x} y="726" textAnchor="middle" fontSize="9" fontWeight="700" letterSpacing="0.14em"
          fill="rgba(255,255,255,0.55)" fontFamily="'Barlow', Arial, sans-serif">{label.toUpperCase()}</text>
      </g>
    ))}
