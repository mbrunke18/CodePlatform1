      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <FootballConnectionCallout 
            text="MIT found CIOs expect 25-50%+ efficiency gains from AI within 2 years. Football achieved 360x coordination speed decades ago through systematic playbooks. ExecuteIQ delivers both—AI technology powered by proven football methodology."
