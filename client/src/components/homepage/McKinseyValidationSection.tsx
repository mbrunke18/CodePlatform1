      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button size="lg" asChild data-testid="button-see-demo">
                      <a href="/demo-selector">
                        See How ExecuteIQ Closes the Gap
          ...
          <Card className="bg-primary text-primary-foreground" data-testid="card-four-outcomes-callout">
            <CardContent className="p-8 text-center">
              <h3 className="text-2xl font-bold mb-4">
                ExecuteIQ Delivers McKinsey's Four Outcomes
              </h3>
              <p className="text-lg mb-6 opacity-90">
                ...
                ExecuteIQ is purpose-built to optimize all four.
              </p>
          ...
          <FootballConnectionCallout 
            text="Football coaches close this gap by preparing playbooks before game day and coordinating execution in under 60 seconds. ExecuteIQ brings that proven system to business strategy."
