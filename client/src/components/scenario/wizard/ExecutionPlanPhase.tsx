...
export default function ExecutionPlanPhase({ data, onChange }: ExecutionPlanPhaseProps) {
  ...
  const getPhaseColorClass = (color: string) => {
    const colors: Record<string, string> = {
      ...
      blue: 'border-[#2B8A6E]/50 bg-[#0A0F2E]/20',
    };
            ...
            <CardContent className="p-4">
              <div className="flex items-start gap-3">
                <phase.icon className={`h-5 w-5 mt-0.5 ${
                  selectedPhase === phase.id ? `text-${phase.color}-400` : 'text-gray-800'
                }`} />
                <div className="flex-1">
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1 text-left">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-700">{phase.startMin}-{phase.endMin} minutes</div>
                      </div>
                      <Badge variant="outline" className="text-xs">
                  ...
                  <AccordionContent className="px-4 pb-4">
                    {phaseTasks.length === 0 ? (
                      <p className="text-sm text-gray-800 italic py-2">No tasks added to this phase yet.</p>
                    ) : (
                            ...
                            <div className="flex items-start justify-between gap-3">
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  <span className="text-xs font-mono text-gray-800">#{task.sequence}</span>
                                ...
                                <div className="flex items-center gap-3 mt-2 text-xs text-gray-800">
