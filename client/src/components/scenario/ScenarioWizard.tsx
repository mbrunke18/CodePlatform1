          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <CardDescription className="text-gray-700">
                Build an actionable, executable Readiness Protocol with complete situation capture
              </CardDescription>
            </div>
        ...
        {WIZARD_PHASES.map((phase, index) => {
          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-gray-800 leading-tight">{phase.description}</p>
            </button>
          );
        })}
      </div>
        ...
        <div className="flex items-center gap-3">
          {currentPhaseIndex > 0 && (
            <Button
              variant="outline"
              onClick={handleBack}
              className="border-slate-600 text-gray-800"
