    ...
    <div style={{ fontFamily: "Georgia, serif", maxWidth: 720, margin: "0 auto", padding: "40px 48px", background: "#fff", color: NAVY }}>
      <div style={{ borderBottom: `3px solid ${GOLD}`, paddingBottom: 20, marginBottom: 28 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.3em", textTransform: "uppercase", color: GOLD, marginBottom: 6 }}>Board Activation Report · Confidential</div>
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#9CA3AF" }}>Execution Time</div>
            <div style={{ ...CG, fontSize: 36, fontWeight: 700, color: data.elapsedMinutes <= 12 ? TEAL : GOLD, lineHeight: 1 }}>{data.elapsedMinutes}m</div>
            <div style={{ fontSize: 11, color: "#9CA3AF" }}>Target: 12 minutes</div>
          </div>
        </div>
      </div>

      <div style={{ marginBottom: 24 }}>
        <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: GOLD, marginBottom: 8 }}>01 — Situation</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 24 }}>
        {[
          { icon: "⚡", label: "Readiness Protocol Deployed", value: data.playbookName.split("—")[0].trim() },
          ...
          <div key={item.label} style={{ padding: "12px 14px", background: "#F8F7F4", borderTop: `2px solid ${NAVY}` }}>
            ...
            <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#9CA3AF", marginBottom: 4 }}>{item.label}</div>
      ...
      {data.nextSteps.length > 0 && (
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: GOLD, marginBottom: 10 }}>02 — Recommended Next Steps</div>
      ...
      <div style={{ borderTop: `1px solid #E8E4DC`, paddingTop: 16, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        {data.outcomeRating && (
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: "#9CA3AF" }}>Outcome Rating</span>
