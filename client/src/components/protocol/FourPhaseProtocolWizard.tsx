      ...
      <CardContent>
        <div className="flex items-center justify-between">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-800 mt-1">Overall Score</div>
          </div>
        ...
        <DialogHeader className="p-6 pb-4 border-b">
          <DialogTitle className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-lg">Configure Readiness Protocol: {playbook?.name}</div>
              ...
              <Card className="bg-[#0A0F2E] dark:bg-[#0A0F2E]/30 border-[#E8E4DC] dark:border-[#0A0F2E] p-3 mb-4">
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-[#0A0F2E] dark:text-white">
                    <span className="font-semibold">Pro Tip:</span> Customize each section with your organization's specific context. Readiness OS pre-fills 80%+ of content from best practices.
                  </div>
                </div>
              </Card>
