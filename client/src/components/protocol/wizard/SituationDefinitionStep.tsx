    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          placeholder="Define specific conditions that activate this Readiness Protocol (e.g., 'Competitor launches product with 25% price advantage AND market share drops 5%')"
          rows={4}
