...
export const EXECUTION_STAGES = [
  ...
  },
  {
    ...
    fullDef: 'The playbook generates the full task sequence. Each task is assigned to the correct role based on the pre-configured stakeholder registry. Nothing is sent yet — the deployment is fully staged.',
    inClock: true,
    color: GOLD,
    icon: '📋',
  },
