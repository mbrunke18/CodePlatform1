...
export const EXECUTION_STAGES = [
  {
    number: 1,
    name: 'Triggered',
    shortDef: 'Signal threshold crossed — prepared response pre-staged and system-deployed.',
    fullDef: 'A monitored signal crosses its threshold. The AI evaluation engine selects the matched prepared response and begins automated deployment. No human initiates this step.',
    inClock: true,
    color: GOLD,
    icon: '⚡',
  },
  {
    ...
    fullDef: 'The prepared response generates the full task sequence. Each task is assigned to the correct role based on the pre-configured stakeholder registry. Nothing is sent yet — the deployment is fully staged.',
    inClock: true,
    color: GOLD,
    icon: '📋',
  },
  ...
  },
  {
    ...
    fullDef: 'The assigned work is delivered and verified. The role-holder confirms completion, which triggers any downstream tasks in the playbook. The audit trail is automatically recorded.',
    inClock: false,
    color: '#6B7280',
    icon: '◉',
  },
