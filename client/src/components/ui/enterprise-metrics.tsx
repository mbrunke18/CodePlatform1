              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className={`text-3xl font-bold ${colors.text} mb-2`}>
                    {metric.displayValue}
                    <span className="text-sm text-gray-500 font-normal ml-2">{metric.unit}</span>
                  </div>

                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <span className="text-gray-500">Benchmark Percentile</span>
                      <span className="text-gray-500">{metric.benchmarkPercentile}th</span>
                    </div>
                    <Progress 
