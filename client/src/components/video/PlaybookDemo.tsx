      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 w-full">
        ...
        >
          <div className="flex items-center gap-2 bg-red-500/10 border border-red-500/30 px-3 py-2">
            <span className="text-gray-800">Without Readiness Protocols:</span>
        ...
        >
          ...
          <p className="text-gray-600 text-xs mt-3">Each Readiness Protocol represents weeks of expert strategic planning—ready to deploy instantly</p>
        </motion.div>
      </div>
