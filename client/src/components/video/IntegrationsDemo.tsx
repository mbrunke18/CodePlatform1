    ...
    <div className="relative w-full h-full bg-gradient-to-b from-gray-50 to-white flex items-center justify-center overflow-hidden">
      <div className="relative z-10 max-w-5xl mx-auto px-8 w-full">
        <div className="text-center mb-10">
          ...
          >
            Readiness OS connects to your existing tools
          </motion.p>
        </div>
      ...
      <NarrationBox 
        ...
        description="Readiness OS connects to Jira, Slack, Teams, Salesforce, and more—automatically creating tasks and notifying teams."
        delay={0.5}
      />
    </div>
  );
