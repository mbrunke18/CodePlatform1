  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-b from-gray-50 to-white flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-8">
        ...
        >
          Governance pre-defined. Decision rights clear. 50-200+ stakeholders coordinated instantly. 180 Readiness Protocols ready—including compound situation protocols.
        </motion.div>
      ...
      <NarrationBox 
        ...
        description="Readiness OS provides the coordination infrastructure enterprises are missing—governance, decision rights, and stakeholder orchestration built by design, not by default. 180 Readiness Protocols across 9 domains, including compound situation protocols."
        delay={0.5}
      />
    </div>
  );
