...
const configInfo = {
  ...
  general: {
    ...
    description: 'Complete your Command OS platform setup to unlock full strategic execution capabilities.',
      ...
      <CardContent className="flex items-center justify-between py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Configure Command OS for your organization in under 30 minutes</p>
          </div>
        </div>
