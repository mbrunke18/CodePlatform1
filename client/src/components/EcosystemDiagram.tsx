...
export default function EcosystemDiagram({
  ...
  return (
    <svg
      ...
      aria-label={`Execution OS positioned above the ${ecoName}`}
    >
      <defs>
      ...
      <text x={W / 2} y={H - 18} textAnchor="middle"
        ...
        Execution OS orchestrates the {ecoName} — it doesn't replace it. Human executives retain all decision authority.
      </text>
