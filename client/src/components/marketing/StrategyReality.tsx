    ...
    <section className="min-h-screen flex items-center justify-center bg-white px-4 py-20" data-testid="strategy-reality-hero">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <a href="/demo-hub" className="inline-flex items-center gap-2 text-gray-800 hover:text-white font-medium px-8 py-4 transition-colors" data-testid="link-watch-demo">
            Watch Demo
          </a>
        </motion.div>
      </div>
...
export function StrategyToIDEA() {
  const mapping = [
    ...
    },
    {
      ...
      mPlatform: "Automated debriefs, lessons learned capture, Readiness Protocol refinement",
    },
  ];
