...
const SCENE_NARRATIONS = [
  ...
  "Readiness OS has an 18-month head start. 170 playbooks built. Platform validated with enterprise customers. The moat widens every day.",
              ...
              <div className="text-center max-w-4xl">
                ...
                >
                  ...
                  <p className="text-3xl md:text-4xl font-bold text-[#2B8A6E]">
                    Readiness OS is built for the 90%.
                  </p>
                </motion.div>
                <motion.p
                  initial={{ opacity: 0 }}
