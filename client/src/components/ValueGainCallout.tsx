  ...
  const items: Array<{ mode: ValueGainMode; insight: string; gain: GainSpec }> = [
    {
      mode: "offense",
      insight:
        "Every Readiness Protocol staged here is a competitive position taken before the trigger fires. When the moment arrives, you move. Rivals spend the next 30 days figuring out who needs to be in the room.",
    ...
    },
    {
      mode: "special-teams",
      insight:
        "The decision logic encoded in each Readiness Protocol — who owns what, under what conditions, with what authority — cannot be licensed. Competitors can buy the platform. They cannot buy what your team built inside it.",
