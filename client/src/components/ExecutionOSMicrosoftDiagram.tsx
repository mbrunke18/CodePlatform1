 ...
 * Architecture diagram showing Execution OS as the strategic command layer
...
export default function ExecutionOSMicrosoftDiagram() {
  ...
  return (
    <svg
      ...
      aria-label="Execution OS positioned above the Microsoft Full Stack AI Ecosystem"
    >
      <defs>
        {/* Background gradient */}
      ...
      {/* ── "Execution OS orchestrates" annotation ── */}
      <text x={W / 2} y={H - 18} textAnchor="middle"
        fill={IVORY} fontSize={10} opacity={0.3}
        fontFamily="'DM Mono',monospace" letterSpacing={1}>
        Execution OS orchestrates the Microsoft agentic stack — it doesn't replace it. Human executives retain all decision authority.
      </text>
