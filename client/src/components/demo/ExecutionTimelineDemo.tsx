        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-800 dark:text-gray-200">Target Execution Time</p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r   p-4 border border-green-500/30">
              <div className="grid grid-cols-4 gap-4 text-center">
                <div>
                  ...
                  <div className="text-xs text-gray-800 dark:text-gray-200">Last Execution Time</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-green-400">{plan.historicalPerformance.successRate}%</div>
                  <div className="text-xs text-gray-800 dark:text-gray-200">Success Rate</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-green-400">{plan.historicalPerformance.totalExecutions}</div>
                  <div className="text-xs text-gray-800 dark:text-gray-200">Total Executions</div>
                </div>
                <div>
                  ...
                  <div className="flex items-start justify-between gap-4 mb-2">
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-gray-800 dark:text-gray-200 text-sm mb-2">{task.description}</p>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-center pt-2">
              <div>
                ...
                <div className="text-xs text-gray-800 dark:text-gray-200">Total Tasks</div>
              </div>
              <div>
