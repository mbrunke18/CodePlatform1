        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-200">Target Execution Time</p>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-green-950/50 to-emerald-950/50 rounded-lg p-4 border border-green-500/30">
              <div className="grid grid-cols-4 gap-4 text-center">
                <div>
                  ...
                  <div className="text-xs text-gray-600 dark:text-gray-200">Last Execution Time</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-green-400">{plan.historicalPerformance.successRate}%</div>
                  <div className="text-xs text-gray-600 dark:text-gray-200">Success Rate</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-green-400">{plan.historicalPerformance.totalExecutions}</div>
                  <div className="text-xs text-gray-600 dark:text-gray-200">Total Executions</div>
                </div>
                <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-200">Total Coordinated Response</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center pt-2">
              ...
              <div>
                ...
                <div className="text-xs text-gray-600 dark:text-gray-200">Faster than 72 hours</div>
              </div>
            </div>
          </div>
        </CardContent>
