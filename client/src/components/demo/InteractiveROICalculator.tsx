        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-800">Company Size (Employees)</span>
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-800">Current Crisis Response Time (Hours)</span>
          ...
          <div className="bg-gradient-to-r   p-4 border-2 border-green-500/50">
            <div className="text-center space-y-2">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div>
                  <div className="text-sm text-gray-700">M Execution</div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#0A0F2E]/50 p-4 border border-[#2B8A6E]/30">
              ...
              <div className="text-xs text-[#DFC178] mt-1">
          ...
          <div className="bg-gradient-to-r from-[#0A0F2E]/20 to-teal-600/20 p-4 border border-[#2B8A6E]/30">
            ...
            <ul className="text-xs text-gray-800 space-y-1">
              <li>• <strong className="text-green-400">{mResponseMinutes}-minute Readiness Protocol execution</strong> vs {currentCrisisResponse}-hour industry standard</li>
              ...
              <li>• {(reputationProtection * 100).toFixed(0)}% improvement in brand protection with pre-configured Readiness Protocols</li>
