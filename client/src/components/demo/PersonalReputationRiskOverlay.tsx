...
export function PersonalReputationRiskOverlay() {
  ...
  const scenarios = [
    ...
    },
    {
      ...
      quote: '"Other Fortune 1000s had prepared responses ready. Why didn\'t we?"',
      ...
      <Card className="relative w-[950px] bg-gradient-to-br border-red-500/50 p-8 animate-in zoom-in-95 duration-500">
        <div className="space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-xl text-red-700/90">Weeks later, when the damage is done</p>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-600/30 to-orange-600/30 p-5 border border-red-500/40">
            <div className="text-center space-y-2">
              ...
              <p className="text-red-700/80 text-lg">
                One slow mobilization can destroy it
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-red-300/70 text-sm">
              Readiness OS executives answer these questions with data, not excuses
            </p>
          </div>
        </div>
      </Card>
