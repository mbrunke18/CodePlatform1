      ...
      <Card className="rounded-t-xl rounded-b-none border-t-2 border-x-0 border-b-0 border-blue-500/50 bg-white backdrop-blur-xl shadow-2xl h-full overflow-y-auto">
              ...
              <div className="bg-red-950/30 rounded-lg p-3 border border-red-500/30">
                ...
                <div className="space-y-1">
                  {data.executivePressure.traditional.map((item, idx) => (
                    <p key={idx} className="text-xs text-red-700/90">{item}</p>
                  ))}
                </div>
              </div>
            </div>
        ...
        <div className="px-6 py-3 bg-white border-t border-gray-200">
          <div className="flex items-center justify-between mb-2">
            <p className="text-xs text-gray-700">Crisis Response Progress: {data.title}</p>
            <p className="text-xs font-mono text-gray-700">Step {currentStep + 1} / 6</p>
          </div>
