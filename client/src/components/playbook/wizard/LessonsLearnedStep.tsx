    ...
    <div className="space-y-6">
      <div className="bg-amber-50 dark:bg-amber-950 p-4 border border-amber-200 dark:border-amber-800">
        ...
        <p className="text-xs text-muted-foreground">
          This section is populated AFTER Readiness Protocol execution. Use it to capture institutional knowledge and improve future activations.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="Readiness Protocol-mods">Recommended Readiness Protocol Modifications</Label>
          <Textarea
            id="Readiness Protocol-mods"
      ...
      <Card className="p-4 bg-[#0A0F2E] dark:bg-[#0A0F2E] border-[#E8E4DC] dark:border-[#0A0F2E]">
        <h4 className="font-semibold text-sm mb-2">System Analysis</h4>
        <p className="text-xs text-muted-foreground">
          After you complete lessons learned, Readiness OS will analyze patterns across all executions to generate:
        </p>
        <ul className="text-xs text-muted-foreground mt-2 space-y-1 list-disc list-inside">
          <li>Automated Readiness Protocol optimization suggestions</li>
          <li>Cross-Readiness Protocol pattern detection</li>
