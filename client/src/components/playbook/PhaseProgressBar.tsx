  ...
  return (
    <div className="space-y-3" data-testid="phase-progress-full">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-medium text-slate-400 dark:text-slate-300">IDEA Framework Progress</span>
      </div>
        ...
        {phases.map((phase) => (
          ...
          >
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-medium text-slate-400 dark:text-slate-300">{phase.score}%</span>
                {phase.score === 100 ? (
