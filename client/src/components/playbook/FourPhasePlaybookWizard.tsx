              ...
              <Card className="bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-900 p-3 mb-4">
                <div className="flex gap-2">
                  ...
                  <div className="text-sm text-blue-900 dark:text-blue-100">
                    <span className="font-semibold">Pro Tip:</span> Customize each section with your organization's specific context. ExecuteIQ pre-fills 80%+ of content from best practices.
                  </div>
                </div>
              </Card>
