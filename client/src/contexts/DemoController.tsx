...
const personaNarrations = {
  ceo: {
    intro: 'Welcome to Execution OS. Let me show you how CEOs use executive triggers to detect crises days before competitors. You\'ll see a supplier disruption crisis simulation - the same scenario that traditionally takes 72 hours to coordinate. In Execution OS, it executes in 12 minutes. First, I\'ll show you the Crisis Response Center where you\'ll see an active crisis alert.',
    ...
    execution: 'The countdown timer shows 9 minutes elapsed. Tasks are completing in real-time - green checkmarks show finished items. Traditional crisis response takes 72 hours because of sequential coordination delays. Execution OS eliminates those delays by giving everyone their playbook simultaneously. Notice how different departments see different tasks - that\'s role-based playbook distribution. Every stakeholder knows exactly what to do.',
