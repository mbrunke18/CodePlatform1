...
const PHASE_1_STEPS = [
  ...
  { id: 'Readiness Protocols', title: 'Priority Readiness Protocols', subtitle: 'Select your highest-priority scenarios', icon: Layers },
];
  ...
  return (
    ...
    <div style={{ background: OFF, fontFamily: "'Barlow', sans-serif", fontWeight: 500 }}>
      ...
      <div style={{ background: NAVY, padding: "0 48px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 860, margin: "0 auto", padding: "40px 0 36px" }}>
          ...
          <p style={{ fontSize: 14, fontWeight: 400, color: "rgba(255,255,255,0.5)", marginBottom: 32, maxWidth: 560 }}>
            This session takes about 20 minutes. We'll configure your org profile, map your IDEA framework, and select your priority Readiness Protocols. Integration and activation happen over weeks 1–4 with your implementation team.
          </p>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "48px 48px 120px" }}>
          ...
          <div>
                ...
                <Select value={ideaData.budgetThreshold} onValueChange={v => setIdeaData({ ...ideaData, budgetThreshold: v })}>
                  ...
                  <SelectContent>
                    {['50000', '100000', '250000', '500000', '1000000'].map(t => (
                      <SelectItem key={t} value={t}>${parseInt(t).toLocaleString()} per Readiness Protocol activation</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </Field>
            ...
            <div style={{ display: "flex", gap: 24 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flex: 1, padding: "14px 18px", background: "#fff", border: `1px solid ${BORDER}` }}>
                <div>
                  <div style={{ fontSize: 13, fontWeight: 700, color: NAVY }}>Require human approval before Readiness Protocol activation</div>
        ...
        {/* STEP 3: Priority Readiness Protocols */}
        {currentStep === 2 && (
          <div>
              ...
              {PLAYBOOK_OPTIONS.map(pb => {
                ...
                return (
                  <button key={pb.name} onClick={() => setPlaybookData({ ...playbookData, selected: active ? playbookData.selected.filter(p => p !== pb.name) : [...playbookData.selected, pb.name] })}
                    ...
                    <div style={{ fontSize: 11, color: MUTED }}>{pb.count} Readiness Protocols</div>
                  </button>
                );
              })}
            </div>
...
function JourneyView({ onBegin, onSkip }: { onBegin: () => void; onSkip: () => void }) {
  const PHASES = [
    ...
    },
    {
      ...
      items: [
        "First practice drill — full Readiness Protocol simulation",
...
function CompleteView({ orgName, onGo }: { orgName: string; onGo: () => void }) {
  const MILESTONES = [
    ...
    { week: "Week 3–4", title: "First drill & go-live", desc: "Run your first simulated Readiness Protocol activation with your team. Readiness audit. Executive sign-off. You're live.", icon: TrendingUp, color: NAVY, status: "upcoming" },
  ];
    ...
    <div style={{ minHeight: "100vh", background: OFF, fontFamily: "'Barlow', sans-serif", fontWeight: 500 }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "64px 48px" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32 }}>
            <div>
              ...
              <p style={{ fontSize: 13, fontWeight: 400, color: "rgba(255,255,255,0.5)", lineHeight: 1.7, maxWidth: 420 }}>
                Explore your execution console with sample data loaded. See how Readiness Protocol activation works, review your IDEA framework layout, and prepare your team for go-live.
              </p>
            </div>
            <button
              onClick={onGo}
        ...
        <p style={{ fontSize: 12, color: MUTED, textAlign: "center" }}>
          Questions? Contact your support team at <strong style={{ color: NAVY }}>support@vaughnmartin.com</strong>
        </p>
      </div>
    </div>
  );
