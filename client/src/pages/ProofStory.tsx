      ...
      <div className="ps-body" style={{ background: "#fff", ...DM }}>
                ...
                {[
                  {
                    ...
                    beyond: "Detects the trigger itself — no human required to initiate. Continuous monitoring across 231 signal patterns fires the notification before anyone reports it."
                  },
                  {
        ...
        <div style={{ background: NAVY, padding: "64px 48px", textAlign: "center" }}>
          <div style={{ maxWidth: 680, margin: "0 auto" }}>
            ...
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.28)", maxWidth: 560, margin: "32px auto 0", lineHeight: 1.6, fontStyle: "italic" }}>
