        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px" }}>
          ...
          <div style={{ marginTop: 32, display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
            {[
              ...
              { label: "Readiness OS (Founding Partner)", cost: "$75K/yr entry", outcome: "180 protocols pre-staged. 221 triggers monitored. 12-minute execution. ADVANCE 2.0 compounding. Executive authority preserved.", verdict: "Platform" },
            ].map((alt, i) => (
