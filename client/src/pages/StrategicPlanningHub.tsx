        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 10 }}>
            {[
              ...
              { label: "Risk Exposure", value: `${portfolioMetrics.riskExposure}%`, sub: "Mitigated via Readiness Protocol automation", icon: Shield, accent: GOLD, tag: "MONITORED", cls: 'sph-tile-5' },
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="planning" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                { title: "Scenario Builder", desc: "Model strategic situations and define response Readiness Protocols with system-guided prompts", icon: Lightbulb, accent: GOLD, tag: "SIGNAL-BASED", path: "/simulation-studio" },
