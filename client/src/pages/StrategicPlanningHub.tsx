        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="planning" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                { title: "Scenario Builder", desc: "Model strategic situations and define response Readiness Protocols with AI-guided prompts", icon: Lightbulb, accent: GOLD, tag: "SIGNAL-BASED", path: "/simulation-studio" },
