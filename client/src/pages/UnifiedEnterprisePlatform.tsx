...
export default function UnifiedEnterprisePlatform() {
  ...
  const metrics = [
    ...
    { name: "Readiness Protocol Readiness", value: "98.7%", change: "+0.8%", color: "text-[#C9A84C]" },
  ...
  // Executive Readiness Protocols (formerly Crisis Templates)
  ...
  const collaborationData = {
    ...
    recentActivity: [
      ...
      { user: "VP Operations", action: "updated Readiness Protocol execution protocol", time: "5 minutes ago" },
        ...
        <div className="w-full max-w-none space-y-3 h-full flex flex-col">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">Where Strategy Meets Readiness™ — Situational Readiness Platform</p>
                </div>
              </div>
            ...
            <Card className="border-[#C9A84C]/30 bg-white dark:bg-white/5 hover:border-[#C9A84C]/50 transition-all shadow-none">
              ...
              <CardContent className="p-3 pt-0">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-[#6B7280]">47 Readiness Protocols</span>
              ...
              <CardContent className="p-3 pt-0">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-[#2B8A6E] font-semibold">3,600× Execution Head Start</span>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full flex-1 flex flex-col min-h-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 bg-[#F8F7F4] dark:bg-white/5 border border-[#0A0F2E]/30">
                      ...
                      <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-lg text-[#6B7280]">Readiness Protocols</span>
                      </div>
                      <div className="mt-2 flex items-center gap-1">
            ...
            <TabsContent value="crisis" className="flex-1 overflow-y-auto p-3 space-y-3" data-testid="crisis-content">
              {/* Executive Readiness Protocol Control Panel */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <Card className="border-gray-200 bg-white backdrop-blur-sm">
                  <CardHeader>
                    <CardTitle className="text-gray-900">Executive Readiness Protocols Library</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3">
