            ...
            <div style={{ background: isLive ? TEAL : NAVY, padding: '24px 22px', marginBottom: 16 }}>
              ...
              <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.55)', lineHeight: 1.65, marginBottom: 20 }}>
                {isLive
                  ...
                  : 'Complete the critical items across all four phases to activate the 12-minute execution target.'}
              </div>
              {!isLive && (
        ...
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[
                { session: 'Session 1', title: 'Map Your Unintended Situations', desc: 'Identify the 10–15 strategic situations most likely to fire in your industry this year that are not currently on your roadmap. Use the 231-trigger library as your starting point.', cta: 'Open Protocol Library →', href: '/playbooks', color: GOLD },
