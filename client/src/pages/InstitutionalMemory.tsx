...
const DEMO_OUTCOMES = [
  {
    ...
    decisionDescription: 'Activated Readiness Protocol #12 for Day 1 Integration of $2.3B CloudTech acquisition. 45 stakeholders coordinated in 11 minutes 47 seconds. All regulatory filings submitted ahead of deadline.',
    lessonsLearned: 'Early stakeholder tier mapping (5-tier vs 3-tier) reduced communication bottlenecks by 62%. Dual-sign budget authority for >$500K prevented approval delays. Recommend adding acquired-company leadership to Tier 2 by default in future M&A Readiness Protocols.',
    date: 'Jan 28, 2026',
    domain: 'M&A',
  ...
  },
  {
    ...
    outcomeType: 'successful',
    decisionDescription: 'Critical cybersecurity incident at 2:17 AM. Readiness Protocol #31 activated via automated trigger from AWS CloudWatch + CrowdStrike Falcon. 47 production servers isolated in 45 seconds. Full recovery achieved from clean backups with 4-hour RPO.',
    lessonsLearned: 'Auto-isolation rule triggered 3 minutes faster than manual approval would have. VPN monitoring trigger should be added to detect credential compromise earlier. Phishing response Readiness Protocol now cross-linked for upstream prevention.',
    date: 'Feb 3, 2026',
  ...
  },
  {
    ...
    outcomeType: 'successful',
    decisionDescription: 'Competitor launched rival product 6 weeks ahead of their announced timeline. Signal detected via social media monitoring and patent filing analysis. Readiness Protocol #45 activated for accelerated feature release and customer retention campaign.',
  ...
  },
  {
    ...
    decisionDescription: 'EU regulatory body announced surprise audit with 72-hour preparation window. Readiness Protocol #67 activated for compliance readiness sprint. 28 tasks distributed across Legal, IT, and Compliance teams.',
  ...
  },
  {
    ...
    outcomeType: 'successful',
    decisionDescription: 'Critical supplier in Taiwan experienced production halt due to natural disaster. Signal detected via supply chain monitoring API. Readiness Protocol #52 activated backup supplier network across 3 alternate regions within 12 minutes.',
...
const DEMO_PATTERNS = [
  ...
  },
  {
    ...
    category: 'Readiness Protocol Design',
    title: 'Auto-Isolation Rules Cut Cyber Incident Damage by 78%',
    description: 'Readiness Protocols with automated network isolation rules (triggered within 60 seconds of detection) reduced data exposure by 78% compared to manual-approval workflows. The 3-minute gap between auto and manual represents critical damage window in ransomware scenarios.',
    confidenceLevel: '96%',
  ...
  },
  {
    ...
    description: 'Auto-creating Jira boards with pre-populated tasks and assignments during Readiness Protocol execution saves an average of 4.2 hours per incident compared to manual project creation. Teams using auto-sync report 92% task visibility within the first hour.',
    confidenceLevel: '91%',
    impactScore: 'Medium',
    dataPoints: 89,
  },
  {
    ...
    description: 'Organizations with pre-approved emergency budget thresholds (auto-approve below threshold, dual-sign above) execute financial aspects of Readiness Protocols 34% faster. Sweet spot: auto-approve up to $100K, dual-sign $100K-$1M, board approval above $1M.',
    confidenceLevel: '87%',
    impactScore: 'High',
    dataPoints: 112,
  },
  {
    ...
    description: 'Readiness Protocols that capture lessons learned and auto-update detection thresholds show 18% improvement in execution speed on subsequent activations. Organizations conducting reviews within 48 hours capture 3x more actionable insights than those reviewing after 1 week.',
    confidenceLevel: '82%',
    impactScore: 'Medium',
    dataPoints: 67,
  },
...
const DEMO_KNOWLEDGE = [
  {
    ...
    domain: 'M&A',
    title: 'Day 1 Integration Communication Readiness Protocol',
  ...
  },
  {
    ...
    summary: 'In the Feb 3 ransomware incident, the initial compromise occurred 72 hours before detection via a phishing email targeting VPN credentials. Current monitoring missed the lateral movement because VPN session monitoring was not integrated with SIEM. Remediation: Added VPN anomaly detection to detection thresholds in all cybersecurity Readiness Protocols.',
    applicability: 'All cybersecurity incident Readiness Protocols',
  ...
  },
  {
    ...
    applicability: 'All RISK & RESILIENCE domain Readiness Protocols',
  ...
  },
  {
    ...
    applicability: 'All regulatory compliance Readiness Protocols',
  ...
  },
  {
    ...
    applicability: 'Supply chain and operations Readiness Protocols',
  ...
  },
  {
    ...
    applicability: 'All AI Governance domain Readiness Protocols',
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#2B8A6E]/70">Avg improvement per Readiness Protocol iteration</p>
              </div>
            </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#C9A84C]/70">Insights applied to active Readiness Protocols</p>
              </div>
            </div>
        ...
        <Card className="border-[#E8E4DC] bg-white dark:bg-white/5 dark:border-white/10">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#0A0F2E] dark:text-white" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              ...
              Readiness Protocols Improved From Learnings
            </CardTitle>
          </CardHeader>
          <CardContent>
