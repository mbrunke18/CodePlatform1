...
const LAYERS = [
  {
    ...
    color: GOLD,
    desc: "39 pre-configured signal sources active from day one — zero setup required. Each incoming signal is scored against 231 detection threshold templates using weighted keyword matching and domain classification. The evaluation engine accepts any additional source an enterprise wants to connect.",
    details: [
  ...
  },
  {
    ...
    color: TEAL,
    desc: "When a detection threshold fires, the system resolves the appropriate Readiness Protocol from a library of 180 single-domain and 30 compound protocols. Compound protocols coordinate simultaneous multi-domain response.",
    details: [
      ...
      { label: "Detection thresholds", value: "231 named detection threshold templates. Each template maps to 1–4 primary protocols and includes escalation logic" },
      ...
      <div style={{ background: NAVY, padding: "80px 32px 64px", textAlign: "center" }}>
        <div style={{ maxWidth: 820, margin: "0 auto" }}>
          ...
          <div style={{ display: "inline-flex", gap: 2 }}>
            {["231 detection thresholds", "180 Readiness Protocols", "12-minute execution", "Microsoft-native"].map(tag => (
            ...
            {[
              {
                ...
                role: "Readiness OS primary layer — 180 pre-staged Readiness Protocols across 231 detection thresholds. 12-minute response replaces 30-day mobilization cycle.",
                highlight: true,
                color: GOLD,
              },
              {
