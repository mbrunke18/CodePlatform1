    ...
    <div style={{ minHeight: '100vh', background: '#F8F7F4', fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      <div className="print-page" ref={printRef} style={{ maxWidth: 900, margin: '40px auto', padding: '0 24px 60px' }}>
        ...
        <div style={{ background: NAVY, borderRadius: 0, padding: '36px 40px', marginBottom: 28, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', gap: 40, alignItems: 'center', flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: 220 }}>
              <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: 3, textTransform: 'uppercase', color: GOLD, marginBottom: 12 }}>VaughnMartin Readiness OS</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 12, marginBottom: 28 }}>
          ...
          <StatCard label="Readiness Protocols Activated" value={d.activationCount} icon={BookOpen} color={NAVY} sub="Across all execution events" />
        ...
        <div style={{ textAlign: 'center', marginTop: 40, fontSize: 11, color: '#bbb' }}>
          VaughnMartin Readiness OS · Confidential · Generated {generatedDate} · execution-os.vaughnmartin.com
        </div>
      </div>
    </div>
  );
