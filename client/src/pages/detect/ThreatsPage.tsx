...
const THREATS = [
  ...
  },
  {
    ...
    playbook: 'Regulatory Response Readiness Protocol',
    status: 'monitoring',
  },
  {
    id: 4,
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 14, color: MUTED, marginTop: 6 }}>
            Real-time strategic threat identification across 248+ monitored data points — 9 strategic domains
          </p>
        </div>
        ...
        <div style={{ marginTop: 14, display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <span style={{ fontSize: 11, color: MUTED }}>
            Each detected threat maps directly to a pre-built response Readiness Protocol across 9 strategic domains. Target: roles assigned, tasks staged, communications sent — execution live in 12 minutes.
          </span>
        </div>
      </div>
    </IDEALayout>
