        ...
        {currentPhase === 'select' && (
          <>
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold mb-2">Experience Readiness OS</h1>
              <p className="text-muted-foreground text-lg">
                Choose a crisis scenario and watch Readiness OS transform chaos into coordinated execution
              </p>
            </div>
                  ...
                  {showChaosComplete && (
                    <div className="flex-1 space-y-3">
                      ...
                      >
                        ...
                        Now See Readiness OS in Action
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="p-4 bg-[#0A0F2E] dark:bg-[#C9A84C]/10 border border-[#C9A84C] dark:border-[#C9A84C]/30">
                        <h4 className="font-medium mb-3">Readiness Protocol: {selectedScenario.playbook}</h4>
                      ...
                      <Button className="w-full bg-[#0A0F2E] hover:bg-[#141B45] text-white" onClick={completeIdentify}>
                        Readiness Protocol Ready - Continue to Detection
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                    </CardContent>
                  </Card>
                      ...
                      {currentPhase === 'identify' && (
                        <>
                          ...
                          <div className="p-3 bg-background">
                            ...
                            <p className="text-xs text-muted-foreground">180 Readiness Protocols across 9 strategic domains. Customize any or build your own.</p>
                          </div>
                        </>
                      )}
                      {currentPhase === 'detect' && (
                        <>
                          <p className="text-muted-foreground">AI pattern matching identifies triggers and recommends the right Readiness Protocol. Human executives make the final call.</p>
                          <div className="p-3 bg-background">
