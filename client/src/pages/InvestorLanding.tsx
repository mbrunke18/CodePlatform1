        ...
        <section className="py-20 px-6 text-white relative overflow-hidden bg-[#0A0F2E]">
          ...
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            ...
            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-4xl mx-auto" data-testid="text-description">
              Fortune 1000 companies spend $847B annually on strategic initiatives—83% fail due to execution gaps. Execution OS creates a new software category worth $127B TAM, delivering 340x faster strategic execution from signal detection to coordinated response in 12 minutes.
            </p>
