...
const COMPARISON_ROWS = [
  { dimension: "Cost", consulting: "$300K–$500K one-time", executionOs: "$150K–$450K/year · $75K Founding Partner entry" },
...
export default function VsConsulting() {
  ...
  useEffect(() => {
    updatePageMetadata({
      ...
      description: "McKinsey charges $300K–$500K for Readiness Protocols that sit on a shelf. Readiness OS delivers 180 live, executable Readiness Protocols starting at $150K/year — with 12-minute activation, continuous signal monitoring, and a $75K Founding Partner entry credited 100% to Year 1.",
        ...
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
            ...
            <div style={{ border: `2px solid ${GOLD}`, borderRadius: 0, padding: "36px 32px", background: `rgba(201,168,76,0.03)`, textAlign: "center" as const }}>
              ...
              <div style={{ ...CG, fontSize: 42, fontWeight: 600, color: NAVY, marginBottom: 8 }}>$150K–$450K/year</div>
