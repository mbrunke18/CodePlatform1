          ...
          <div style={{ marginTop: "1.5rem", border: "1px solid #E2DDD5", padding: "1.75rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 0 }}>
              {[
                ...
                { q: "Is this an autonomous AI agent?", a: "No. Readiness OS is a human-authorized execution platform. The system monitors signals, detects trigger patterns, and orchestrates pre-staged protocols — but every execution decision is made by a human executive. The value is preparation speed, not autonomous action. We compress the mobilization cycle to 12 minutes; the decision to act remains exclusively with your leadership team." },
