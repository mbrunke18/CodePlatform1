...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Audit Trail", detail: "All system-analyzed recommendations logged with model, timestamp, and confidence score" },
    ],
  },
];
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "3rem 2rem" }}>
          ...
          <div style={{ marginTop: "1.5rem", border: "1px solid #E2DDD5", padding: "1.75rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 0 }}>
              {[
                { q: "Can the AI take action without human approval?", a: "No. Readiness OS uses continuous monitoring and pattern detection to identify triggers and stage responses — but the system cannot execute autonomously. Every Readiness Protocol requires explicit executive sign-off. Until that authorization is received, no budget unlocks, no tasks seed, and no stakeholders are notified. The architecture is explicitly human-in-the-loop by design, not as a safety bolt-on." },
                { q: "What AI guardrails are in place?", a: "Three layers of guardrails govern every activation. First, ConsequencePreview: before any executive authorizes, the platform displays the full execution impact — tasks, budget, and stakeholders — so the decision is fully informed. Second, Stand Down authority: any designated executive can halt execution at any point. Third, fail-closed authorization: any error in role validation defaults to deny, never permit. The system cannot proceed past a guardrail failure." },
                { q: "Is this an autonomous AI agent?", a: "No. Readiness OS is a human-authorized execution platform. The system monitors signals, detects situations forming, and orchestrates pre-staged protocols — but every execution decision is made by a human executive. The value is preparation speed, not autonomous action. We compress the mobilization cycle to 12 minutes; the decision to act remains exclusively with your leadership team." },
