  ...
  return (
    <div className="page-background min-h-screen bg-white text-gray-900">
          ...
          <div className="flex gap-4">
            ...
            {!executionId && (
              <Button
                ...
                size="lg"
                className="bg-[#0A0F2E] text-white hover:bg-[#141B45] text-xl px-8 py-6"
      ...
      {!executionId && (
        <div className="max-w-7xl mx-auto mb-8">
          <Card className="bg-white border-[#E8E4DC]">
            <CardHeader>
              <CardTitle className="text-4xl text-center flex items-center justify-center gap-3 text-[#0A0F2E]">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 page-background">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-300 mb-3">
                  Notice: Execution OS is coordinating stakeholders, but humans are making all decisions.
                </p>
                <ul className="space-y-1 text-sm text-slate-700 dark:text-slate-300">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2B8A6E] flex-shrink-0" />
                ...
                <p className="text-sm font-semibold text-[#0A0F2E] dark:text-[#0A0F2E] mt-3">
      ...
      {executionId && demoPhase === 'threshold' && (
        <Card className="max-w-7xl mx-auto mb-8 border-2 border-[#2B8A6E] bg-[#2B8A6E]/5 dark:bg-[#2B8A6E]/20 animate-in fade-in slide-in-from-top duration-500" data-testid="card-threshold-message">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <Shield className="w-6 h-6 text-[#2B8A6E] flex-shrink-0" />
              <div>
                <p className="font-semibold text-sm text-[#0A0F2E] dark:text-[#2B8A6E]/20">
          ...
          <CardHeader>
            <CardTitle className="flex items-center justify-between text-3xl text-slate-900 dark:text-white">
              <span className="flex items-center gap-2">
                <Users className="h-10 w-10 text-[#0A0F2E] dark:text-[#0A0F2E]" />
            ...
            <p className="text-gray-800 dark:text-slate-300 text-lg mt-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3" data-testid="grid-stakeholders">
              {STAKEHOLDER_ROSTER.map((stakeholder) => {
                ...
                const priorityColors = {
                  ...
                  High: 'border-[#C9A84C]/40 bg-[#C9A84C]/10 dark:border-[#C9A84C]/50 dark:bg-[#C9A84C]/20',
                  Medium: 'border-[#C9A84C]/30 bg-[#C9A84C]/5 dark:border-[#C9A84C]/40 dark:bg-[#C9A84C]/10'
                };
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex-1 page-background min-w-0">
                        <div className={`font-semibold text-sm ${isAcknowledged ? 'text-[#2B8A6E]' : 'text-slate-900 dark:text-white'} truncate`}>
                          {stakeholder.name}
                        </div>
                        <div className={`text-xs ${isAcknowledged ? 'text-[#2B8A6E]/80' : 'text-gray-800 dark:text-slate-300'} truncate`}>
                          {stakeholder.role}
                        </div>
                        <div className="text-xs text-gray-800 dark:text-slate-300 truncate">
                    ...
                    <Badge 
                      variant="outline" 
                      className={`text-xs ${
                        stakeholder.priority === 'Critical' ? 'border-red-500 text-red-500' :
                        stakeholder.priority === 'High' ? 'border-[#C9A84C] text-[#C9A84C]' :
                        'border-[#C9A84C]/70 text-[#C9A84C]/70'
                      }`}
                    >
      ...
      {demoPhase === 'complete' && (
        <div className="max-w-7xl mx-auto mb-8">
          <Card className="bg-white border-[#2B8A6E]/30 overflow-hidden">
            <CardContent className="p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                <Card className="bg-gray-50 border-[#2B8A6E]/30">
                  <CardContent className="p-6 text-center">
                    <Clock className="h-12 w-12 text-[#2B8A6E] mx-auto mb-3" />
                    <div className="text-6xl font-bold text-[#2B8A6E] mb-2" data-testid="text-final-time">
                      {finalMetrics.coordinationTime}
                    </div>
                    <div className="text-xl text-gray-800">Coordination Time</div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-50 border-[#2B8A6E]/30">
                  <CardContent className="p-6 text-center">
                    <Users className="h-12 w-12 text-[#0A0F2E] mx-auto mb-3" />
                    <div className="text-6xl font-bold text-[#0A0F2E] mb-2" data-testid="text-final-acks">
                      {finalMetrics.stakeholdersAcknowledged}/{finalMetrics.stakeholdersNotified}
                    </div>
                    <div className="text-xl text-gray-800">Acknowledged</div>
                  </CardContent>
                </Card>

                <Card className="bg-gray-50 border-[#2B8A6E]/30">
                  <CardContent className="p-6 text-center">
                    <Target className="h-12 w-12 text-[#C9A84C] mx-auto mb-3" />
                    <div className="text-6xl font-bold text-[#C9A84C] mb-2" data-testid="text-final-rate">
                      {finalMetrics.acknowledgmentRate}%
                    </div>
                    <div className="text-xl text-gray-800">Success Rate</div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-50 border-[#2B8A6E]/30">
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="text-xl text-gray-800">Avg Response</div>
                  </CardContent>
                </Card>
              </div>

              {/* The Execution OS Advantage - Before/After */}
                ...
                <CardContent className="p-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="text-center p-6 bg-red-900/30 rounded-lg border-2 border-red-500/50">
                      <div className="text-lg text-red-300 mb-3 font-semibold">WITHOUT Execution OS</div>
                      <div className="text-7xl font-bold text-red-400 mb-3" data-testid="text-without-vexor">
                        48-72h
                      </div>
                      <div className="text-xl text-gray-800 dark:text-slate-200">Traditional coordination</div>
                      <div className="text-lg text-gray-800 mt-2">Email chains, meetings, delays</div>
                    </div>
                    ...
                    <div className="text-center p-6 bg-[#2B8A6E]/20 rounded-lg border-2 border-[#2B8A6E]/30">
                      <div className="text-lg text-[#2B8A6E]/80 mb-3 font-semibold">WITH Execution OS</div>
                      <div className="text-7xl font-bold text-[#2B8A6E] mb-3 animate-pulse" data-testid="text-with-vexor">
                        {finalMetrics.coordinationTime}
                      </div>
                      <div className="text-xl text-gray-800 dark:text-slate-200">Strategic velocity</div>
                      <div className="text-lg text-[#2B8A6E] mt-2 font-semibold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <Card className="bg-gradient-to-br   border-[#0A0F2E]/50">
                  <CardContent className="p-8 text-center">
                    <Clock className="h-16 w-16 text-[#0A0F2E] mx-auto mb-4" />
                    <div className="text-5xl font-bold text-[#0A0F2E] mb-3" data-testid="text-time-saved">
                      {finalMetrics.timeSavedHours.toFixed(1)} hours
                    </div>
                    <div className="text-2xl text-gray-800">Time Saved</div>
                  </CardContent>
                </Card>

                <Card className="bg-gradient-to-br   border-[#2B8A6E]/30">
                  <CardContent className="p-8 text-center">
                    <DollarSign className="h-16 w-16 text-[#2B8A6E] mx-auto mb-4" />
                    <div className="text-5xl font-bold text-[#2B8A6E] mb-3" data-testid="text-value-saved">
                      ${finalMetrics.valueSaved.toLocaleString()}
                    </div>
                    <div className="text-2xl text-gray-800">Executive Time Value</div>
                  </CardContent>
                </Card>

                <Card className="bg-gradient-to-br   border-[#C9A84C]/50">
                  <CardContent className="p-8 text-center">
                    <TrendingUp className="h-16 w-16 text-[#C9A84C] mx-auto mb-4" />
                    <div className="text-5xl font-bold text-[#C9A84C] mb-3" data-testid="text-velocity">
                      {finalMetrics.velocityMultiplier}x Faster
                    </div>
                    <div className="text-2xl text-gray-800">Strategic Velocity</div>
                  </CardContent>
                </Card>
              </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-3 border-gray-200">
            <CardContent className="p-12">
              <div className="text-center">
                <div className="flex items-center justify-center gap-4 mb-6">
                  <Clock className="h-16 w-16 text-[#0A0F2E]" />
                  <div>
                    <div className="text-8xl font-bold font-mono tracking-tight" data-testid="text-elapsed-time">
                      {formatTime(elapsedTime)}
                    </div>
                    <div className="text-2xl text-gray-800 dark:text-slate-200 mt-2">
          ...
          <Card className="bg-gray-50 border-gray-200">
            ...
            <CardContent>
              <div className="text-6xl font-bold text-[#0A0F2E]" data-testid="text-ack-count">
                {acknowledgments.length}
              </div>
              <div className="text-xl text-gray-800 dark:text-slate-200 mt-2">
          ...
          <Card className="bg-gray-50 border-gray-200">
            ...
            <CardContent>
              <div className="text-6xl font-bold text-[#2B8A6E]" data-testid="text-progress">
                {progress.toFixed(0)}%
              </div>
              <div className="text-xl text-gray-800 dark:text-slate-200 mt-2">
                of target reached
          ...
          <Card className="lg:col-span-3 bg-gray-50 border-gray-200">
            <CardHeader>
              <CardTitle className="flex items-center justify-between text-2xl">
                <span className="flex items-center gap-2">
                  <Activity className="h-8 w-8 text-[#0A0F2E]" />
            ...
            <CardContent>
              <div className="space-y-3 max-h-[500px] overflow-y-auto" data-testid="feed-timeline">
                {!executionId && (
                  <div className="text-center py-12 text-gray-800 dark:text-slate-200 text-xl">
                ...
                {executionId && DEMO_SCENARIO.tasks.map((task) => {
                  ...
                  const getColor = () => {
                    if (task.type === 'milestone') return 'text-[#C9A84C] bg-[#C9A84C]/30 border-[#C9A84C]/50';
                    if (task.type === 'system') return 'text-[#2B8A6E] bg-[#2B8A6E]/30 border-[#2B8A6E]/50';
                    return 'text-[#0A0F2E] bg-[#0A0F2E]/30 border-[#0A0F2E]/50';
                  };
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        {isExecuted && (
                          <CheckCircle2 className="h-6 w-6 text-[#2B8A6E] flex-shrink-0" />
                        )}
                      </div>
                    </div>
                  );
                ...
                {acknowledgments.map((ack, index) => (
                  ...
                  >
                    <div className="flex items-center gap-4 flex-1">
                      <CheckCircle2 className="h-8 w-8 text-[#2B8A6E] flex-shrink-0" />
                      <div className="flex-1 page-background">
                        ...
                        <div className="text-lg text-gray-800 dark:text-slate-200">{ack.role}</div>
                      </div>
                    </div>
          ...
          {/* ROI Comparison */}
          <Card className="bg-gradient-to-br   border-[#C9A84C]">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-2xl">
            ...
            <CardContent className="space-y-6">
              <div>
                <div className="text-sm text-gray-800 dark:text-slate-200 mb-2">WITHOUT Execution OS</div>
                <div className="flex items-center gap-2">
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="text-sm text-gray-800 dark:text-slate-200 mb-2">WITH Execution OS</div>
                <div className="flex items-center gap-2">
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="text-sm text-gray-800 dark:text-slate-200 mb-2">VALUE</div>
                <div className="text-3xl font-bold text-[#2B8A6E]">$283K</div>
                <div className="text-lg text-gray-800 dark:text-slate-200 mt-2">
      ...
      {!executionId && (
        <Card className="max-w-7xl mx-auto mt-8 bg-gray-50 border-gray-200">
          <CardHeader>
