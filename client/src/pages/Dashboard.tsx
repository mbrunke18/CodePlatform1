...
function PerspectiveSwitcher({ currentRole, currentIndustry }: { currentRole?: string | null; currentIndustry?: string | null }) {
  ...
  const displayIndustry = currentIndustry ? currentIndustry.split(" & ")[0].split(" (")[0] : "Set industry";
    ...
    <div style={{ position: "relative", display: "inline-block" }}>
      ...
      <button
        ...
        style={{
          ...
          color: isSet ? "#C9A84C" : "rgba(255,255,255,0.6)",
          padding: "6px 14px",
          fontSize: 11,
          fontWeight: 700,
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <select
                ...
                style={{
                  ...
                  color: role ? "#fff" : "rgba(255,255,255,0.4)",
                  padding: "10px 12px",
                  fontSize: 13,
                  borderRadius: 2,
                  outline: "none",
              ...
              >
                <option value="" style={{ background: "#0A0F2E" }}>Select a role…</option>
                {EXEC_ROLES.map(r => (
                  <option key={r} value={r} style={{ background: "#0A0F2E" }}>{r}</option>
                ))}
              </select>
              {role === "Other" && (
                <input
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <select
                ...
                style={{
                  ...
                  background: "rgba(255,255,255,0.05)",
                  border: "1px solid rgba(255,255,255,0.15)",
                  color: industry ? "#fff" : "rgba(255,255,255,0.4)",
                  padding: "10px 12px",
                  fontSize: 13,
                  borderRadius: 2,
                  outline: "none",
              ...
              >
                <option value="" style={{ background: "#0A0F2E" }}>Select a sector…</option>
                {INDUSTRIES.map(i => (
                  <option key={i} value={i} style={{ background: "#0A0F2E" }}>{i}</option>
                ))}
              </select>
              {industry === "Other" && (
                <input
            ...
            <button
              ...
              style={{
                width: "100%",
                background: canSave ? "#C9A84C" : "rgba(255,255,255,0.08)",
                color: canSave ? "#0A0F2E" : "rgba(255,255,255,0.3)",
                border: "none",
                padding: "12px 20px",
                fontSize: 11,
                fontWeight: 800,
            ...
            <p style={{ fontSize: 10, color: "rgba(255,255,255,0.3)", textAlign: "center", marginTop: 12, marginBottom: 0 }}>
              This calibrates your dashboard framing and playbook context.
            </p>
          </div>
        </>
      )}
