  ...
  const sections = [
    {
      ...
      pages: [
        ...
        { name: "Readiness Protocol Library", path: "/playbook-library" },
    ...
    },
    {
      ...
      pages: [
        ...
        { name: "Signal Radar Dashboard", path: "/ai-radar" },
          ...
          <CardContent className="p-12">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <div className="text-white/60 text-[10px] uppercase tracking-widest font-bold">Strategic Readiness Protocols</div>
              </div>
              <div>
