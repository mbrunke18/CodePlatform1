...
export default function DemoRouter() {
  ...
  const demoOptions = [
    ...
    },
    {
      ...
      title: 'Quick Demo',
      duration: '3 minutes',
      description: 'See a Readiness Protocol activate and tasks deploy in real-time. Perfect for a quick overview.',
      icon: Zap,
    ...
    },
    {
      ...
      duration: '12 minutes',
      description: 'Step into the role of a Fortune 500 CSO. Experience signal detection, Readiness Protocol activation, and coordinated response.',
      icon: Briefcase,
    ...
    },
    {
      ...
      description: 'See Readiness OS configured for your industry: Financial Services, Healthcare, Manufacturing, Retail, Energy, and Luxury.',
      icon: Building2,
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-800 mb-3">
                  See how Readiness OS delivers live execution in 12 minutes — roles assigned, tasks staged, teams already moving — with predictive AI and role-specific wins.
                </p>
                <Button
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-800">
                  Readiness OS forecasts trigger probabilities 90 days out. Run what-if scenarios. Know which Readiness Protocols you'll need before you need them.
                </p>
              </div>
            </div>
          </div>
