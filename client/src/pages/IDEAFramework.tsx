...
const phases = [
  {
    ...
    aiActions: [
      ...
      "Recommend Readiness Protocols based on historical outcomes",
    ],
    humanActions: [
      "Configure which triggers activate which Readiness Protocols",
  ...
  },
  {
    ...
    humanActions: [
      "Authorize Readiness Protocol activation with one click",
  ...
  },
  {
    ...
    aiRole: "System-Analyzed",
    humanRole: "Human-Decided",
    aiColor: "#2B8A6E",
    humanColor: "#C9A84C",
    description:
      "After each activation, AI generates an executive summary capturing what happened, decision timing, stakeholder response rates, and outcome metrics. Readiness Protocols are automatically updated based on what worked. Over time, your organization's execution speed and precision compound.",
    aiActions: [
      "Generate post-activation executive summaries",
      "Score stakeholder response rates and SLA adherence",
      "Recommend Readiness Protocol updates based on outcomes",
      "Track execution velocity trends over time",
    ],
    humanActions: [
      "Review performance against strategic objectives",
      "Approve Readiness Protocol updates and governance changes",
        ...
        <section style={{ background: OFF, borderTop: `3px solid ${GOLD}` }} className="py-16 px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-center text-xs mt-8 italic" style={{ color: MUTED }}>
              The preparation compresses the mobilization cycle. The decision remains human. No Readiness Protocol activates without executive sign-off.
            </p>
          </div>
        </section>
