...
const TIERS = [
  {
    ...
    roiNote: "A vendor dispute mishandled costs $500K–$2M in lost margin and executive time. Handled with a pre-staged playbook in 12 minutes, you protect that. One activation at this level returns the annual investment many times over.",
  },
  {
    id: "responsive",
    name: "Responsive",
