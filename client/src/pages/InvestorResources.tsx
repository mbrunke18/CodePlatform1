            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 12 }}>
              ...
              {[
                ...
                <div key={n} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", borderRadius: 0, background: active ? "rgba(201,168,76,0.08)" : "transparent", border: active ? "1px solid rgba(201,168,76,0.2)" : "1px solid rgba(255,255,255,0.04)" }}>
                  <span style={{ ...IR_MONO, fontSize: 11, color: active ? IR_GOLD : "rgba(240,237,228,0.2)", fontWeight: 700, flexShrink: 0 }}>{n}</span>
...
export default function InvestorResources() {
  useEffect(() => {
    updatePageMetadata({
      title: "Investor Resources | Readiness OS — Situational Readiness Platform",
            ...
            <CardContent>
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-[#2B8A6E]/5 border border-[#2B8A6E]/10">
                  ...
                  <p className="text-xs text-[#6B7280] leading-relaxed">
                    Structured debriefs, metrics captured, Readiness Protocols improved
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-[#6B7280]">
                    {[
                      ...
                      { cap: "Pre-built response Readiness Protocols", crisis: false, pm: false, vm: true },
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                },
                {
                  ...
                  items: [
                    "20-test suite — Vitest + Supertest covering Readiness Protocol seeding, auth, activation chain, top API routes",
