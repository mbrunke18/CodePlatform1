...
const PHASES = [
  {
    ...
    capabilities: [
      ...
      {
        title: '170 Pre-Staged Playbooks',
        detail: 'Each playbook represents a strategic decision already made by the best minds in the organization under no pressure, with full information and complete clarity. Not a template — a commitment. The organization has already decided what it will do when this trigger fires.',
      },
      {
        title: 'Trigger Configuration Wizard',
        detail: 'Maps your specific strategic situations to the playbooks that respond to them. The system understands what your organization considers a trigger, not what a generic model suggests. Situation intents, signal thresholds, and monitoring rules are configured to your context.',
      },
      {
  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        detail: 'No playbook activates without executive sign-off. The platform compresses the mobilization cycle, not the decision authority. The preparation eliminates improvisation under pressure; the human judgment that authorizes action remains exactly where it belongs.',
      },
      {
        title: 'AI Execution Brief at Activation',
        detail: 'A structured pre-read generated at the moment of trigger detection — telling the authorizing executive what fired, why, what the playbook deploys, who gets notified, and what they are approving. Decision-ready in under 2 minutes, not 2 hours.',
      },
      {
        title: 'Execution Confidence Score',
        detail: 'Per detection — showing which signals converged, which domains lit, the confidence weight of the trigger, and the recommended playbook with alternates. The executive sees the case for action before they authorize it.',
      },
      {
  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        detail: 'Every owner receives their specific responsibilities, due times, and success criteria the moment the playbook activates — no waiting for a coordinator to assign work, no ambiguity about who owns what. Pre-staged task sequences deploy automatically.',
      },
      {
        title: 'Live War Room',
      ...
      },
      {
        ...
        detail: 'Microsoft Teams, Azure OpenAI, Copilot Studio, and Microsoft Entra. Execution OS sits above the Microsoft investment as the operating model layer — not a replacement, an orchestrator. Every enterprise already has Microsoft\'s AI stack. This is the operating model to use it.',
      },
      {
  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        detail: 'Improvements identified in each post-activation debrief are captured and fed back into the playbook architecture. The specific changes — who should have been in Tier 1, which communications needed earlier distribution, which decision gate slowed the clock — become part of the playbook the next time it activates.',
      },
      {
      ...
      },
      {
        ...
        detail: 'A structured performance record scored against what was designed vs. what happened — not a retrospective document but a forward-feeding artifact that drives playbook improvement. Performance is not evaluated to assign blame; it is evaluated to eliminate the gap between plan and execution.',
      },
      {
...
const PLATFORM_CAPABILITIES = [
  {
    ...
    detail: 'Authenticated walk-throughs of industry-specific triggers — CISO zero-day breach, CFO activist investor, COO supplier failure, GC FDA enforcement — mapped to the live playbook library, showing the exact IDEA chain and 12-minute execution in the buyer\'s own context.',
  },
  {
    icon: BarChart3,
  ...
  },
  {
    ...
    detail: 'Digital twin environment where organizations test playbook responses against live signals without activating in production. Run fire drills at any time — validate response quality before the real trigger fires.',
  },
  {
    icon: BookOpen,
    title: 'Playbook Detail Editor',
    detail: 'Authenticated users can customize phases, tasks, decision gates, and stakeholder assignments within any playbook — ensuring the pre-staged response reflects the organization\'s actual structure, not a generic template.',
  },
  {
    icon: Target,
    title: 'Compound Threat Intelligence',
    detail: 'Identifies when multiple signals across different domains converge into a compound threat — a cyber event coinciding with a regulatory inquiry coinciding with a key executive departure — and surfaces the combined risk with a unified playbook response.',
  },
  {
    icon: Lock,
    title: 'Role-Based Access & Audit Trail',
    detail: 'Executive, strategist, and admin roles with granular access controls. Every action — detection acknowledgment, playbook activation, task completion, decision gate clearance — is logged with timestamp and actor for complete governance and audit compliance.',
  },
];
...
export default function PlatformCapabilities() {
  useEffect(() => {
    updatePageMetadata({
      title: 'Platform Capabilities — Execution OS | VaughnMartin',
      description: 'The full decision intelligence lifecycle: preparation, activation, coordination, and compounding learning. Every capability that Execution OS delivers.',
    });
  }, []);
      ...
      <div style={{ background: NAVY, padding: '72px 0 56px' }}>
        <div style={{ maxWidth: 960, margin: '0 auto', padding: '0 40px' }}>
          ...
          <p style={{ fontSize: 16, color: 'rgba(240,237,228,0.65)', lineHeight: 1.8, maxWidth: 660, fontWeight: 400, marginBottom: 32 }}>
            Execution OS does not help organizations respond faster. It helps them prepare better, decide with higher confidence, execute with greater precision, and compound organizational intelligence over time — so every response is faster, sharper, and more likely to succeed than the last one.
          </p>
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            {[
              { label: '170 Playbooks', sub: 'Pre-staged' },
      ...
      <div style={{ background: NAVY, padding: '64px 0' }}>
        <div style={{ maxWidth: 820, margin: '0 auto', padding: '0 40px', textAlign: 'center' }}>
          ...
          <blockquote style={{
            ...
            "Most tools address one moment. Execution OS addresses the entire decision lifecycle — from signal detection through decision preparation through activated execution through institutional learning — and every cycle through that lifecycle makes the organization more capable of handling the next one."
          </blockquote>
