      ...
      <div className="flex flex-col items-center justify-center h-full px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl w-full">
          ...
          <div className="bg-[#2B8A6E]/5 border border-[#2B8A6E]/10 p-8">
            ...
            <div className="space-y-4">
              {['T+0: AI detects signal automatically', 'T+2m: Readiness Protocol matched with 94% confidence', 'T+4m: Stakeholders notified, tasks assigned', 'T+8m: Budget pre-approved, resources staged', 'T+12m: Full coordinated response active', 'T+24h: Post-action review, prepared response refined'].map((t, i) => (
                <div key={i} className="flex items-start gap-3">
