          ...
          <div className="max-w-7xl mx-auto relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-bold uppercase tracking-widest" style={{ color: GOLD }}>Platform · Intelligence</span>
              </div>
              ...
              <p className="text-white/60 max-w-xl">
                248+ data points. 19 signal categories. Real-time pattern detection. 15-minute monitoring cycles.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {activeTab === 'overview' && (
            <>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                {[
                  { label: 'Signal Categories', value: '19', desc: 'Enterprise domains monitored', icon: Layers, color: TEAL },
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  { title: 'Signal Intelligence', desc: '248+ data points, 19 signal categories', path: '/signal-intelligence', tab: 'signals', icon: Zap, color: TEAL },
          ...
          {activeTab === 'signals' && (
            <>
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
                <div>
                  <div className="flex items-center gap-3"><h2 className="text-3xl font-bold text-[#0A0F2E]" style={CG}>Signal Intelligence Dashboard</h2><Badge className="bg-[#2B8A6E] text-white border-none px-3 py-1 font-bold uppercase tracking-wider">LIVE</Badge></div>
                  <p className="text-[#6B7280] mt-1">248+ data points monitored across 19 signal categories</p>
                </div>
          ...
          {activeTab === 'compound' && (
            <>
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
                <div>
                  <div className="flex items-center gap-3"><h2 className="text-3xl font-bold text-[#0A0F2E]" style={CG}>Compound Threat Intelligence</h2><Badge className="bg-[#0A0F2E] text-white border-none px-3 py-1 font-bold uppercase tracking-wider">System-Analyzed</Badge></div>
              ...
              <Card className="border-[#E8E4DC] bg-white mb-6">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                      { step: '01', title: 'Weak Signal Aggregation', desc: 'The system reads signals across all 19 signal categories simultaneously, identifying patterns invisible to category-specific analysis.' },
          ...
          {activeTab === 'audit' && (
            <>
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
                <div>
                  <div className="flex items-center gap-3"><h2 className="text-3xl font-bold text-[#0A0F2E]" style={CG}>Audit & Compliance Log</h2><Badge className="bg-[#0A0F2E] text-white border-none px-3 py-1 font-bold uppercase tracking-wider">SOC 2</Badge></div>
