            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <Card className="border-l-4 border-l-poise-teal">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Quarterly Executions</p>
              ...
              <Card className="border-l-4 border-l-poise-gold">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Orchestration Health</p>
              ...
              <Card className="border-l-4 border-l-emerald-500">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Anticipation Window</p>
              ...
              <Card className="border-l-4 border-l-violet-500">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Execution Velocity</p>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-xs text-slate-500">{capability.domains.join(', ')}</p>
                              </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">{capability.description}</p>
                          <div className="flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Early warnings detected by ExecuteIQ Signal</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {mockAnticipationSignals.map((signal) => (
                      <div key={signal.id} className="p-4 rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div>
                            <p className="text-slate-500">Magnitude</p>
                            <p className="font-semibold">{signal.magnitude}/10</p>
                          </div>
                          <div>
                            <p className="text-slate-500">Relevance</p>
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div className="text-center p-6 rounded-xl bg-gradient-to-br from-poise-teal/10 to-emerald-500/10 border border-poise-teal/30">
                      ...
                      <p className="text-slate-600 dark:text-slate-400">Average anticipation window</p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 rounded-lg bg-slate-100 dark:bg-slate-800 text-center">
                        ...
                        <p className="text-sm text-slate-500">Signals converted to executions</p>
                      </div>
                      <div className="p-4 rounded-lg bg-slate-100 dark:bg-slate-800 text-center">
                        <p className="text-2xl font-bold text-slate-900 dark:text-white">3</p>
                        <p className="text-sm text-slate-500">Emerging opportunities</p>
                      </div>
                    </div>
