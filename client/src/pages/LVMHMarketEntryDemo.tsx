...
const TASKS = [
  ...
  { phase: "CLIENT RETENTION", role: "Chief Client Officer", action: "Launch immediate VIP client retention initiative — personal CEO outreach to all clients with any overlap with the acquired brand. Relationship call, not a sales call. Listen first.", time: "4:00", priority: "critical" },
  { phase: "CHANNEL PROTECTION", role: "Chief Revenue Officer", action: "Brief all distribution partners — reinforce exclusivity commitments, accelerate partner appreciation initiatives, lock channel agreements before competitor integration team arrives at partner HQ", time: "6:00", priority: "high" },
  ...
  { phase: "STRATEGIC ACCELERATION", role: "Chief Strategy Officer + CFO", action: "Accelerate review of 3 pre-identified strategic acquisition targets that strengthen position in affected segment. Present board with prioritized opportunity and preliminary term structure.", time: "12:00", priority: "high" },
];
