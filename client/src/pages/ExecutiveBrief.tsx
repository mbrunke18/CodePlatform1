...
const comparisonRows = [
  {
    ...
    executionOS: "Automatic — continuous AI monitoring across 248+ data points",
  },
  {
  ...
  {
    category: "Playbook Readiness",
    traditional: "Built in real time during the crisis under pressure",
    executionOS: "Pre-staged — 170 playbooks ready before the trigger fires",
  },
  {
  ...
  },
  {
    ...
    executionOS: "Automated debrief after every activation — playbooks improve continuously",
  },
];

const proofNumbers = [
  { value: "170", label: "Pre-staged playbooks across 9 strategic domains" },
...
const pilotIncludes = [
  "Full Execution OS platform access for up to 25 users",
...
export default function ExecutiveBrief() {
  useEffect(() => {
    updatePageMetadata({
      ...
      description: "A shareable executive summary of the Execution OS thesis, proof numbers, ROI case, and pilot program. Built for Fortune 1000 board-level conversations.",
      ogTitle: "Executive Brief — VaughnMartin Execution OS",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
              <div>
                ...
                <p style={{ fontSize: 15, color: "#4B5563", lineHeight: 1.8, marginTop: 12 }}>
                  Execution OS doesn't bolt intelligence onto that model. It replaces it. Pre-staged playbooks replace real-time coordination. Pattern detection replaces committee deliberation. 12-minute execution replaces 30-day alignment cycles.
                </p>
              </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, alignItems: "center" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {[
                  ...
                  { label: "Execution OS trigger to coordination", value: "12 min", color: TEAL, sub: "Full stakeholder cascade, tasks assigned, roles live" },
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <thead>
                  <tr style={{ borderBottom: "2px solid #E8E4DC" }}>
                    ...
                    <th style={{ padding: "12px 16px", textAlign: "left", fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: NAVY, width: "37.5%" }}>Execution OS</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "start" }}>
              <div>
                ...
                <p style={{ fontSize: 14, color: "#4B5563", lineHeight: 1.8 }}>
                  Execution OS is not a replacement for Copilot, Azure OpenAI, or Teams. It is the operating model layer that sits above your existing Microsoft investment. Your AI tools detect and summarize. Execution OS deploys your people — the coordination infrastructure that makes detection actionable.
                </p>
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  { layer: "Execution OS", role: "Operating model — coordinates humans at trigger speed", yours: false },
                  ...
                  <div key={layer} style={{ border: `1px solid ${yours ? "#E8E4DC" : GOLD}`, padding: "12px 16px", background: yours ? "#F8F7F4" : "rgba(201,168,76,0.04)" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                      ...
                      {!yours && <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", color: GOLD }}>Execution OS</span>}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32, alignItems: "start" }}>
              <div>
                ...
                <p style={{ fontSize: 14, color: "#4B5563", lineHeight: 1.8, marginBottom: 20 }}>
                  A structured 90-day engagement to prove Execution OS' 12-minute coordination claim with live activations in your environment. Measurable outcomes. Clear conversion path.
                </p>
