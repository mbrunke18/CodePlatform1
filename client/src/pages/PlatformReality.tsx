...
export default function PlatformReality() {
  ...
  useEffect(() => {
    updatePageMetadata({
      ...
      description: "Every conference keynote, McKinsey deck, and LinkedIn post proves the mobilization problem is real. None of them built the solution. Readiness OS did — 12-minute execution, 180 pre-staged Readiness Protocols, 3,600× Execution Head Start.",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 2 }}>
            {[
              ...
              },
              {
                ...
                cost: "$300K–$500K per engagement",
                what: "McKinsey charges $75,000 to $300,000 to build a response after your situation has already arrived. The knowledge leaves when the engagement ends. Your next situation starts from zero. Same cost. Same 30 days. Every time.",
                gap: "30 days unchanged",
              ...
              },
              {
                ...
                verdict: "Automated It",
                cost: "IT operations budget",
                what: "ServiceNow and Monday automate work — but the work has to be defined first. Under pressure. By people who are also managing the situation. They optimize execution of tasks assembled after the trigger fired.",
                gap: "30 days unchanged",
          ...
          <div style={{ marginTop: 2, padding: "36px 40px", background: NAVY, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32, flexWrap: "wrap" as const }}>
            <div>
              ...
              <p style={{ fontSize: 14, color: "rgba(240,237,228,0.55)", maxWidth: 540, marginTop: 8, lineHeight: 1.6 }}>
                180 live playbooks. 231 pre-mapped triggers. 248+ data points monitored. Executive-authorized execution in 12 minutes. The response is ready before the trigger fires.
              </p>
            </div>
            <button
              onClick={() => setLocation("/12-minute-experience")}
