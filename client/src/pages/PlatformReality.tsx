...
export default function PlatformReality() {
  ...
  useEffect(() => {
    updatePageMetadata({
      ...
      ogDescription: "The 3,600× Execution Head Start is not a framework. It's a timestamp on a deployed playbook. See how Readiness OS ends the thought leadership theater.",
    });
  }, []);
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: 1 }}>
                {[
                  ...
                  { step: "03", label: "The Implementation Begins", body: "Workshops are scheduled. Champions are named. A steering committee convenes. Three months later, a pilot program is approved." },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column" as const, gap: 2 }}>
              ...
              <div style={{ padding: "32px", background: `rgba(201,168,76,0.08)`, border: `2px solid ${GOLD}`, textAlign: "center" as const }}>
                ...
                <div style={{ fontSize: 13, color: "#4B5563" }}>Pre-staged playbook. Role assignments automated. Executive-authorized. Live.</div>
              </div>
