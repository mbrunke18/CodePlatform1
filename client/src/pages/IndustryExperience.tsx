...
const INDUSTRIES: Record<string, IndustryData> = {
  'lvmh-market-entry': {
    ...
    lesson: 'Readiness Protocol enhanced: Added "Government Policy Monitor" as a leading indicator trigger — detected tariff changes 45 days before public announcement. Created reusable "Multi-Brand Simultaneous Launch" template. WeChat-first digital strategy outperformed traditional retail-first by 340%.',
  },
  'shein-trend': {
  ...
  'spacex-launch': {
    ...
    lesson: 'Readiness Protocol refined: Added "Orbital Window Prediction" as a 7-day lookahead trigger — identifies acceleration opportunities 5 days earlier. Created reusable "Accelerated Countdown" template with parallel regulatory filing. Recovery ship pre-positioning reduced booster turnaround by 2 days.',
  },
  ...
  'pharma-recall': {
    ...
    lesson: 'Readiness Protocol enhanced: Added "API Process Change Monitor" as a root cause prevention trigger — would have detected the synthesis modification 8 months earlier. TraceLink serialization enabled unprecedented pharmacy-level recall precision. Created reusable "NDMA Contamination Response" template now shared across industry consortium.',
  },
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-[#6B7280] leading-relaxed">
                Configure your own Readiness Protocol, triggers, data sources, and customizations. Then watch your personalized execution come alive as a real signal fires.
              </p>
            </motion.div>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
              className="mt-8 flex items-center justify-center gap-6 text-sm text-[#6B7280] flex-wrap"
            >
              <span className="flex items-center gap-2"><BookOpen className="h-4 w-4 text-[#2B8A6E]" /> Readiness Protocol #{industry.playbook.number}</span>
        ...
        return (
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  { msg: `${industry.stakeholders[0]?.name || 'CEO'}: "Readiness Protocol activated. All teams report status in 5 minutes."`, time: '2 min ago', color: 'border-[#2B8A6E]/30' },
