...
const INDUSTRIES: Record<string, IndustryData> = {
  'lvmh-market-entry': {
    ...
    executionTasks: [
      ...
      { task: '1,267 stakeholders coordinated, 10-brand launch program fully operational', tool: 'ExecuteIQ', status: 'Complete', time: '11:47' },
    ],
    outcomes: [
  ...
  'shein-trend': {
    ...
    executionTasks: [
      ...
      { task: '5,847 stakeholders synchronized, 7-day sprint activated', tool: 'ExecuteIQ', status: 'Complete', time: '11:22' },
    ],
    outcomes: [
  ...
  'spacex-launch': {
    ...
    executionTasks: [
      ...
      { task: '1,847 stakeholders coordinated, launch acceleration fully operational', tool: 'ExecuteIQ', status: 'Complete', time: '11:33' },
    ],
    outcomes: [
  ...
  'financial-ransomware': {
    ...
    executionTasks: [
      ...
      { task: '150 stakeholders coordinated, response fully operational', tool: 'ExecuteIQ', status: 'Complete', time: '11:47' },
    ],
    outcomes: [
  ...
  'pharma-recall': {
    ...
    executionTasks: [
      ...
      { task: '2,052 stakeholders coordinated, recall operation fully activated', tool: 'ExecuteIQ', status: 'Complete', time: '11:47' },
    ],
    outcomes: [
  ...
  'manufacturing-supplier': {
    ...
    executionTasks: [
      ...
      { task: '158 stakeholders coordinated, crisis response fully operational', tool: 'ExecuteIQ', status: 'Complete', time: '11:12' },
    ],
    outcomes: [
  ...
  'retail-contamination': {
    ...
    executionTasks: [
      ...
      { task: '5,000 stakeholders coordinated, response fully operational', tool: 'ExecuteIQ', status: 'Complete', time: '11:33' },
    ],
    outcomes: [
  ...
  'energy-grid': {
    ...
    executionTasks: [
      ...
      { task: '2,500 stakeholders coordinated, emergency response fully operational', tool: 'ExecuteIQ', status: 'Complete', time: '11:47' },
    ],
    outcomes: [
                ...
                <div className="border-t border-white/10 pt-6">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    {industry.executionTasks.length > 5 && (
                      <div className="text-center text-xs text-slate-600 dark:text-slate-200 py-1">+ {industry.executionTasks.length - 5} more template tasks</div>
                    )}
                  </div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  { msg: `ExecuteIQ: "${userPlaybook.name}" fully operational. ${userPlaybook.stakeholders.toLocaleString()} stakeholders coordinated in under 12 minutes.`, time: '1 min ago', color: 'border-cyan-500/30' },
              ...
              {industry.outcomes.map((outcome, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      <div className="text-xs text-slate-300 mb-1">Before ExecuteIQ</div>
                    ...
                    <div className="flex-1">
                      <div className="text-xs text-slate-300 mb-1">With ExecuteIQ</div>
