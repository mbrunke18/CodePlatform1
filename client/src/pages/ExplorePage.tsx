  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-[#F8F7F4]">
        ...
        {/* ── Platform Showcase ── */}
        <ProductShowcase
          eyebrow="The Platform That Learns"
          headline="Every activation closes the loop. Every close-out improves the next."
          image="/screenshots/new_advance_intelligence.jpg"
          imageAlt="Readiness OS ADVANCE 2.0 — Closed-Loop Causal Learning"
          urlPath="/advance-intelligence"
          urlTag="ADVANCE 2.0"
          tagColor="#2B8A6E"
          features={[
            { color: "#2B8A6E", label: "Causal Hypotheses", description: "Every protocol update generates an expected outcome — measured automatically after the next activation." },
            { color: "#C9A84C", label: "Proven Improvements", description: "Updates classified as Proven, Measuring, or Disproven — building an evidence-backed library over time." },
            { color: "#4A90C4", label: "Learning Velocity Index", description: "Months to rebuild on any competitor — a growing institutional moat that compounds with every activation." },
          ]}
        />
