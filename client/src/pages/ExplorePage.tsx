...
export default function ExplorePage() {
  ...
  useEffect(() => {
    updatePageMetadata({
      ...
      description: 'Sign in and experience VaughnMartin Readiness OS as a real customer. Browse 170 playbooks, activate a scenario, and see a coordinated response unfold.',
    });
  }, []);
