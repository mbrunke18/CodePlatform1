        ...
        <div style={{ background: NAVY, padding: "80px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <p className="text-white/60 text-xl leading-relaxed max-w-3xl">
              Prioritize your Readiness Protocol preparation with our Likelihood × Impact framework. 
        ...
        <div className="p-12 max-w-7xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  Get your Top 10 Critical Readiness Protocols to 95%+ readiness level.
                </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                ...
                <p className="text-white/80 text-sm leading-relaxed">
                  ...
                  Build out remaining Readiness Protocols with quarterly readiness sprints.
                </p>
              </div>
            </div>
            </CardContent>
          ...
          <Card className="rounded-none border-[#E8E4DC] bg-white overflow-hidden">
            ...
            <CardContent className="p-8 space-y-4">
              {[
                { 
                  title: 'Schedule practice drills for your Critical Readiness Protocols', 
