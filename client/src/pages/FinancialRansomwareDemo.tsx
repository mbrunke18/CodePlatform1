        ...
        {currentAct === "outcome" && (
          <div className="max-w-6xl mx-auto space-y-8">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-blue-200">Compare the traditional approach vs. POISE's coordinated response</p>
            </div>
        ...
        {currentAct === "summary" && (
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="bg-gradient-to-r from-blue-950/50 to-purple-950/50 border-blue-800/30 p-8">
              <h3 className="text-xl font-semibold text-white mb-4 text-center">The POISE Difference</h3>
              <p className="text-blue-100 text-center leading-relaxed max-w-3xl mx-auto">
                Your AI detected the ransomware in milliseconds. But without POISE, coordinating your CEO, CISO, CTO, CFO, legal counsel, Board, and regulators would take 48-72 hours of email chains and emergency meetings. In that window, a $1M incident becomes a $27M disaster. POISE turns instant detection into 12-minute coordinated response—we're not replacing your AI, we're the execution layer that makes it deliver ROI.
              </p>
            </Card>
