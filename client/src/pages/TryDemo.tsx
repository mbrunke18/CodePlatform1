...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    chaosMessages: [
      ...
      { id: '2', type: 'slack', sender: 'EVP, Technology Products', content: 'We need a unified roadmap message for customers in 48 hours. Three acquisitions. One platform story. Where is it?', urgency: 'critical' },
      ...
      { id: '4', type: 'slack', sender: 'Armis CEO', content: 'Team is watching closely. Our engineers are getting recruiter calls. What is the retention plan?', urgency: 'critical' },
      { id: '5', type: 'text', sender: 'Chief Financial Officer', content: 'Debt financing structure needs board sign-off by EOD. Integration budget not yet allocated across 3 deals.', urgency: 'critical' },
      ...
      { id: '9', type: 'text', sender: 'CEO & Chairman', content: 'Analyst from Barclays just asked me about integration coherence on live CNBC call. I need answers from the team.', urgency: 'critical' },
  ...
  },
  {
    ...
    chaosMessages: [
      ...
      { id: '2', type: 'slack', sender: 'Google Cloud CEO', content: 'Wiz team is asking about organizational structure post-close. They walked away before. We need answers in 24 hours.', urgency: 'critical' },
      { id: '3', type: 'text', sender: 'Wiz CEO', content: 'My board is watching the DOJ situation. If this drags past 12 months, the deal economics change for us.', urgency: 'critical' },
      ...
      { id: '7', type: 'text', sender: 'CEO, Alphabet', content: 'Wiz walked away from $23B. The question the board is asking is: what is different this time? I need the answer.', urgency: 'critical' },
  ...
  },
  {
    ...
    color: 'bg-[#0A0F2E]',
    borderColor: 'border-[#E8E4DC]',
    trigger: 'Redshire Capital files activist position during Juniper integration',
    playbook: 'Activist Defense + Integration Continuity',
    dealValue: 14000000000,
    stakeholders: 13,
    revenuePerMinute: 48000,
    chaosMessages: [
      { id: '1', type: 'email', sender: 'Investor Relations', content: 'Redshire Capital disclosed a significant stake this morning. Public letter questioning the entire Juniper integration thesis. Board call needed today.', urgency: 'critical' },
      { id: '2', type: 'slack', sender: 'Integration PMO', content: 'Juniper integration team asking: do we continue on current plan or pause? Redshire is questioning the rationale for the deal entirely.', urgency: 'critical' },
      { id: '3', type: 'text', sender: 'Chief Executive Officer', content: 'Redshire wants a call with me and the board before market open tomorrow. I need our integration performance data and a defense narrative in the next 3 hours.', urgency: 'critical' },
      { id: '4', type: 'email', sender: 'General Counsel', content: 'Redshire letter demands board refreshment and strategic review. We need proxy defense counsel engaged immediately — ISS clock starts now.', urgency: 'critical' },
      ...
      { id: '7', type: 'slack', sender: 'Enterprise Sales', content: '6 enterprise deals referencing the Redshire letter in calls today. Customers asking if Juniper product roadmap is stable. No answer ready.', urgency: 'critical' },
  ...
  },
  {
    ...
    chaosMessages: [
      ...
      { id: '3', type: 'text', sender: 'Chief Executive Officer', content: 'Analysts are asking what our recurring revenue strategy looks like post-close. I need a model and a message in the next 48 hours.', urgency: 'critical' },
...
const SCENARIO_SIGNALS: Record<string, { label: string; source: string; strength: number }[]> = {
  ...
  'hpe-juniper': [
    { label: 'Redshire Capital 13D filing — significant HPE stake disclosed', source: 'SEC EDGAR Monitor', strength: 44 },
...
const SCENARIO_ADVANCE: Record<string, { patterns: string[]; improvements: string[]; stat: string }> = {
  ...
  'hpe-juniper': {
    patterns: ['Unified board position drafted and approved in 11 minutes', 'Integration continuity message delivered to Juniper team before market open', 'CEO narrative for Redshire call built from pre-staged integration data — no scramble'],
    improvements: ['Add Redshire-style activist monitoring at 3% stake accumulation threshold', 'Pre-stage integration performance dashboard for board-level activist defense', 'Include Juniper customer communication in Phase 1 — not Phase 2'],
    stat: '$14B integration thesis defended — Redshire engagement resolved without board change',
  },
  'target-succession': {
...
const PHASES = [
  ...
  { id: 'identify' as Phase, name: 'IDENTIFY', icon: BookOpen, color: 'teal', description: 'Readiness Protocol ready' },
...
export default function TryDemo() {
  ...
  const simulateExecution = () => {
    ...
    const steps = [
      { id: 1, title: 'Readiness Protocol Activated', description: `${selectedScenario?.playbook} triggered`, icon: Zap, integration: 'execution-os', delay: 0 },
  ...
  return (
    <PageLayout>
                ...
                <div>
                    ...
                    <Card className="bg-white border-gray-200">
                      ...
                      <CardContent className="space-y-4">
                        <div className="p-4 bg-[#C9A84C]/10 border border-[#C9A84C]/30">
                          <h4 className="text-gray-900 font-medium mb-3">Readiness Protocol: {selectedScenario.playbook}</h4>
                  ...
                  {currentPhase === 'detect' && (
                    ...
                    <div style={{ background: NAVY, borderRadius: 0, overflow: 'hidden' }}>
                      ...
                      <div style={{ padding: '20px 20px 24px' }}>
                        ...
                        {/* Trigger fired + Readiness Protocol match */}
                        {detectStep >= 3 && (
                          <div style={{ background: 'rgba(34,197,94,0.08)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: 0, padding: '14px 16px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                              ...
                              <span style={{ fontSize: 12, fontWeight: 700, color: '#22c55e', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Trigger Threshold Crossed — Readiness Protocol Matched</span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                          ...
                          <div>
                            ...
                            <p style={{ fontSize: 11, fontWeight: 600, color: 'rgba(255,255,255,0.85)', margin: '0 0 2px', lineHeight: 1.45 }}>
                              {executionSteps.length === 0
                                ...
                                ? `Readiness Protocol activated in seconds — budget pre-approved, tasks pre-assigned.`
                  ...
                  {currentPhase === 'advance' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                      ...
                      {/* Readiness Protocol improvements */}
                      <div style={{ background: 'white', border: `1px solid ${BORDER}`, borderRadius: 0, padding: '16px 18px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                          <Lightbulb style={{ width: 14, height: 14, color: GOLD }} />
                          <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: GOLD }}>Readiness Protocol Improvements Staged</span>
                        </div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                      ...
                      >
                        See the Full Readiness Protocol That Powered This Response
                        <ArrowRight className="ml-2 h-4 w-4" />
                      </Button>
                  ...
                  {currentPhase === 'complete' && (
                    <div className="space-y-6">
                      {/* Readiness Protocol reveal — primary WOW moment */}
                      {(() => {
                        ...
                        return mapped ? (
                          <div style={{ background: NAVY, borderRadius: 0, overflow: 'hidden' }}>
                            ...
                            <div style={{ background: NAVY_MID, padding: '12px 24px', display: 'flex', alignItems: 'center', gap: 8, borderBottom: '1px solid rgba(201,168,76,0.2)' }}>
                              ...
                              <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.5)' }}>Readiness OS — Readiness Protocol Activated</span>
                            </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <p style={{ fontSize: 13, color: '#6B7280', lineHeight: 1.65, marginBottom: 16 }}>
                              You have now seen Readiness OS in action. Your candid perspective — credibility, gaps, competitive concerns — is more valuable to us than a positive review. The assessment takes 25–35 minutes and directly shapes the product roadmap.
                            </p>
                  ...
                  <Card className="bg-white border-[#C9A84C]">
                    <CardContent className="p-4 text-center">
                      ...
                      >
                        ...
                        View 3 Free Readiness Protocol Examples
                      </button>
                    </CardContent>
                  </Card>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto font-medium">
              Explore how Readiness OS handles real-world scenarios across offense and defense — each demo shows the full trigger-to-execution loop.
            </p>
          </div>
      ...
      {/* Live Readiness Protocol Examples Section */}
