...
const DOMAIN_CONFIG = {
  offense: {
    ...
    icon: Rocket,
    color: "teal",
    playbooks: "58 Readiness Protocols",
  ...
  defense: {
    ...
    icon: Shield,
    color: "navy",
    playbooks: "74 Readiness Protocols",
  ...
  special_teams: {
    ...
    icon: Settings,
    color: "gold",
    playbooks: "54 Readiness Protocols",
              ...
              <div className="grid grid-cols-3 gap-6 max-w-lg mx-auto">
                {[
                  ...
                  <div key={step.num} className="text-center">
                    <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 32, fontWeight: 700, color: '#C9A84C', lineHeight: 1, marginBottom: 6 }}>{step.num}</div>
                    <div style={{ width: 16, height: 1, background: '#C9A84C', margin: '0 auto 8px' }} />
