...
const EVENTS: RegulatoryEvent[] = [
  {
    ...
    action: "Activate Cybersecurity Incident Response Readiness Protocol to pre-stage disclosure workflow.",
  ...
  },
  {
    ...
    action: "Activate GDPR Breach Protocol Readiness Protocol immediately upon discovery.",
  ...
  },
  {
    ...
    action: "Run Financial Controls Assessment Readiness Protocol to surface any material weakness before certification window.",
    regulatoryBody: "U.S. Securities and Exchange Commission",
  },
  {
    id: "ftc-merger",
  ...
  },
  {
    ...
    action: "Pre-stage Product Recall Response Readiness Protocol — all stakeholder assignments pre-loaded.",
  ...
  },
  {
    ...
    action: "Activate HR Compliance Reporting Readiness Protocol to coordinate data collection across business units.",
  ...
  },
  {
    ...
    action: "Schedule Privacy Compliance Audit Readiness Protocol — coordinate legal, IT, and operations teams.",
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 28 }}>
            {[
              ...
              { label: "Readiness Protocols Mapped", value: EVENTS.reduce((a, e) => a + e.relatedPlaybooks.length, 0), color: TEAL, bg: "rgba(43,138,110,0.06)", sub: "Pre-staged responses" },
                ...
                >
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                      ...
                      <span style={{ fontSize: 10, color: TEAL, fontWeight: 600 }}>{event.relatedPlaybooks.length} Readiness Protocol{event.relatedPlaybooks.length !== 1 ? "s" : ""}</span>
                    </div>
