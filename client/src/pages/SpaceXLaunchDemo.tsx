                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: 16 }}>
                  ...
                  <div>
                    ...
                    <p style={{ color: "rgba(240,237,228,0.7)", lineHeight: 1.6, fontSize: 13 }}>
                      ...
                      Execution OS compresses it to <strong style={{ color: GOLD }}>12 minutes</strong> — enabling SpaceX to capture time-sensitive launch opportunities competitors cannot match.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <div style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.1)", borderTop: `3px solid ${GOLD}`, borderRadius: 12, padding: 40, textAlign: "center" }}>
              ...
              <div style={{ marginBottom: 24 }}>
                ...
                <p style={{ fontSize: 12, color: "rgba(240,237,228,0.4)", marginTop: 10 }}>Deploy Execution OS across your organization</p>
              </div>
            </div>
