        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0">
              ...
              {activeSection === 'roles' && (
                <div className="space-y-6">
                  <div className="flex items-center justify-between"><div><h2 className="text-2xl font-bold text-[#0A0F2E]" style={CG}>Roles & Permissions</h2><p className="text-[#6B7280] mt-1">Control access levels for Readiness Protocol activation and trigger management</p></div></div>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      { role: 'Executive', desc: 'Full authorization — can activate all Readiness Protocols', permissions: ['Activate Readiness Protocols', 'Approve escalations', 'View all data', 'Modify triggers'], color: GOLD },
                      { role: 'Strategist', desc: 'Can configure Readiness Protocols and view intelligence', permissions: ['View all data', 'Configure triggers', 'Prepare Readiness Protocols', 'Draft briefs'], color: TEAL },
                      { role: 'Operator', desc: 'Execute assigned tasks within active Readiness Protocols', permissions: ['View assigned tasks', 'Update task status', 'Receive notifications'], color: NAVY },
