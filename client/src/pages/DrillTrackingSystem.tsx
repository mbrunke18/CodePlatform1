...
const demoDrills = [
  ...
  },
  {
    ...
    lessons: [
      'Due diligence checklist completion improved from 72% to 94% with structured Readiness Protocol',
    ...
    <div className="bg-white overflow-auto min-h-screen">
      ...
      <div className="p-12 max-w-7xl mx-auto">
        <div style={{ border: "1px solid #E8E4DC", borderLeft: `3px solid ${NAVY}`, padding: "32px", background: "#fff" }}>
          ...
          <p className="text-[#6B7280] mb-8">Practice Readiness Protocol execution with team performance tracking and systematic auditing.</p>
