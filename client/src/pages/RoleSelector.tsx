...
const roleConfigs: RoleConfig[] = [
  {
    ...
    keyMetric: "$144M execution gap → 12 minutes to live execution",
    playbook: 'ma-day1',
  ...
  },
  {
    ...
    icon: FileCheck,
    hookQuestion: "Audit notification arrives Monday. How long before 6 teams have roles assigned and tasks already staged?",
