      ...
      <main className="max-w-7xl mx-auto px-6 py-12 text-white">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Experience the full IDEA Framework in action. Watch how Readiness OS detects a deal at risk and delivers live execution in 12 minutes — roles assigned, tasks staged, teams already moving.
          </p>
          <Button 
            variant="outline" 
              ...
              <Card className="bg-white/5 border-white/10">
                ...
                <CardContent className="space-y-4">
                  ...
                  {allIntegrationsConnected && !typedStatus?.playbook && (
                    ...
                    >
                      Select Deal Risk Response Readiness Protocol
                    ...
                    {!completedPhases.includes('advance') ? (
                      <div className="space-y-4">
                        <p className="text-white/80">
                          Readiness OS captures institutional knowledge from every execution, so your organization gets smarter with each response.
                        </p>
                        <Button 
                          className="w-full bg-[#C9A84C] text-[#0A0F2E] hover:bg-[#DFC178] font-bold"
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-[#DFC178] mb-3 flex items-center gap-2">
                            ...
                            Recommended Readiness Protocol Improvements
                          </h4>
                          <div className="space-y-2">
