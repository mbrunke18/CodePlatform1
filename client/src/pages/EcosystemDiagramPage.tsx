          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32 }}>
            {[
              ...
              },
              {
                ...
                body: "Sitting above the Microsoft stack, Readiness OS monitors 221 executive triggers, maps them to 170 pre-staged Readiness Protocols, and fires coordinated responses in 12 minutes — inside Teams, M365, and Azure.",
                color: TEAL,
              },
              {
                phase: "03",
