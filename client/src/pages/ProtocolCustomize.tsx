...
export default function ProtocolCustomize() {
  ...
  const savePlaybook = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Readiness Protocol saved", description: "Your Readiness Protocol has been created successfully." });
      setLocation('/playbooks');
    },
    onError: (error: any) => {
      toast({ title: "Error", description: error.message || "Failed to save Readiness Protocol", variant: "destructive" });
    }
  });
  ...
  return (
    <PageLayout>
        ...
        <div className="max-w-[1600px] mx-auto px-6 pt-6 pb-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#C9A84C]">Readiness Protocol Architect</span>
                </div>
                <h1 style={CG} className="text-4xl font-bold text-white">
                  {isCreateMode ? "Architect New Readiness Protocol" : `Configure: ${template?.name || "Readiness Protocol"}`}
                </h1>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                {savePlaybook.isPending ? "Saving..." : "Deploy Readiness Protocol"}
              </Button>
            </div>
          </div>
        </div>
      ...
      {/* What staging this Readiness Protocol produces — visible before any section is edited */}
            ...
            <div className="p-8">
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      <Label className="text-[10px] uppercase tracking-widest font-bold text-[#6B7280]">Readiness Protocol Identity</Label>
                      <Input 
                        {...register("name")} 
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  <div className="flex items-center justify-between mb-2">
                    <div>
                      ...
                      <p className="text-sm text-[#6B7280]">Define what signals should activate this Readiness Protocol</p>
                    </div>
                    <Button 
              ...
              {activeSection === 'governance' && (
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2"><Label className="text-[10px] uppercase tracking-widest font-bold text-[#6B7280]">Readiness Protocol Owner</Label><Input {...register('playbookOwner')} placeholder="e.g. VP of Strategy" /></div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-[#F8F7F4] border border-[#E8E4DC]">
                    ...
                    <div><p className="text-sm font-bold text-[#0A0F2E]">Require Change Approval</p><p className="text-xs text-[#6B7280]">Any modification to this Readiness Protocol requires executive sign-off before saving</p></div>
                  </div>
                </div>
              )}
              ...
              {activeSection === 'compliance' && (
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-[#F8F7F4] border border-[#E8E4DC]">
                    ...
                    <div><p className="text-sm font-bold text-[#0A0F2E]">Audit Trail Required</p><p className="text-xs text-[#6B7280]">Every action during this Readiness Protocol's execution will be logged for compliance review</p></div>
                  </div>
                  <div className="space-y-4">
              ...
              {activeSection === 'escalation' && (
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  {escalationArray.fields.length === 0 && <div className="py-12 text-center border-2 border-dashed border-[#E8E4DC]"><ArrowUpRight className="w-10 h-10 text-[#C9A84C] mx-auto mb-3" /><p className="text-[#6B7280] font-medium">No escalation paths defined. Every serious Readiness Protocol needs one.</p></div>}
                  <div className="space-y-4">
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      { switchName: 'boardNotificationRequired' as const, label: 'Board Notification Required', desc: 'Board must be briefed as part of this Readiness Protocol execution' },
                ...
                <div className="space-y-8 animate-in fade-in duration-500">
                  <div className="flex items-center justify-between">
                    <div><h3 style={CG} className="text-2xl font-bold text-[#0A0F2E]">Business Impact</h3>
                      <p className="text-sm text-[#6B7280]">Quantify the value this Readiness Protocol delivers when executed effectively</p></div>
                  ...
                  {impactArray.fields.length === 0 && <div className="py-12 text-center border-2 border-dashed border-[#E8E4DC]"><TrendingUp className="w-10 h-10 text-[#C9A84C] mx-auto mb-3" /><p className="text-[#6B7280] font-medium">Define the measurable business value this Readiness Protocol protects or creates.</p></div>}
                  <div className="space-y-4">
              ...
              {activeSection === 'ownership' && (
                <div className="space-y-8 animate-in fade-in duration-500">
                  <div>
                    ...
                    <p className="text-sm text-[#6B7280] mt-1">The operational moat. The executive who activates this Readiness Protocol must have been in the room building it — not receiving it.</p>
                  </div>
                  ...
                  <div style={{ borderLeft: "3px solid #C9A84C", background: "#F8F7F4", padding: "24px 24px 24px 28px" }}>
                    ...
                    <div style={{ fontSize: 12, color: "#6B7280", fontWeight: 500 }}>
                      This section is where the Readiness Protocol owner formally exercises their challenge rights — before the trigger fires, not after.
                    </div>
                  </div>
                  ...
                  <div className="p-6 border border-[#E8E4DC] space-y-4">
                    ...
                    <p className="text-sm text-[#6B7280]">The owner of this Readiness Protocol was involved in its construction, not just its receipt.</p>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label className="text-[10px] uppercase tracking-widest font-bold text-[#6B7280]">Readiness Protocol Owner</Label>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-xs text-[#6B7280] mt-1">Document any assumption you question, gap you've identified, or condition where this Readiness Protocol would fail. These become the basis for the next revision cycle.</p>
                    </div>
                    <Textarea
                    ...
                    <div className="flex items-start gap-3 p-4" style={{ background: "rgba(43,138,110,0.06)", border: "1px solid rgba(43,138,110,0.2)" }}>
                      ...
                      <p className="text-xs" style={{ color: "#2B8A6E", lineHeight: 1.6 }}>
                        Challenge rights are permanent. Any assumption documented here creates a mandatory review obligation before this Readiness Protocol activates in a live scenario. The record stays with the Readiness Protocol through every revision.
                      </p>
                    </div>
                  </div>
