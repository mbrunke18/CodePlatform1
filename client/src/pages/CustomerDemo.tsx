...
const IDEA_STORY = [
  ...
  },
  {
    ...
    time: 30,
    description: "Execution OS comes with 170 playbooks across 9 domains—from cyber incidents to M&A integration to product launches. Each one pre-configured with smart defaults for your industry. You customize once, then it's ready for instant activation.",
    roleWins: [
  ...
  },
  {
    ...
    time: 50,
    description: "Execution OS's AI monitors competitive intelligence, regulatory filings, supply chain signals, and internal alerts. When it detects something relevant, it recommends the right playbook. You stay in control—AI recommends, you decide.",
    roleWins: [
