...
const IDEA_STORY = [
  ...
  },
  {
    ...
    time: 75,
    description: "ExecuteIQ forecasts which triggers are most likely to fire in the next 30, 60, and 90 days. Run what-if scenarios to see how your organization would respond. Get your team aligned BEFORE the crisis—not during it.",
    roleWins: [
  ...
  },
  {
    ...
    subtitle: "ExecuteIQ handles the coordination so you handle the crisis",
    phase: "EXECUTE",
    ...
    time: 120,
    description: "When you activate a playbook, ExecuteIQ instantly notifies all stakeholders, creates tasks in your existing PM tools (Jira, Asana, etc.), stages all documents, and unlocks pre-approved budgets. Your team sees their role-specific dashboard—they know exactly what to do.",
    roleWins: [
  ...
  },
  {
    ...
    time: 160,
    description: "After each execution, ExecuteIQ captures what worked, what didn't, and suggests improvements. This knowledge stays with your organization—not in the head of the executive who might leave. Your playbooks get better every time.",
    roleWins: [
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    ...
                    className={`text-sm ${manualMode ? 'text-emerald-400' : 'text-slate-300'}`}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {[1, 2, 4].map((speed) => (
                      <Button
                        ...
                        className={`text-xs px-2 ${playbackSpeed === speed ? 'text-emerald-400 bg-emerald-500/20' : 'text-slate-300'}`}
                            ...
                            {currentStage.smartDefaults.items.map((item, idx) => (
                              <div key={idx} className="flex items-start gap-2 text-sm">
                                ...
                                <div>
                                  ...
                                  <span className="text-slate-300">{item.defaults}</span>
                                </div>
                              </div>
                            ))}
                          </div>
                      ...
                      {!isComplete ? (
                        ...
                        <div className="space-y-4">
                          <div className="bg-emerald-900/30 border border-emerald-500/30 rounded-lg p-4 text-center">
                            ...
                            <p className="text-slate-300 text-sm">From signal to coordinated action: 12 minutes vs 72 hours</p>
                          </div>
                          ...
                          <div className="bg-slate-800/50 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              <div className="p-3 bg-emerald-900/30 rounded-lg border border-emerald-500/30">
                                ...
                                <div className="text-xs text-slate-300 mb-2">5 playbooks, 25 users</div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="text-xs text-slate-300 truncate">{stakeholder.role}</div>
                            </div>
