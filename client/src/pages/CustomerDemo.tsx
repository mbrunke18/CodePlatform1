...
const IDEA_STORY = [
  ...
  },
  {
    ...
    time: 75,
    description: "POISE forecasts which triggers are most likely to fire in the next 30, 60, and 90 days. Run what-if scenarios to see how your organization would respond. Get your team aligned BEFORE the crisis—not during it.",
    roleWins: [
  ...
  },
  {
    ...
    subtitle: "POISE handles the coordination so you handle the crisis",
    phase: "EXECUTE",
    ...
    time: 120,
    description: "When you activate a playbook, POISE instantly notifies all stakeholders, creates tasks in your existing PM tools (Jira, Asana, etc.), stages all documents, and unlocks pre-approved budgets. Your team sees their role-specific dashboard—they know exactly what to do.",
    roleWins: [
  ...
  },
  {
    ...
    time: 160,
    description: "After each execution, POISE captures what worked, what didn't, and suggests improvements. This knowledge stays with your organization—not in the head of the executive who might leave. Your playbooks get better every time.",
    roleWins: [
