...
const IDEA_STORY = [
  ...
  },
  {
    ...
    time: 50,
    description: "Readiness OS's AI monitors competitive intelligence, regulatory filings, supply chain signals, and internal alerts. When it detects something relevant, it recommends the right Readiness Protocol. You stay in control—AI recommends, you decide.",
    roleWins: [
  ...
  },
  {
    ...
    bgColor: "bg-[#C9A84C]/20",
    time: 120,
    description: "When you activate a Readiness Protocol, Readiness OS instantly notifies all stakeholders, creates tasks in your existing PM tools (Jira, Asana, etc.), stages all documents, and unlocks pre-approved budgets. Your team sees their role-specific dashboard—they know exactly what to do.",
    roleWins: [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Readiness Protocol Updates", value: "Suggested" },
