      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-800 dark:text-slate-300 mt-2">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-800 dark:text-slate-300">Playbook Maturity</span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-800 dark:text-slate-300">Execution Velocity</span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-800 dark:text-slate-300">Learning Rate</span>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-800 dark:text-slate-300">Signal Detection</span>
              ...
              <CardContent>
                <ScrollArea className="h-[500px]">
                  <div className="space-y-4">
                    {signalsLoading ? (
                      <p className="text-center text-gray-800">Loading signals...</p>
                    ) : weakSignals.length === 0 ? (
                      <p className="text-center text-gray-800">No weak signals detected</p>
                    ) : (
            ...
            <Card>
              ...
              <CardContent>
                <ScrollArea className="h-[500px]">
                  <div className="space-y-4">
                    {patternsLoading ? (
                      <p className="text-center text-gray-800">Loading patterns...</p>
                    ) : oraclePatterns.length === 0 ? (
                      <p className="text-center text-gray-800">No oracle patterns detected</p>
                    ) : (
              ...
              <CardContent>
                <ScrollArea className="h-[500px]">
                  <div className="space-y-3">
                    {activityLoading ? (
                      <p className="text-center text-gray-800">Loading activity...</p>
                    ) : activityFeed.length === 0 ? (
                      <p className="text-center text-gray-800">No recent activity</p>
                    ) : (
