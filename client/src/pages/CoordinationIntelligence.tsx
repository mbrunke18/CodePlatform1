            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  { label: 'Execution OS Target', subLabel: '12-minute execution benchmark', value: '12 min', pct: (12 / 43200) * 100, color: TEAL, note: 'Pre-staged coordination — ready before trigger fires' },
                ].map((row) => (
