          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            {isDemo && (
              <Badge style={{ background: 'rgba(201,168,76,0.15)', color: GOLD, border: `1px solid rgba(201,168,76,0.3)`, fontSize: 10, letterSpacing: '0.2em', padding: '4px 12px' }}>
                DEMO DATA — Activate Readiness Protocols to see your organization's real coordination record
              </Badge>
            )}
          </div>
        </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      { label: 'Readiness Protocol Library', path: '/playbook-library', icon: BarChart3 },
              ...
              <Card style={{ border: `2px solid ${GOLD}`, borderRadius: 0 }}>
                <CardContent className="p-6">
                  ...
                  <p style={{ fontSize: 12, color: MUTED, lineHeight: 1.65 }}>
                    When a high-stakes situation presents itself, competitors spend <strong style={{ color: NAVY }}>30 days</strong> figuring out who needs to be in the room. Your organization is already executing at <strong style={{ color: NAVY }}>minute 12</strong>. That is not a timing advantage. That is a 3,600× Execution Head Start.
                  </p>
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  { icon: TrendingUp, label: 'Every activation improves the Readiness Protocol', desc: 'Coordination times, bottlenecks, and outcomes are captured after every event. The platform learns. Your organization gets faster.' },
