...
const ROUNDS: RoadmapRound[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Readiness Protocol Library now filters by industry sector — Healthcare, Financial Services, Technology, Manufacturing, Retail, Energy. Each sector pack surfaces the prepared responses most relevant to that industry's dominant risk profile.",
