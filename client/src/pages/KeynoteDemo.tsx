...
function ActivationTimeline() {
  ...
  const steps = [
    ...
    { time: '0:30', label: 'Readiness Protocol Matched', detail: 'Competitive Response #47 selected', icon: BookOpen, color: 'text-[#C9A84C]' },
    ...
    introducing: (
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-8 bg-[#0A0F2E] relative overflow-hidden">
        ...
        >
          ...
          <span className="text-2xl text-[#C9A84C] font-light tracking-widest uppercase">Readiness Infrastructure</span>
          <div className="h-px w-16 bg-[#C9A84C]" />
        </motion.div>
        <motion.p
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <br />180 pre-built Readiness Protocols. 9 strategic domains. Pre-staged execution.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
    ...
    playbook: (
      <div className="flex flex-col items-center justify-center min-h-screen px-8 bg-[#F8F7F4]">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center mb-10">
          ...
          <p className="text-xl text-[#0A0F2E]">AI selects from 180 pre-built Readiness Protocols across 9 strategic domains</p>
        </motion.div>
        ...
        >
          <div className="bg-white border border-[#E8E4DC] overflow-hidden">
            <div className="bg-[#2B8A6E] border-b border-white/10 px-8 py-5 flex items-center justify-between">
              <div>
                <span className="text-white/60 text-[10px] font-bold uppercase tracking-[0.2em]">Recommended Readiness Protocol</span>
              ...
              <div className="text-right">
                <span className="text-white/60 text-[10px] font-bold uppercase tracking-[0.2em]">Readiness Protocol</span>
          ...
          <div className="bg-white border border-[#E8E4DC] p-10">
            ...
            <div className="bg-[#F8F7F4] border border-[#E8E4DC] p-6 mb-8 italic">
              <p className="text-lg text-[#0A0F2E] leading-relaxed">
                "Activate <span className="text-[#0A0F2E] font-bold not-italic underline decoration-[#C9A84C] decoration-2">Competitive Response Readiness Protocol #47</span> immediately.
            ...
            <div className="flex items-center justify-between p-6 bg-[#0A0F2E]/5 border border-[#0A0F2E]/10">
              ...
              >
                <div className="flex items-center gap-3 bg-[#2B8A6E] text-white px-6 py-3 font-bold text-lg">
                  ...
                  APPROVED — Activate Readiness Protocol
                </div>
              </motion.div>
            </div>
          </div>
    ...
    idea: (
      <div className="flex flex-col items-center justify-center min-h-screen px-8 bg-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-4 gap-6 max-w-6xl w-full relative z-10">
          {[
            { phase: 'IDENTIFY', subtitle: 'Readiness Protocol™', icon: BookOpen, color: 'bg-[#2B8A6E]', border: 'border-[#2B8A6E]/20', items: ['180 strategic Readiness Protocols', '3 domains: Growth & Positioning, Risk & Resilience, Transformation', 'Customizable task sequences', 'Pre-approved budget allocation', 'Role-based stakeholder mapping'] },
