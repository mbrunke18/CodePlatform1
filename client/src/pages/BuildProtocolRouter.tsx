...
const OPTIONS = [
  {
    ...
    description: 'Start here. Choose a situation from the library — Regulatory Investigation, Activist Investor, Cybersecurity, and more. The system pre-populates the right executive roles and situation variants. You define (or accept) what each role does in each variant. The result is a complete, executable call sheet ready before the trigger fires.',
    bestFor: 'Single-situation protocols · First protocol · Founding Partner onboarding',
    steps: ['Select situation', 'Confirm roles', 'Define situation variants', 'Build the role × situation matrix', 'Set authorization chain', 'Publish call sheet'],
