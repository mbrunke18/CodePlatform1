    ...
    <div className="print-page" style={{ minHeight: "100vh", background: IVORY, fontFamily: "'Barlow', sans-serif" }}>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "56px 40px 80px" }}>
        ...
        <div className="print-section" style={{ marginBottom: 44 }}>
          ...
          <Body>
            Readiness OS is the coordination layer enterprises are missing. It continuously monitors signals across 39 live data sources, matches patterns against 221 strategic triggers, and stages execution assets before any trigger fires. When the moment hits, the response is already built.
          </Body>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 20, margin: "24px 0" }}>
            ...
            <StatBlock value="221" label="Trigger Patterns" sub="Continuously monitored" />
        ...
        <div className="print-section" style={{ marginBottom: 44 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 1, background: "rgba(10,15,46,0.08)", border: "1px solid rgba(10,15,46,0.08)", marginTop: 20 }}>
            {[
              { letter: "I", phase: "Identify", detail: "Signal detection across 39 live sources. 221 trigger patterns scored in real time. Continuous monitoring — no manual triage." },
        ...
        <div className="print-section" style={{ marginBottom: 44 }}>
          ...
          <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 1 }}>
            {[
              { t: "T+0:00", label: "Signal Detected", body: "System-detected event matches a trigger pattern. Continuous monitoring against 221 patterns — no human triage required." },
