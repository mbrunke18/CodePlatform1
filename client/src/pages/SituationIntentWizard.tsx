...
const BRIEF_SUGGESTIONS = [
  ...
  "Pre-staged Readiness Protocol summary and first 3 actions",
        ...
        {step === 1 && (
          <div>
            ...
            <p style={{ fontSize: 15, color: MUTED, marginBottom: 32, lineHeight: 1.6 }}>
              ...
              Readiness Protocol gets deployed, which data points matter, and who gets notified when it fires.
            </p>
                ...
                <div style={{ background: "#fff", border: `1px solid ${BORDER}`, borderRadius: 0, padding: 16 }}>
                  <div style={{ display: "grid", gap: 10, marginBottom: 12 }}>
                    ...
                    >
                      ...
                      <option value="activation">On Readiness Protocol activation</option>
