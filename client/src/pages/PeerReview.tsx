    ...
    return (
      <div style={{ background: NAVY, minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 40, textAlign: "center" }}>
        <div style={{ maxWidth: 480 }}>
          ...
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.3em", textTransform: "uppercase", color: GOLD, marginBottom: 16 }}>VaughnMartin · Execution OS</div>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        {step === 2 && (
          <div>
            ...
            <QBlock num="Q5" question="After your review of Execution OS, how clearly did you understand what the product actually does?">
            ...
            <QBlock num="Q6" question="In your own words, what does Execution OS do?" note="Write this as if explaining it to a peer who has not seen it.">
            ...
            <QBlock num="Q9" question="Which of the following best describes how you see Execution OS after your review?" note="Select all that apply.">
        ...
        {step === 3 && (
          <div>
            ...
            <QBlock num="Q10" question="Do you believe there is a genuine market need for a product like Execution OS?">
            ...
            <QBlock num="Q11" question="Who in an organization would most likely be the person to champion a purchase of Execution OS?" note="Select the single most likely buyer.">
            ...
            <QBlock num="Q12" question="What would most likely prevent an organization from purchasing Execution OS?" note="Select all that apply.">
            ...
            <QBlock num="Q13" question="At what price point would a 90-day pilot of Execution OS represent good value to an enterprise organization?">
            ...
            <QBlock num="Q14" question="Which industries or organizational types would most immediately benefit from Execution OS?" note="Set H (High), M (Medium), or L (Low) priority for each.">
        ...
        {step === 4 && (
          <div>
            ...
            <QBlock num="Q15" question="What is the single most significant gap or weakness you identified in Execution OS?">
            ...
            <QBlock num="Q19" question="Are there existing tools or platforms in your organization that Execution OS would need to displace or integrate with to be adopted?">
        ...
        {step === 5 && (
          <div>
            ...
            <QBlock num="Q20" question="Are you aware of any existing product or platform that does what Execution OS does — specifically pre-staged, AI-activated strategic execution playbooks that deploy across an organization in minutes?">
            ...
            <QBlock num="Q21" question="How does Execution OS compare to the tools your organization currently uses to manage strategic response situations?">
            ...
            <QBlock num="Q22" question="What is the strongest competitive argument against Execution OS — the reason a well-informed buyer might choose to do nothing or use an alternative?">
        ...
        {step === 6 && (
          <div>
            ...
            <QBlock num="Q23" question="Overall, how would you rate Execution OS as a product?">
            ...
            <QBlock num="Q25" question="Do you believe Execution OS is a viable commercial product in the real world?">
            ...
            <QBlock num="Q26" question="Would you refer Execution OS to a peer or colleague in a relevant role?">
