...
const TASKS: Task[] = [
  ...
  { id: '5', time: 4, title: 'CEO briefing package auto-generated', stakeholder: 'Readiness OS', type: 'ai', completed: false },
  { id: '6', time: 5, title: 'Regulatory notification template populated', stakeholder: 'Readiness OS', type: 'ai', completed: false },
  ...
  { id: '9', time: 8, title: 'AI auto-requested data from Security team', stakeholder: 'Readiness OS', type: 'ai', completed: false },
  ...
  { id: '13', time: 12, title: 'Customer notification initiated (2.4M emails)', stakeholder: 'Readiness OS', type: 'ai', completed: false },
  ...
  { id: '15', time: 14, title: 'All 47 tasks completed - breach contained', stakeholder: 'Readiness OS', type: 'complete', completed: false },
];
          ...
          <Card className="mt-6 border-[#2B8A6E]/30">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-800 mb-6">
                Traditional response time: 17 days. Readiness OS response: 12 minutes.
              </p>
