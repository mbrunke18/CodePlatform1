    ...
    return (
      <>
        ...
        <main className="max-w-4xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-gray-600 mb-6">The requested playbook could not be located.</p>
            ...
            <div className="pt-4 border-t">
              {!isAuthenticated ? (
                <div className="text-center py-4">
                  <p className="text-gray-600 mb-4">Sign in to execute this playbook</p>
                ...
                <div className="text-center py-4">
                  <p className="text-gray-600 mb-4">No organization configured</p>
            ...
            <CardContent className="space-y-4">
              {Array.isArray(playbook.tier1Stakeholders) && playbook.tier1Stakeholders.length > 0 && (
                <div>
                  ...
                  <p className="text-sm text-gray-600">{(playbook.tier1Stakeholders as string[]).join(", ")}</p>
                </div>
              )}
              {Array.isArray(playbook.tier2Stakeholders) && playbook.tier2Stakeholders.length > 0 && (
                <div>
                  ...
                  <p className="text-sm text-gray-600">{(playbook.tier2Stakeholders as string[]).join(", ")}</p>
                </div>
              )}
              {Array.isArray(playbook.tier3Stakeholders) && playbook.tier3Stakeholders.length > 0 && (
                <div>
                  ...
                  <p className="text-sm text-gray-600">{(playbook.tier3Stakeholders as string[]).join(", ")}</p>
                </div>
              )}
            </CardContent>
          </Card>
