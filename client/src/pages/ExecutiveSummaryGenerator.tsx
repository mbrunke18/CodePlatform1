...
export default function ExecutiveSummaryGenerator() {
      ...
      printWindow.document.write(`
        <html>
          ...
          <body>
            ...
            <div class="meta">
              Generated by ExecuteIQ Strategic Execution OS | ${new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })} | ${industry} Sector
            </div>
          </body>
        </html>
      `);
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `ExecuteIQ-${selectedReport}-${new Date().toISOString().split('T')[0]}.md`;
                      ...
                      {reportTypes.map((type) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 ml-6">{type.description}</p>
                          </button>
                        );
                      })}
                    </div>
