    ...
    <div>
      ...
      <div style={{ background: `${scenario.color}10`, border: `1px solid ${scenario.color}30`, borderLeft: `4px solid ${scenario.color}`, borderRadius: 4, padding: '20px 24px', marginTop: 28 }}>
        <p style={{ fontSize: 14, color: '#1E293B', lineHeight: 1.7, margin: 0, fontWeight: 600 }}>
          Without pre-staged execution, every decision is being made for the first time, under pressure, by people who haven't rehearsed this scenario. Execution OS changes the constraint.
        </p>
      </div>
    </div>
  );
      ...
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{ marginBottom: 52 }}>
          ...
          <p style={{ fontSize: 16, color: '#475569', maxWidth: 620, lineHeight: 1.75, fontWeight: 500 }}>
            Each walk-through uses real Execution OS playbooks, the full IDEA chain, and authentic 12-minute execution data — staged for the specific trigger your organization faces.
          </p>
        </div>
