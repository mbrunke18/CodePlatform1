...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    question: "Does your organization have pre-defined Readiness Protocols for strategic scenarios?",
    context: "Pre-staged responses with predetermined stakeholders, tasks, and budgets.",
    options: [
      { value: "comprehensive", label: "Yes, comprehensive Readiness Protocols for most scenarios", score: 100 },
      { value: "some", label: "Some Readiness Protocols for major scenarios", score: 75 },
      { value: "crisis_only", label: "Only for crisis situations", score: 50 },
      { value: "informal", label: "Informal, undocumented processes", score: 25 },
      { value: "none", label: "No predefined Readiness Protocols—we figure it out each time", score: 0 }
    ]
  },
  {
                  ...
                  <CardContent className="p-6">
                    ...
                    {score < 60 ? (
                      ...
                      <div className="text-left space-y-3">
                        ...
                        <p className="text-[#0A0F2E] dark:text-[#C9A84C]">
                          Readiness OS can help you close the remaining gap with <span className="text-[#2B8A6E] font-semibold">pre-staged Readiness Protocols and 12-minute execution</span>.
                        </p>
                      </div>
                    )}
                  </CardContent>
