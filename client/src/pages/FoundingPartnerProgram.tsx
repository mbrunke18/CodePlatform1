  ...
  return (
    <PageLayout className="vm-page-fpp">
      <div className="bg-[#F8F7F4] dark:bg-[#0A0F2E]">
        ...
        <section style={{ padding: '80px 32px', background: '#fff', borderTop: '1px solid #E8E4DC' }}>
            ...
            <div style={{ display: 'grid', gap: 2 }}>
              {[
                ...
                <div key={i} style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', border: '1px solid #E8E4DC', borderTopWidth: i === 0 ? 1 : 0, borderTopColor: i === 0 ? '#E8E4DC' : 'transparent' }}>
                  <div style={{ padding: '24px 28px', borderRight: '1px solid #E8E4DC', background: '#FAFAF8' }}>
                  ...
                  <div style={{ padding: '24px 32px', background: '#fff', display: 'flex', alignItems: 'center' }}>
                    <p style={{ fontSize: 13, color: '#374151', lineHeight: 1.75, margin: 0 }}>{item.a}</p>
                  </div>
                </div>
              ))}
            </div>
            <div style={{ marginTop: 28, padding: '20px 28px', background: '#F8F7F4', borderLeft: '3px solid #2B8A6E', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
