...
const roles = [
  ...
  },
  {
    ...
    color: TEAL,
    sees: [
      { label: 'Command Center', detail: 'Live view of who owns what task, what is overdue, where bottlenecks are forming, and Readiness Protocol progress across all active workstreams — without a single status meeting.' },
      { label: 'Live Activation Center', detail: 'Step-by-step Readiness Protocol execution in real time. Stakeholder acknowledgment tracking, task completion rate, and the live 3,600× Execution Head Start as execution progresses.' },
    ...
    pages: [
      ...
      { label: 'Readiness Protocol Library', href: '/playbook-library' },
    ],
  },
  {
    id: 'finance',
