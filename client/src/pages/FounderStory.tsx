      ...
      <main style={{ background: "#fff" }}>
        <div style={{ maxWidth: 740, margin: "0 auto", padding: "80px 32px" }}>
          ...
          <div style={{ paddingBottom: 64, marginBottom: 56, borderBottom: `1px solid ${BORDER}` }}>
            ...
            <Body>
              I carried those four words from a third-grade football field through twenty years inside enterprise organizations. Into every boardroom, every sideline, every organization that was either ready when the moment came or scrambling to build the response after the signal had already fired. The pattern was the same everywhere I looked: the organizations that had prepared in advance moved without fear. The ones that had not were still aligning when the window closed.
            </Body>
            <Body>
          ...
          <div style={{ background: "#F0EDE4", border: `1px solid ${BORDER}`, borderLeft: `4px solid ${NAVY}`, padding: "44px 40px", margin: "48px 0" }}>
            ...
            <p style={{ fontSize: 16, lineHeight: 1.85, color: "#374151", marginBottom: 20 }}>
              There is a concept in football called four-down territory — and it is almost always misunderstood. Most people think it refers to a specific yard line on the field. It does not. Four-down territory is a mindset. A situational decision. The offense that enters four-down territory is not necessarily planning to use the fourth down. The real advantage is that having the fourth down available changes how they call plays on the first three. They can stay on schedule. Create manageable situations. Sustain the drive without forcing a conversion on every third down. The fourth down does not need to convert. It needs to exist. Its presence changes everything upstream.
            </p>
            <p style={{ fontSize: 16, lineHeight: 1.85, color: "#374151", marginBottom: 20 }}>
              Every organization running Readiness OS is operating in four-down territory. Not because they expect to activate every protocol. Because having 180 pre-staged protocols and 231 detection thresholds monitored continuously changes how leadership operates before any trigger fires. Decisions are calmer. Pivots are faster. There is no scramble to build the response in real time because the response already exists. The enterprise equivalent of four-down territory is not a crisis management posture — it is a permanent operational advantage. The preparation changes the entire series, not just the moment it is called upon.
            </p>
