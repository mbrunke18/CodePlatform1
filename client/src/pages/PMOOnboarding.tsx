        ...
        <div style={{ background: "#fff", padding: "72px 48px", borderBottom: `1px solid ${BORDER}` }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <h2 style={{ ...CG, fontSize: "clamp(30px,4vw,48px)", fontWeight: 700, color: NAVY, lineHeight: 1.1, marginBottom: 28 }}>
              You own the preparation gap.<br />
              <em style={{ color: GOLD, fontStyle: "italic" }}>Until now, there was no infrastructure for it.</em>
            </h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 40, marginBottom: 48, alignItems: "start" }}>
              <div>
                <p style={{ fontSize: 16, color: "#374151", lineHeight: 1.8, marginBottom: 20 }}>
                  When a strategic trigger fires — a competitor makes a decisive move, a regulatory action lands, a supply chain collapses — someone has to mobilize the organization. Stakeholders identified. Tasks assigned. Briefs drafted. Authorization paths clarified. That falls to you. And it happens from scratch, under pressure, every time — because there has never been a place to build it in advance.
                </p>
                <p style={{ fontSize: 16, color: "#374151", lineHeight: 1.8 }}>
                  The result is a 30-day mobilization cycle before execution even begins. Not because the organization lacks talent. Because it lacks <strong style={{ color: NAVY }}>preparation infrastructure.</strong>
                </p>
              </div>
              <div>
                <p style={{ fontSize: 16, color: "#374151", lineHeight: 1.8, marginBottom: 20 }}>
                  Your accountability spans three strategic domains: growth &amp; positioning, risk &amp; resilience, and transformation. In each domain, there are scenarios your organization will face — some planned, some triggered without warning. For each one, the response needs to be built, assigned, and staged <em>before</em> the situation presents itself.
                </p>
                <p style={{ fontSize: 16, color: "#374151", lineHeight: 1.8 }}>
                  That is preparation architecture. That is your role. Readiness OS is the first platform built to give it infrastructure — so the response is ready before the trigger fires.
                </p>
              </div>
            </div>

            {/* Three-domain accountability map */}
              ...
              {[
                {
                  ...
                  label: "Strategic Growth Preparation",
                  color: TEAL,
                  desc: "Market entries. Competitive responses. M&A mobilization. Protocols pre-staged before the strategic window opens.",
                },
                {
                  domain: "RISK & RESILIENCE",
                  label: "Risk & Continuity Preparation",
                  color: "#C0392B",
                  desc: "Ransomware. Regulatory action. Supply chain disruption. Response architecture ready before the trigger fires.",
                },
                {
                  domain: "TRANSFORMATION",
                  label: "Transformation Preparation",
                  color: GOLD,
                  desc: "Workforce shifts. Technology transitions. Operating model changes. Execution staged before the announcement is made.",
                },
              ].map(({ domain, label, color, desc }) => (
            ...
            <div style={{ background: NAVY, padding: "32px 36px", marginTop: 40, borderLeft: `3px solid ${GOLD}` }}>
              <p style={{ ...CG, fontSize: "clamp(18px,2.2vw,24px)", fontStyle: "italic", color: "#fff", lineHeight: 1.6, margin: "0 0 12px" }}>
                "The preparation gap is not a failure of talent. It is a failure of infrastructure. Readiness OS is the first platform built to close it."
              </p>
