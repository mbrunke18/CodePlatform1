...
const competitors: Competitor[] = [
  {
    ...
    oneLiner: "You've already bought the engine. Execution OS is the transmission.",
  ...
  },
  {
    ...
    theGap: "ServiceNow automates execution of known processes. Execution OS orchestrates mobilization for unexpected strategic events. These are genuinely different problems. ServiceNow manages your work after someone decides what work to do. Execution OS decides what work starts and who starts it the moment a trigger fires.",
    oneLiner: "ServiceNow manages your work. Execution OS deploys your people.",
    isComplementary: true,
  },
  {
    name: "Palantir AIP",
    ...
    theGap: "Palantir can feed signals into Execution OS. They are complementary, not competing. Palantir is data infrastructure; Execution OS is execution infrastructure. The honest message: Palantir will tell you what's happening with unmatched depth. Execution OS ensures what's happening gets acted on in 12 minutes.",
    oneLiner: "Palantir tells you. Execution OS deploys you.",
    isComplementary: true,
  },
  {
    name: "Everbridge",
    ...
    theGap: "Every Everbridge customer has already accepted that crisis coordination is a problem worth paying for. They bought half the solution. The market leader in alerting has $400M in revenue and the response time problem is completely unsolved. That is the market signal that Execution OS addresses.",
    oneLiner: "Everbridge tells your people. Execution OS deploys them.",
  },
  {
    ...
    theGap: "Fortune 1000 organizations spend hundreds of thousands annually on GRC platforms to prove they have a plan. Execution OS is what actually executes the plan when it matters. GRC satisfies auditors. Execution OS protects the business.",
    oneLiner: "Your GRC platform proves you had a plan. Execution OS proves the plan worked — in 12 minutes.",
  },
  {
  ...
  },
  {
    ...
    theGap: "Execution OS integrates with all of them. When Execution OS activates a playbook, it pushes tasks directly into your existing Jira or Asana. These tools are the destination for the work Execution OS initiates — not a competitor.",
    oneLiner: "Jira tracks tasks after someone creates them. Execution OS creates the right tasks and fires them in 12 minutes — before anyone has had a meeting.",
    isComplementary: true,
  },
  {
    ...
    theGap: "McKinsey will analyze your execution gap after the crisis. Execution OS closes it before the crisis arrives — continuously, automatically, at a fraction of the cost. $75K pilot vs. $3M+ consulting engagement is not the same conversation. Execution OS runs 24/7, not episodically.",
    oneLiner: "McKinsey analyzes your execution gap after the crisis. Execution OS closes it before.",
  },
];
...
const fiveReasons = [
  {
    ...
    body: "Every competitor reacts to triggers. Execution OS is already staged before the trigger fires. 170 playbooks across 9 domains. 221 configured trigger signatures. When the trigger fires, your organization is not starting from zero — it is executing from a pre-positioned stance. No competitor offers this.",
  ...
  },
  {
    ...
    body: "Microsoft sells intelligence. ServiceNow sells process automation. Palantir sells data integration. Everbridge sells notification. None of them sell the operating model that sits above all of these and coordinates humans at AI speed. Execution OS is that layer — and it works with every tool your organization already has.",
  ...
  },
  {
    ...
    body: "$75K flat. 90 days. 100% credited to the enterprise contract. At least one live activation with a measured 12-minute response, or the data shows why not. No competitor offers this because no competitor is confident enough in their outcome to structure an engagement this way. Execution OS does.",
...
export default function WhyExecutionOS() {
  ...
  useEffect(() => {
    updatePageMetadata({
      title: "Why Execution OS — The Competitive Landscape | VaughnMartin",
      description: "Why Execution OS wins against Microsoft Copilot, ServiceNow, Palantir, Everbridge, and every other enterprise platform. The operating model layer no one else provides.",
      ogTitle: "Why Execution OS? Honest Competitive Analysis",
          ...
          <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1, textAlign: "center" }}>
            ...
            <div className="grid md:grid-cols-2 gap-0 max-w-3xl mx-auto mt-10 text-left border border-white/10">
              ...
              <div style={{ background: "rgba(201,168,76,0.06)", padding: "28px 28px" }}>
                ...
                {["The operating model that coordinates humans at AI speed", "Pre-staged playbooks that fire before the trigger", "12-minute stakeholder cascade — fully automated", "Trigger-to-execution without a single meeting", "Infrastructure that runs 24/7, not episodically"].map(item => (
                  <div key={item} className="flex items-center gap-3 mb-3">
        ...
        <section style={{ background: "#fff", padding: "56px 48px", borderBottom: "2px solid #E8E4DC" }}>
          <div style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
            ...
            <p style={{ fontSize: 15, color: "#4B5563", lineHeight: 1.8 }}>
              Better data. Better analysis. Better summaries. Better notifications. Better task tracking. The gap between "we know this is happening" and "every relevant person has their task, is accountable, and is executing" remained entirely human-dependent, meeting-dependent, and slow. That gap is 30 days. Execution OS is the first platform that closes it — not by making the inputs faster, but by replacing the coordination model itself.
            </p>
          </div>
        </section>
                      ...
                      <div style={{ padding: "0 24px 24px", borderTop: "1px solid #F3F4F6" }}>
                        <div className="grid md:grid-cols-3 gap-4 mt-4">
                          ...
                          <div style={{ padding: "16px", background: "rgba(201,168,76,0.04)", border: `1px solid ${GOLD}` }}>
                            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: GOLD, marginBottom: 8 }}>The Execution OS advantage</div>
          ...
          <div style={{ maxWidth: 900, margin: "0 auto", position: "relative", zIndex: 1 }}>
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              ...
              <h2 style={{ ...CG, fontSize: "clamp(30px,4vw,48px)", fontWeight: 700, color: "#fff", marginBottom: 12 }}>
                5 reasons Execution OS<br />wins every comparison
              </h2>
        ...
        <section style={{ background: "#fff", padding: "64px 48px", borderTop: "2px solid #E8E4DC" }}>
          <div style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
            ...
            <blockquote style={{ ...CG, fontSize: "clamp(22px,3vw,34px)", fontWeight: 700, color: NAVY, lineHeight: 1.3, fontStyle: "italic", marginBottom: 24, borderLeft: `4px solid ${GOLD}`, paddingLeft: 24, textAlign: "left" }}>
              "Every enterprise has tools that tell them what's happening. None have the infrastructure that deploys their people when it does. That is Execution OS."
            </blockquote>
            <p style={{ fontSize: 15, color: "#4B5563", lineHeight: 1.8, maxWidth: 640, margin: "0 auto 40px" }}>
              In the next 12 months, your organization will face at least 3–5 strategic triggers requiring cross-domain coordination. For each one, you currently spend weeks mobilizing before execution begins. Execution OS pre-stages the response to each one before it fires. The question is not whether you can afford Execution OS. The question is how many of those events you can afford to handle the old way.
            </p>

            {/* Proof bar */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
              {[
                { v: "170", l: "Pre-staged playbooks" },
