...
const competitors: Competitor[] = [
  ...
  },
  {
    ...
    whereTheyStop: "Palantir tells you what is happening with extraordinary sophistication. It does not then automatically assign tasks, notify your General Counsel, route your CISO to the right response protocol, or activate a pre-staged Prepared Response. The gap from intelligence to coordinated human execution remains entirely manual. Deployment typically takes 6–24 months and requires dedicated data engineers.",
  ...
  },
  {
    ...
    whereTheyStop: "Notification is not coordination. Everbridge tells people something happened. It does not assign them tasks. It does not activate a pre-staged Prepared Response. It does not connect the alert to a timeline, a decision gate, a war room, or an accountability system. After the alert goes out, you're back to the same phone tree, the same emergency meeting, and the same 30-day mobilization cycle — just with better message delivery.",
