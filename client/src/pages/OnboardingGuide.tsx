...
export default function OnboardingGuide() {
  useEffect(() => {
    document.title = "Executive Onboarding Guide — VaughnMartin Execution OS";
  }, []);
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 40px 80px" }}>
        ...
        <div style={{ background: NAVY, borderRadius: "0 0 16px 16px", padding: "64px 56px 56px", marginBottom: 56, position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <p style={{ fontSize: 17, color: "rgba(255,255,255,0.55)", margin: "0 0 40px", maxWidth: 520, lineHeight: 1.6 }}>
              Everything you need to understand, activate, and operate your Execution OS from day one.
            </p>
        ...
        <Section id="overview">
          <SectionHeader
            ...
            subtitle="Execution OS is not a reporting tool or a dashboard. It is the operating infrastructure that compresses your mobilization cycle from 30 days to 12 minutes — before a strategic trigger fires, not after."
          />
        ...
        <Section id="demos">
          <SectionHeader
            ...
            subtitle="These pages require no login. Share them with board members, stakeholders, or team members to demonstrate Execution OS before they have platform access."
          />
        ...
        <Section id="first-month">
          <SectionHeader
            ...
            subtitle="A suggested schedule for getting maximum value from your Execution OS pilot."
          />
        ...
        <div style={{ borderTop: "1px solid #E5E7EB", paddingTop: 32, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: 13, fontWeight: 800, color: NAVY }}>VaughnMartin Execution OS</div>
