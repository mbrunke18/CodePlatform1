          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="flex items-end justify-between gap-12">
              <div className="max-w-3xl">
                ...
                <p className="text-white/60 text-xl leading-relaxed max-w-2xl">Execution OS orchestrates your entire enterprise stack through bi-directional strategic synchronization.</p>
              </div>
