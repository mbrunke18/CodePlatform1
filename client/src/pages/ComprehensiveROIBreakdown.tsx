                      ...
                      {scenarioData.map((scenario, index) => (
                        ...
                        >
                          <td className="py-3 px-4">
                            ...
                            <div className="text-sm text-slate-600 dark:text-slate-300">{scenario.purpose}</div>
                          </td>
                          <td className="py-3 px-4">
                            <Badge 
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-sm text-slate-600 dark:text-slate-300">annual value</div>
                        </div>
                      </div>
