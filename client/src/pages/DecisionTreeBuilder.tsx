              ...
              {options.map((option, index) => (
                ...
                >
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-3">
                      <label className="text-[10px] font-bold uppercase tracking-widest text-[#0A0F2E]">
                        Execute Readiness Protocol on Selection
                      </label>
                      <Select>
                        <SelectTrigger className="rounded-none border-[#E8E4DC] h-12 bg-white">
                          <SelectValue placeholder="Select Readiness Protocol..." />
                        </SelectTrigger>
                        <SelectContent className="rounded-none border-[#E8E4DC]">
                          <SelectItem value="public-disclosure">Public Disclosure Readiness Protocol</SelectItem>
                          <SelectItem value="crisis-comms">Crisis Communications Readiness Protocol</SelectItem>
                          <SelectItem value="regulatory">Regulatory Notification Readiness Protocol</SelectItem>
                          <SelectItem value="internal-only">Internal Assessment Readiness Protocol</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
