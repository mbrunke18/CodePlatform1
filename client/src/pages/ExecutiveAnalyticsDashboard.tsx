...
export default function ExecutiveAnalyticsDashboard() {
  ...
  const getInsightColor = (category: string) => {
    switch (category) {
      case 'achievement': return 'bg-[#2B8A6E]/10 text-[#2B8A6E] border-none';
      case 'opportunity': return 'bg-[#0A0F2E]/10 text-[#0A0F2E] border-none';
      case 'risk': return 'bg-red-500/10 text-red-700 border-none';
      case 'alert': return 'bg-[#C9A84C]/10 text-[#C9A84C] border-none';
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'medium': return 'bg-[#C9A84C] text-[#0A0F2E] border-none';
      case 'low': return 'bg-[#2B8A6E] text-white border-none';
      ...
      <div className="flex-1 bg-[#F8F7F4] overflow-y-auto p-8 space-y-8">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-gray-500">
            <Link to="/">
              <Button variant="ghost" size="sm" className="text-gray-500 hover:text-[#0A0F2E] p-0 h-auto">
                HOME
              </Button>
            </Link>
            <span>/</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
          <Card className="bg-white border-[#E8E4DC] rounded-none shadow-sm">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Active Users</h3>
              ...
              <div className="text-xs text-gray-400 mt-1 uppercase tracking-widest font-bold">Live concurrent</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-[#E8E4DC] rounded-none shadow-sm">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Revenue</h3>
              ...
              <div className="text-xs text-gray-400 mt-1 uppercase tracking-widest font-bold">Today's total</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-[#E8E4DC] rounded-none shadow-sm">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Conversion</h3>
              ...
              <div className="text-xs text-gray-400 mt-1 uppercase tracking-widest font-bold">Target: 4.0%</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-[#E8E4DC] rounded-none shadow-sm">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Customer Sat</h3>
              ...
              <div className="text-xs text-gray-400 mt-1 uppercase tracking-widest font-bold">Industry leading</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white border-[#E8E4DC] rounded-none shadow-sm">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">System Health</h3>
              ...
              <div className="text-xs text-gray-400 mt-1 uppercase tracking-widest font-bold">SLA compliant</div>
            </CardContent>
          </Card>
        </div>
          ...
          <TabsContent value="overview" className="space-y-6 mt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {executiveMetrics.map((metric) => (
                <Card key={metric.id} className="bg-white border-[#E8E4DC] rounded-none hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-[10px] font-bold uppercase tracking-widest text-gray-500">{metric.name}</h3>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <div className="text-right">
                        <div className="text-[10px] font-bold uppercase tracking-widest text-gray-400">Confidence</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                      <div>
                        <div className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Projected Impact</div>
                        <div className="text-lg font-bold text-[#2B8A6E]" style={CG}>{insight.impact}</div>
                      </div>
                      
                      <div>
                        <div className="text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">Recommended Actions</div>
