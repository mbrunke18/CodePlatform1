...
const PLAYBOOK_OPTIONS = [
  {
    ...
    name: "Competitive Response Readiness Protocol",
  ...
  },
  {
    ...
    name: "Regulatory Compliance Readiness Protocol",
  ...
  {
    id: "market_expansion",
    name: "Market Expansion Readiness Protocol",
  ...
  },
  {
    ...
    name: "Crisis Management Readiness Protocol",
  ...
  const startExecution = () => {
    ...
    const events: Omit<ExecutionEvent, "status">[] = [
      { 
        ...
        valueCallout: "Readiness OS monitors 50+ data sources 24/7 so you never miss a critical signal",
                ...
                <Card className="border-[#E8E4DC] dark:border-slate-800">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-[#0A0F2E]">
                      ...
                      Step 3: Select a Readiness Protocol
                    </CardTitle>
                    <CardDescription>
                  ...
                  <CardContent className="space-y-6">
                    <div className="bg-[#F8F7F4] dark:bg-[#141B45]/50 p-6 space-y-4 border border-[#E8E4DC]">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <p className="text-sm text-[#6B7280] dark:text-slate-300">Readiness Protocol to Execute</p>
                    ...
                    <div className="bg-[#F8F7F4] dark:bg-[#2B8A6E]/15 p-4 border border-[#2B8A6E] dark:border-[#2B8A6E]">
                      ...
                      <ul className="text-sm text-[#2B8A6E] dark:text-[#2B8A6E] space-y-1">
                        ...
                        <li>• Readiness Protocol activation with task and stakeholder assignments</li>
                      ...
                      >
                        <div className="bg-gradient-to-br from-[#2B8A6E] to-[#3BAF8A] dark:from-[#2B8A6E]/15 dark:to-[#3BAF8A]/40 p-6 border border-[#2B8A6E] dark:border-[#2B8A6E]">
                          ...
                          <p className="text-sm text-gray-800 dark:text-slate-300 text-center mb-6">
                            In production, Readiness OS also creates Jira tickets, notifies Slack channels, stages documents, and unlocks pre-approved budgets—all automatically.
                          </p>
