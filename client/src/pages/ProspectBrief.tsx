        ...
        <div style={{ background: NAVY, padding: "32px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
              <span style={{ padding: "10px 24px", background: GOLD, color: NAVY, fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em" }}>vaughnmartin.com/request-access</span>
