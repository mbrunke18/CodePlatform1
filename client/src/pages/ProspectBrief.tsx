...
const IDEA_PHASES = [
  { letter: "I", name: "IDENTIFY", desc: "170 playbooks pre-built and staged across 9 domains. Nothing improvised. Everything ready before the trigger fires." },
        ...
        <div style={{ width: "100%", maxWidth: 560 }}>
          ...
          <div style={{ background: "#fff", border: `1px solid ${BORDER}`, borderTop: `4px solid ${GOLD}`, padding: "40px 40px 36px" }}>
            ...
            <p style={{ fontSize: 13, color: MUTED, textAlign: "center", marginBottom: 32, lineHeight: 1.6 }}>
              A printable 2-page document showing exactly how Execution OS would deploy for this organization — specific playbooks, triggers, and ROI.
            </p>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 40px", background: "#fff" }} className="brief-doc">
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 14, color: "#374151", lineHeight: 1.8, margin: 0 }}>
            ...
            Execution OS eliminates it. The decision is the same. The mobilization cycle is pre-staged. Response begins in <strong>12 minutes</strong>.
          </p>
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 1, background: BORDER, marginBottom: 36, border: `1px solid ${BORDER}` }}>
          {[
            ...
            { label: "Playbooks Armed", value: `${playbookCount}`, sub: `in ${form.industry}` },
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 13, color: MUTED, marginBottom: 20, lineHeight: 1.6 }}>
            {playbookCount} playbooks are pre-built and staged in {form.industry}. The following are immediately relevant based on your domain and concern:
          </p>
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 11, color: MUTED, marginTop: 10 }}>
            Monitored every 15 minutes across 8 live signal sources. Alert sent to stakeholders within 12 minutes of threshold crossing.
          </p>
        </div>
        ...
        <div style={{ marginBottom: 36, padding: "20px 24px", background: "rgba(10,15,46,0.04)", border: `1px solid ${BORDER}` }}>
          ...
          <p style={{ fontSize: 13, color: NAVY, lineHeight: 1.7, margin: 0 }}>
            ...
            Execution OS is the operating model layer above it. Not a replacement. An orchestrator that makes the Microsoft investment immediately executable at a strategic level.
          </p>
        </div>
        ...
        <div style={{ background: NAVY, padding: "32px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.55)", margin: "0 0 20px", lineHeight: 1.6 }}>
              Deployable in 2 weeks. {playbookCount} playbooks pre-built for {form.industry}. Your triggers armed from day one. No rip-and-replace — sits above your existing Microsoft infrastructure.
            </p>
            <div style={{ display: "flex", gap: 16, alignItems: "center", flexWrap: "wrap" }}>
              ...
              <span style={{ fontSize: 12, color: "rgba(255,255,255,0.4)" }}>pilot@vaughnmartin.com</span>
            </div>
          </div>
        </div>
