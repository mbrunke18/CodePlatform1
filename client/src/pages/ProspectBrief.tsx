...
const IDEA_PHASES = [
  ...
  { letter: "D", name: "DETECT", desc: "248+ data points monitored every 15 minutes across 15 pre-configured signal sources — news, regulatory, SEC, cybersecurity, and government enforcement. 221 trigger patterns armed and ready." },
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 40px", background: "#fff" }} className="brief-doc">
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <p style={{ fontSize: 11, color: MUTED, marginTop: 10 }}>
            Monitored every 15 minutes across 15 pre-configured signal sources — news, SEC EDGAR, CISA, FDA, FTC, DOJ, and Reuters. Alert sent to stakeholders within 12 minutes of threshold crossing.
          </p>
        </div>
