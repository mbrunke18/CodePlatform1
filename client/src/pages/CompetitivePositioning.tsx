...
const comparisonRows = [
  ...
  { feature: "180 pre-built strategic Readiness Protocols", execOS: "yes", crisis: "no", pm: "no" },
  ...
  { feature: "Strategic Readiness Protocol customization", execOS: "yes", crisis: "no", pm: "no" },
...
const useCases = [
  ...
  },
  {
    ...
    with: "Leadership Continuity Readiness Protocol activates instantly — succession, communications, board briefing, and talent sourcing tasks assigned automatically",
    icon: Users,
  },
  {
    ...
    with: "Regulatory Crisis Readiness Protocol fires — legal, compliance, communications, and executive tasks mobilized with pre-approved response templates in 12 minutes",
    icon: Shield,
  },
  {
    ...
    with: "Activist Response Readiness Protocol activates — investor relations, legal defense, board briefing, and public narrative tasks launched immediately",
    icon: AlertTriangle,
  },
];
...
export default function CompetitivePositioning() {
  ...
  useEffect(() => {
    updatePageMetadata({
      title: "Competitive Positioning - Readiness OS | Readiness Infrastructure",
                ...
                <div style={{ padding: "48px 40px", background: "rgba(43,138,110,0.02)" }}>
                  ...
                  <div className="flex flex-col gap-0">
                    {[
                      ...
                      { label: "Readiness Protocol Selected", time: "+2m", note: "Best-fit Readiness Protocol matched automatically" },
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: 1, background: "rgba(255,255,255,0.06)", marginBottom: 24 }}>
              {[
                ...
                { label: "IBP / Planning Frameworks", ex: "S&OP · IBP · Governance Frameworks · Scenario Planning", gap: "2 of 12 partially (on paper)", verdict: "Define decision rights and governance in frameworks and planning cadences. Coherent on paper. The execution layer — pre-staged protocols, automatic team assembly — does not exist under pressure." },
                ...
                { label: "GRC / Risk Platforms", ex: "Archer · OneTrust · Riskonnect", gap: "2 of 12", verdict: "Risk mapping and governance documentation. Genuinely strong on compliance tracking and governance record. Doesn't activate the coordinated response when the risk materializes." },
                { label: "BCP / Incident Response Tools", ex: "Everbridge · Fusion · Castellan", gap: "2–3 of 12 (continuity scope)", verdict: "Designed for continuity and operational incidents — solid within that scope. Doesn't cover activist investor, M&A, regulatory inquiry, or competitive disruption." },
