      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] flex-shrink-0 p-12" style={{ background: NAVY }}>
        ...
        <div>
          ...
          <p className="text-sm mb-8" style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7 }}>
            Request access and get an activation link instantly. Your 48-hour session unlocks every capability — live trigger detection, 180 Readiness Protocols, Mission Control, and the complete IDEA Framework.
          </p>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <p className="text-xs text-center" style={{ color: "#9CA3AF" }}>
                ...
                <a href="/request-access" style={{ color: GOLD }}>Founding Partner Program</a>.
              </p>
            </form>
          </Form>
        </div>
