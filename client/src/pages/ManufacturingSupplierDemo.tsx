          ...
          <div className="max-w-5xl mx-auto space-y-8">
            <Card className="p-8 bg-white/5 border-white/10">
              <div className="text-center mb-8">
                <Factory className="w-16 h-16 text-[#C9A84C] mx-auto mb-4" />
                <h2 className="text-3xl font-bold text-[#C9A84C] mb-3" style={{ fontFamily: "'Cormorant Garamond', serif" }}>{manufacturingDemoData.crisis.title}</h2>
                    ...
                    {manufacturingDemoData.stakeholderTiers && (
                      <>
                        ...
                        <Card className="p-6 bg-white/5 border-white/10">
                          ...
                          <div className="text-3xl font-bold text-[#C9A84C] mb-3" style={{ fontFamily: "'Cormorant Garamond', serif" }}>{manufacturingDemoData.stakeholderTiers.tier2.count}</div>
                          <div className="text-xs text-white/40">
