...
const scheduledTasks = [
  ...
  {
    id: 4,
    name: 'Readiness Protocol Learning Extraction',
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { name: "Readiness Protocol Engine", latency: "32ms", status: "live", uptime: "99.99%" },
              ...
              {[
                {
                  ...
                  body: "Oracle reduced enterprise licensing by 12% in 3 markets. Readiness Protocol 'Competitive Price Response' pre-staged and ready. Recommend executive review within 6 hours.",
                  urgency: "HIGH",
                  urgencyColor: "#dc2626",
                },
                {
