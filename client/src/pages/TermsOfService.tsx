  ...
  const sections = [
    {
      ...
      body: `By accessing or using the Execution OS platform, website, or any associated services operated by ${COMPANY} ("VaughnMartin," "we," "us," or "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the platform.`,
    },
    {
      id: "ip",
      title: "2. Intellectual Property",
      body: `All content on this platform — including but not limited to the IDEA Framework™, the 170 strategic playbooks, trigger patterns, signal scoring methodology, written copy, visual design, software architecture, and the VaughnMartin and Execution OS trademarks — is the exclusive intellectual property of ${COMPANY} and is protected by United States and international copyright, trademark, and trade secret law.\n\nThe IDEA Framework™ (IDENTIFY, DETECT, EXECUTE, ADVANCE), the "3,600× Execution Head Start" methodology, and the playbook content represent proprietary operational knowledge developed over years of enterprise experience. These materials may not be reproduced, distributed, modified, reverse-engineered, or used to create derivative works without express written permission from VaughnMartin.`,
    },
    {
      id: "prohibited",
      title: "3. Prohibited Uses",
      body: `You agree that you will NOT:\n\n(a) Use any automated tool, bot, crawler, scraper, spider, agent, or AI system to access, copy, index, or reconstruct any portion of the platform, its content, its API responses, or its underlying methodology;\n\n(b) Use the platform's public demo, marketing materials, or API endpoints to reconstruct, replicate, or train any system intended to compete with or approximate VaughnMartin's products or services;\n\n(c) Access or attempt to access any API endpoint, playbook content, or platform feature in a manner that exceeds authorized access or circumvents access controls;\n\n(d) Copy, reproduce, republish, or redistribute the playbook library, trigger patterns, signal scoring logic, or IDEA Framework methodology in any form;\n\n(e) Use VaughnMartin, Execution OS, or IDEA Framework as a trademark, service mark, trade name, or product name without express written authorization;\n\n(f) Represent any product or service as affiliated with, endorsed by, or derived from VaughnMartin or Execution OS without authorization.`,
    },
    {
      id: "api",
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div style={{ background: "#fff", border: `1px solid ${BORDER}`, borderLeft: `4px solid ${GOLD}`, padding: "20px 24px", marginBottom: 40 }}>
            <p style={{ fontSize: 13, color: NAVY, lineHeight: 1.7, margin: 0, fontWeight: 500 }}>
              VaughnMartin's Execution OS platform, playbook library, IDEA Framework™, and all associated methodologies represent proprietary intellectual property. These Terms exist to protect that work and to make clear what is and is not permitted. Please read them carefully before using this platform.
            </p>
          </div>
          ...
          <p style={{ marginTop: 24, fontSize: 12, color: MUTED }}>
            © {new Date().getFullYear()} {COMPANY}. All rights reserved. VaughnMartin, Execution OS, and IDEA Framework are trademarks of {COMPANY}.
          </p>
        </div>
      </div>
    </PageLayout>
