        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div style={{ background: "#fff", border: `1px solid ${BORDER}`, borderLeft: `4px solid ${GOLD}`, padding: "20px 24px", marginBottom: 40 }}>
            <p style={{ fontSize: 13, color: NAVY, lineHeight: 1.7, margin: 0, fontWeight: 500 }}>
              VaughnMartin's Readiness OS platform, playbook library, IDEA Framework™, and all associated methodologies represent proprietary intellectual property. These Terms exist to protect that work and to make clear what is and is not permitted. Please read them carefully before using this platform.
            </p>
          </div>
