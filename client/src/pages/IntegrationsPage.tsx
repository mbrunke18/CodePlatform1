          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-white/60 text-xl leading-relaxed max-w-2xl">
                Readiness OS doesn't replace your workflow tools — it coordinates them. When a Readiness Protocol 
        ...
        <div className="p-12 max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-8 rounded-none border-[#E8E4DC] bg-white hover:border-[#C9A84C] transition-colors">
              ...
              <p className="text-sm text-[#6B7280] leading-relaxed">Strategic Readiness Protocols trigger coordinated actions across your entire enterprise stack.</p>
            </Card>
            <Card className="p-8 rounded-none border-[#E8E4DC] bg-white hover:border-[#C9A84C] transition-colors">
              <div style={{ width: 28, height: 1, background: '#C9A84C', marginBottom: 20 }} />
