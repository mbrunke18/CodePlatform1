          ...
          <Card className="bg-[#0A0F2E] border-none rounded-none shadow-xl overflow-hidden relative">
            ...
            <CardContent className="p-10 pt-4 relative z-10 space-y-8">
              <p className="text-white/80 text-lg leading-relaxed max-w-4xl">
                Poise provides the <strong className="text-white font-black">execution infrastructure</strong> that McKinsey, IBM, Bain, and BCG all say is missing—governance, decision rights, and coordination systems built <em className="italic">before</em> the moment hits.
              </p>
              ...
              <div className="p-10 md:w-1/3 bg-[#F8F7F4] flex flex-col justify-center">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="text-[9px] font-bold uppercase tracking-widest text-[#2B8A6E]">Poise Velocity</div>
                  </div>
