        ...
        <div style={{ background: NAVY, padding: "64px 48px", margin: "-32px -32px 32px -32px", position: "relative", overflow: "hidden" }}>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 9, fontWeight: 700, letterSpacing: "0.4em", textTransform: "uppercase" as const, color: GOLD }}>Performance Analytics</span>
            </div>
          ...
          <Card className="bg-[#0A0F2E] border-none rounded-none shadow-xl overflow-hidden relative">
            ...
            <CardContent className="p-10 pt-4 relative z-10 space-y-8">
              <p className="text-white/80 text-lg leading-relaxed max-w-4xl">
                Execution OS provides the <strong className="text-white font-black">execution infrastructure</strong> that McKinsey, IBM, Bain, and BCG all say is missing—governance, decision rights, and coordination systems built <em className="italic">before</em> the moment hits.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-8 rounded-none">
                ...
                <div className="space-y-3 text-sm text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-2"><strong>170 Playbooks</strong> <span>9 Domains</span></div>
              ...
              <div className="bg-white p-8 rounded-none border-l-4 border-[#C9A84C]">
                ...
                <p className="text-[#6B7280] leading-relaxed">
                  ...
                  Execution OS gives you that infrastructure on <strong className="text-[#0A0F2E]">day one</strong>—170 playbooks, pre-defined governance, and a compressed 12-minute execution cycle.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="p-10 md:w-2/3 border-r border-[#F8F7F4]">
                <CardHeader className="px-0 pt-0 mb-6">
                  ...
                  <p className="text-[#0A0F2E] text-lg leading-relaxed">
                    ...
                    While competitors coordinate through email chains and emergency meetings, Execution OS practitioners execute in minutes.
                  </p>
                  <p className="text-[#6B7280] leading-relaxed">
                    After 10 strategic events, an Execution OS-powered organization is <strong className="text-[#0A0F2E]">50 days ahead</strong> of the competition—the difference between a category leader and a market follower.
                  </p>
              </div>
              <div className="p-10 md:w-1/3 bg-[#F8F7F4] flex flex-col justify-center">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="text-[9px] font-bold uppercase tracking-widest text-[#2B8A6E]">Execution OS Velocity</div>
                  </div>
