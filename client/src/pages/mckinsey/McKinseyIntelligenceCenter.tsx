              ...
              <div className="pt-4 border-t space-y-3">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-[#0A0F2E]" data-testid="value-speed-improvement">3,600× faster</span>
                  </div>
                  <div className="flex items-center justify-between">
      ...
      <Card className="border-primary/20 bg-primary/5" data-testid="card-cta">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Transform with Readiness OS + McKinsey
          </CardTitle>
          <CardDescription>
            Combine McKinsey's research-backed framework with Readiness OS' 12-minute execution velocity to achieve sustainable transformation
          </CardDescription>
        </CardHeader>
        <CardContent>
