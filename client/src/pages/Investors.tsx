...
const scenarioComparisons = [
  ...
  },
  {
    ...
    speedup: "3,600×",
    context: "Incident playbook fires on detection. Containment steps, legal holds, regulator notifications, and board briefing all coordinate in parallel — not sequence.",
  },
  {
...
const competitiveAdvantages = [
  {
    ...
    description: "170 pre-built playbooks across 9 strategic domains represent 18+ months of strategic planning already done for customers.",
    icon: Zap,
  },
  {
...
const researchCitations = [
  ...
  { id: 8, source: "Gartner", title: "AI Technology Stack", year: "2026", finding: "Nine layers of enterprise AI investment mapped — from infrastructure to solutions — with no operating model layer identified to orchestrate execution. That gap is the market Execution OS serves." },
];
      ...
      <div className="border-t border-[#E8E4DC] pt-6">
        ...
        <div className="flex items-center gap-0">
          {[
            ...
            { label: "Category Leader", sub: "Strategic Execution OS standard", color: GOLD },
          ].map((stage, i) => (
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            ...
            <p className="text-xl text-[#0A0F2E]/70 max-w-3xl mx-auto mb-8 font-medium">
              Execution OS transforms how enterprises respond to strategic events — in 12 minutes you're in full execution mode while competitors spend 30 days just figuring out who needs to be in the room, what work is needed, and what plan to put together.
            </p>
