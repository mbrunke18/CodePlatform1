      ...
      <div className="container mx-auto px-4 py-12 pt-24 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-amber-300 max-w-3xl mx-auto">
            Experience how ExecuteIQ prevents catastrophic infrastructure failure through coordinated response—
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            <Card className="p-8 bg-gradient-to-r from-amber-950 to-orange-950 border-amber-500 border-2">
              ...
              <p className="text-lg text-amber-200 mb-4">
                Watch ExecuteIQ orchestrate grid stabilization across 247 substations, 47 hospitals, federal agencies, 
        ...
        {currentAct === "outcome" && (
          <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <Card className="p-8 bg-slate-900 border-amber-500">
              <h3 className="text-2xl font-bold mb-4 text-white">The ExecuteIQ Difference</h3>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h4 className="font-semibold text-green-400 mb-2">✓ ExecuteIQ Coordination</h4>
                  <ul className="text-sm text-slate-300 space-y-1">
