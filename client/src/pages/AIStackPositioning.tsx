...
const STACK_LAYERS = [
  {
    ...
    readinessItems: ["180 cross-industry Readiness Protocols", "231 pre-mapped trigger scenarios", "12-minute mobilization vs. 30-day baseline", "3,600× execution head start"],
    highlight: true,
    color: GOLD,
    badge: "PRIMARY LAYER",
  ...
  },
  {
    ...
    readinessRole: "Signal intelligence layer. Continuous monitoring of 39 live feeds scored against 231 trigger patterns, with semantic embedding-based similarity scoring augmenting keyword evaluation. Activation history forms the long-term institutional memory layer.",
    readinessItems: ["39 pre-configured signal sources, every 15 minutes", "231 trigger patterns — keyword + semantic embedding scoring", "Semantic similarity via text-embedding-3-small cosine match", "Institutional memory: activation records, debriefs, outcome data"],
    highlight: false,
    color: TEAL,
    badge: "INTELLIGENCE",
    badgeBg: "rgba(43,138,110,0.1)",
