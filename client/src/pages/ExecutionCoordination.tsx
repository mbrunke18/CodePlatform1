...
const statusConfig = {
  pending: { color: 'bg-slate-200 text-slate-400', icon: Circle, label: 'Pending' },
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          >
            ...
            <p className={`text-sm ${activeCategory === 'offense' ? 'text-emerald-700 dark:text-emerald-300 font-medium' : 'text-slate-400 dark:text-slate-300'}`}>
          ...
          >
            ...
            <p className={`text-sm ${activeCategory === 'defense' ? 'text-blue-700 dark:text-blue-300 font-medium' : 'text-slate-400 dark:text-slate-300'}`}>
          ...
          >
            ...
            <p className={`text-sm ${activeCategory === 'special_teams' ? 'text-purple-700 dark:text-purple-300 font-medium' : 'text-slate-400 dark:text-slate-300'}`}>
                        ...
                        <div className="flex items-center gap-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center ${phaseComplete ? 'bg-emerald-500' : 'bg-slate-200 dark:bg-slate-700'}`}>
                            {phaseComplete ? (
                              ...
                              <span className="text-sm font-bold text-slate-400 dark:text-slate-300">{phaseIndex + 1}</span>
                            )}
                          </div>
                          <div>
