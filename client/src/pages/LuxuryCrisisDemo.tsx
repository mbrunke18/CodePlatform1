          ...
          <div className="space-y-8">
            ...
            <div className="text-center">
              ...
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.35)", marginTop: 8 }}>
                Experience how Readiness OS transforms AI detection into coordinated execution — turning a {crisisScenario.financialImpact} crisis into a strategic advantage in 12 minutes.
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div style={{ width: 20, height: 1.5, background: GOLD }} />
                <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: GOLD }}>Readiness OS 12-Minute Stakeholder Cascade</span>
              </div>
            ...
            <div className="text-center pt-2">
              ...
              <p style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", marginTop: 12 }}>Interactive simulation — AI detects, Readiness OS coordinates your Maisons and VIP clients simultaneously</p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            <Card className="p-12 bg-white/5 border-white/10 text-center">
              ...
              <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", maxWidth: 560, margin: "0 auto 32px" }}>
                You've just experienced how Readiness OS turns the gap between AI detection and human execution — from weeks of coordination chaos to 12 minutes of orchestrated brand protection.
              </p>
              ...
              <div className="p-6 border-2 border-[#C9A84C]/50 mb-8 text-left" style={{ background: "rgba(201,168,76,0.05)" }}>
                ...
                <p style={{ fontSize: 13, color: "rgba(255,255,255,0.7)", lineHeight: 1.75 }}>
                  Luxury brands are spending billions on AI for threat detection and social monitoring. But without Readiness OS, they're still losing the critical first 12 minutes to coordination chaos — manual phone trees, unclear accountability, and delayed VIP client communication that cannot be undone. Readiness OS is the missing piece: the operating model layer that turns detection into coordinated protection, before the narrative escapes.
                </p>
              </div>
