            ...
            <>
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-3"><h2 className="text-3xl font-bold text-[#0A0F2E]" style={CG}>The IDEA Framework™</h2><Badge className="bg-[#C9A84C] text-[#0A0F2E] border-none px-3 py-1 font-bold uppercase tracking-wider">Continuously Monitored</Badge></div>
