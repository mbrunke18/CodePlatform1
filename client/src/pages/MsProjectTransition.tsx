...
const COMPARISON_ROWS = [
  ...
  { dimension: "Mobilization Lag", them: "30-day cycle (same as MS Project — tool changed, model didn't)", us: "Eliminated — 170 playbooks pre-staged and ready" },
  ...
  { dimension: "Playbooks", them: "Custom templates — weeks to configure", us: "170 pre-built, battle-tested readiness playbooks" },
