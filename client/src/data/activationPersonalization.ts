...
export const ROLE_OVERLAYS: Record<string, RoleOverlay> = {
  ...
  cto: {
    ...
    completionMetrics: [
      { label: 'Technology Integration', before: '36 months average', after: '22 months with ExecuteIQ' },
  ...
  cdo: {
    ...
    completionMetrics: [
      { label: 'Data Signal to Action', before: '14 days average', after: '2 hours with ExecuteIQ' },
  ...
  cco: {
    ...
    completionMetrics: [
      { label: 'Audit Response', before: '10 business days', after: '2 days with ExecuteIQ' },
  ...
  cso: {
    ...
    completionMetrics: [
      { label: 'Strategy Execution', before: '70% on-time delivery', after: '95% with ExecuteIQ coordination' },
