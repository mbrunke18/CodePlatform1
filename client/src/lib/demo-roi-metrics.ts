...
export const enhancedTemplateLibrary = {
  totalTemplates: 170, // 180 playbook library across 9 domains (including AI Governance)
        ...
        tasks: [
          {
            ...
            description: 'IF CFO approved → Update pricing system, activate promotional codes, sync with billing platform',
            role: 'COO',
            estimatedMinutes: 3,
            priority: 'high',
        ...
        tasks: [
          {
            ...
            description: 'AFTER Operations deployed → Email customers new value proposition, update website messaging, brief executive team',
            role: 'CCO',
            estimatedMinutes: 4,
            priority: 'high',
          ...
          },
          {
            ...
            description: 'AFTER Product activated → Equip sales team with new positioning, update CRM messaging, activate competitive win-back campaign',
            role: 'CRO',
            estimatedMinutes: 3,
            priority: 'high',
        ...
        tasks: [
          {
            ...
            description: 'IF CTO approved → Activate audit prep team, fast-track documentation, schedule daily war room meetings',
            role: 'Compliance',
            estimatedMinutes: 3,
            priority: 'high',
          ...
          },
          {
            ...
            description: 'IF Legal identified gaps → Contact all vendors for security certifications, audit reports, data processing agreements',
            role: 'Procurement',
            estimatedMinutes: 3,
            priority: 'high',
        ...
        tasks: [
          {
            ...
            description: 'AFTER Compliance mobilized → Prepare board memo, schedule emergency board call if needed, draft public statement contingency',
          ...
          },
          {
            ...
            description: 'AFTER Vendor docs requested → Schedule pre-audit walkthrough, identify quick wins, establish remediation timeline',
