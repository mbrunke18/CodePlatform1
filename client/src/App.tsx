...
const VideoBrief = lazy(() => import("./pages/VideoBrief"));
...
const PreparationDiagnostic = lazy(() => import("./pages/PreparationDiagnostic"));
...
const TierComparisonDemo = lazy(() => import("./pages/TierComparisonDemo"));
...
const QuarterlyReadinessPlanning = lazy(() => import("./pages/QuarterlyReadinessPlanning"));
  ...
  return (
    <DemoTimelineProvider defaultDuration={720000} defaultSpeedMultiplier={20}>
      <DemoControllerProvider>
        ...
        <Route path="/quarterly-planning" component={QuarterlyReadinessPlanning} />
        ...
        <Route path="/preparation-diagnostic" component={PreparationDiagnostic} />
        ...
        <Route path="/tier-comparison" component={TierComparisonDemo} />
        ...
        <Route path="/situations" component={lazy(() => import('./pages/SituationsIndex'))} />
