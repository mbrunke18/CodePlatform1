...
export const playbooksData: PlaybooksDataset = {
  "playbooks": [
    ...
    {
      "number": 196,
      "protocol_code": "CP-196",
      "name": "Compound: IPO Pricing Window + Adverse Media Event",
      "trigger": "Material adverse news — product liability allegation, key customer loss, securities fraud claim, or executive misconduct — breaks publicly during the live IPO roadshow window, forcing a simultaneous investor relations crisis and securities disclosure decision under SEC quiet period constraints",
      "stakeholders": ["CEO", "CFO", "General Counsel", "Lead Underwriter", "IR Counsel", "Board Chair", "Communications Lead", "SEC Outside Counsel"],
      "response": "Dual-track IPO defense protocol activated — securities counsel and underwriters convene within 2 hours to assess materiality and determine whether a roadshow pause, prospectus amendment, or pricing window extension is required, while communications team executes a controlled response that satisfies disclosure obligations without triggering automatic SEC review that delays the offering. Without pre-staged coordination between legal, underwriting, and communications, the silence required by quiet period rules is misread as evasion — institutional investors pull orders before the materiality determination is complete, and the offering either prices at a 20–40% discount or is withdrawn entirely.",
      "response_window": "2 hours",
      "financial_exposure": "$50M–$500M in IPO valuation erosion; withdrawn offering costs $10M–$30M in sunk underwriting and legal fees plus 12–18 month re-entry delay",
      "domain": 3,
      "frequency": "low",
      "budget": 5000000,
      "compound": true
    ...
    {
      "number": 197,
      "protocol_code": "CP-197",
      "name": "Compound: Labor Strike + Supply Chain Collapse",
      "trigger": "Simultaneous union work stoppage at primary manufacturing facilities and failure of a Tier-1 supplier creates a compounding production shutdown — neither event alone would halt operations, but together they eliminate all manufacturing capacity with no recovery path using standard contingency plans",
      "stakeholders": ["CEO", "COO", "CHRO", "VP Supply Chain", "CFO", "VP Manufacturing", "General Counsel", "Board Operations Committee"],
      "response": "Tri-track activation of labor negotiation, emergency supplier qualification, and customer allocation management — a senior executive mediator engages the union directly within 4 hours while procurement simultaneously qualifies emergency alternative suppliers and a customer prioritization algorithm determines which orders are protected, which are deferred, and which trigger force majeure notifications. Without simultaneous execution of all three tracks, resolving the labor dispute reveals no supplier to restart with, and emergency sourcing proceeds while the union dispute remains unresolved — the sequential approach extends full production shutdown by 60–90 days beyond what simultaneous execution requires.",
      "response_window": "4 hours",
      "financial_exposure": "$5M–$20M per week in lost production plus $15M–$80M in customer penalties, emergency sourcing premiums, and permanent market share loss to competitors",
      "domain": 2,
      "frequency": "low",
      "budget": 12000000,
      "compound": true
    ...
    {
      "number": 198,
      "protocol_code": "CP-198",
      "name": "Compound: Credit Rating Downgrade + Debt Covenant Breach",
      "trigger": "Rating agency downgrade (Moody's, S&P, or Fitch) automatically triggers cross-default clauses and financial maintenance covenant violations across multiple debt instruments simultaneously — converting a reputational event into an immediate liquidity and solvency event requiring lender negotiation within hours, not weeks",
      "stakeholders": ["CEO", "CFO", "General Counsel", "Board Finance Committee Chair", "Investment Banker", "Lead Lenders", "Chief Accounting Officer", "Restructuring Counsel"],
      "response": "Simultaneous covenant waiver negotiation across all affected lending facilities — CFO and restructuring counsel convene emergency lender calls within 6 hours of downgrade confirmation to negotiate 60–90 day waiver agreements before cross-default acceleration rights mature, while the Board Finance Committee pre-approves the concessions required to secure waivers without a full board convening delay. Without pre-staged lender relationship protocols and pre-approved waiver parameters, each lender negotiates independently — the first to accelerate triggers cross-default clauses that give every other lender the same right, converting a manageable covenant cure into an uncontrolled debt acceleration event.",
      "response_window": "6 hours",
      "financial_exposure": "$50M–$2B in accelerated debt obligations if cross-default cascade is not contained; waiver negotiation costs $2M–$10M but avoids restructuring costs of $50M–$200M",
      "domain": 3,
      "frequency": "low",
      "budget": 8000000,
      "compound": true
    ...
    {
      "number": 199,
      "protocol_code": "CP-199",
      "name": "Compound: C-Suite Fraud Discovery + Board Governance Failure",
      "trigger": "Internal audit or whistleblower reveals material financial fraud by a C-suite executive simultaneously with evidence that audit committee oversight failures allowed the fraud to persist — creating simultaneous criminal exposure, SEC enforcement risk, shareholder litigation, and a board credibility crisis that disqualifies the oversight body from leading the internal investigation",
      "stakeholders": ["Board Chair", "Independent Directors", "External Forensic Auditor", "Special Committee Counsel", "Communications Counsel", "SEC Outside Counsel", "Criminal Defense Counsel"],
      "response": "Independent Special Committee of outside directors constituted within 12 hours — separate from any directors with audit committee responsibility — to lead the forensic investigation, manage SEC voluntary disclosure strategy, and determine officer termination authority, while criminal defense counsel and civil litigation counsel are engaged simultaneously to preserve privilege across all tracks. Without pre-staged Special Committee governance protocols, the tainted audit committee attempts to self-investigate, producing findings that regulators reject, shareholders use to establish board complicity, and prosecutors use to extend criminal exposure beyond the individual officer to the institution itself.",
      "response_window": "12 hours",
      "financial_exposure": "$25M–$500M in SEC fines, criminal penalties, and shareholder litigation; board governance failure that prevents independent investigation can convert individual misconduct into enterprise criminal liability",
      "domain": 4,
      "frequency": "low",
      "budget": 20000000,
      "compound": true
    ...
    {
      "number": 200,
      "protocol_code": "CP-200",
      "name": "Compound: Pandemic / Health Crisis + Workforce Availability Collapse",
      "trigger": "Rapid-onset regional or global health event reduces available workforce to below operational minimums simultaneously across multiple facilities or functions — triggering a cascade of customer SLA failures, regulatory compliance gaps (functions requiring licensed personnel), and reputational crisis from service degradation that cannot be solved by remote work or standard business continuity plans",
      "stakeholders": ["CEO", "COO", "CHRO", "Chief Medical Officer", "CFO", "VP Operations", "Legal Counsel", "Communications Lead"],
      "response": "Five-track crisis activation covering workforce triage, operational triage, customer communication, regulatory compliance preservation, and supply continuity — essential functions are ranked by revenue and regulatory criticality within 4 hours, cross-trained personnel are redeployed across function lines, and regulators are proactively notified of compliance capacity constraints before violations occur so that good-faith notifications receive leniency treatment rather than enforcement action. Without pre-staged workforce criticality rankings and cross-training records, the redeployment decision becomes a 2-week consensus process while operations degrade — by the time functions are reprioritized, enterprise customers have already activated their own contingency sourcing and regulators have opened compliance inquiries.",
      "response_window": "4 hours",
      "financial_exposure": "$10M–$200M in revenue loss, SLA penalties, and regulatory fines; permanent customer attrition from competitors who maintained service continuity adds $20M–$150M in long-term impact",
      "domain": 2,
      "frequency": "low",
      "budget": 15000000,
      "compound": true
    ...
    {
      "number": 201,
      "protocol_code": "CP-201",
      "name": "Compound: IP Theft + Active Competitive Exploitation",
      "trigger": "Forensic evidence confirms intellectual property exfiltration — source code, formulas, customer lists, or trade secrets — simultaneously with market intelligence indicating a competitor is actively using the stolen material in products already in development or released, compressing the legal remediation window before the IP advantage is permanently lost",
      "stakeholders": ["CEO", "General Counsel", "CISO", "Chief Product Officer", "IP Litigation Counsel", "Forensic Investigator", "Board Chair", "Communications Lead"],
      "response": "Simultaneous activation of emergency TRO (temporary restraining order) proceedings, criminal referral to FBI Cyber Division, and accelerated internal product roadmap to replace compromised IP advantages — legal team files for injunctive relief within 48 hours while product team identifies which competitive advantages remain uncompromised and accelerates the development roadmap to obsolete the stolen assets before they reach market. Without simultaneous legal and product track execution, a sequential approach — investigate first, then litigate, then adapt the roadmap — allows the competitor to ship product incorporating stolen IP before any injunction can be obtained, permanently eroding the advantage that the IP represented.",
      "response_window": "48 hours",
      "financial_exposure": "$20M–$500M in competitive advantage erosion; legal remedies recover 20–40 cents on the dollar of IP value — pre-staged response preserves the injunctive window that is lost after 72 hours of commercial exploitation",
      "domain": 5,
      "frequency": "low",
      "budget": 10000000,
      "compound": true
    ...
    {
      "number": 202,
      "protocol_code": "CP-202",
      "name": "Compound: Natural Disaster + Infrastructure Cascade Failure",
      "trigger": "Physical catastrophe (earthquake, flood, hurricane, wildfire) simultaneously destroys or disables primary data center, backup infrastructure, and key personnel availability in the same geographic region — standard business continuity plans that assume geographic separation of primary and backup fail because both are within the disaster zone",
      "stakeholders": ["CEO", "CTO", "COO", "CISO", "CFO", "VP Operations", "Insurance Counsel", "Business Continuity Lead"],
      "response": "Emergency infrastructure reconstitution protocol activates cloud failover to geographically separated regions within 2 hours — pre-authorized cloud spend limits allow CTO to commit $500K–$5M in emergency infrastructure spend without board approval delay, while COO simultaneously activates remote-work protocols for displaced personnel and General Counsel files insurance notices within the policy window. Without pre-authorized emergency cloud spend limits and pre-configured cross-region failover, infrastructure teams spend 48–72 hours in procurement and approval cycles while the business operates without systems — the approval delay causes more revenue loss than the disaster itself.",
      "response_window": "2 hours",
      "financial_exposure": "$5M–$100M in direct revenue loss per day of outage; infrastructure reconstitution costs $2M–$20M; insurance recovery averages 30–60% without pre-staged documentation protocols",
      "domain": 2,
      "frequency": "low",
      "budget": 10000000,
      "compound": true
    ...
    {
      "number": 203,
      "protocol_code": "CP-203",
      "name": "Compound: Antitrust Investigation + Strategic Partnership Collapse",
      "trigger": "DOJ or FTC antitrust investigation announcement causes a key strategic partner or joint venture co-investor to immediately suspend all joint commercial activity — citing their own legal exposure — simultaneously converting an antitrust defense challenge into an antitrust defense plus strategic asset collapse requiring separate legal and commercial remediation tracks",
      "stakeholders": ["CEO", "General Counsel", "Chief Strategy Officer", "CFO", "Antitrust Counsel", "M&A Counsel", "Board Chair", "Communications Lead"],
      "response": "Dual-track activation separating antitrust defense from partnership remediation — antitrust counsel manages DOJ/FTC engagement under strict privilege protocols while a separate M&A counsel team negotiates with the partner to preserve the commercial relationship through arm's-length restructuring that eliminates the antitrust exposure without terminating the partnership's strategic value. Without pre-staged separation of antitrust and commercial tracks, the partner's legal team treats all joint communications as potential antitrust evidence — they cease all cooperation, and the antitrust investigation converts a resolvable inquiry into a per se violation case built on the partner's own documentary record.",
      "response_window": "24 hours",
      "financial_exposure": "$30M–$300M in partnership value loss; antitrust fines of 10% of annual revenue if per se violation established; combined exposure escalates sharply when both tracks are managed sequentially",
      "domain": 4,
      "frequency": "low",
      "budget": 8000000,
      "compound": true
    ...
    {
      "number": 204,
      "protocol_code": "CP-204",
      "name": "Compound: Executive Misconduct + Brand Boycott + Advertiser Exodus",
      "trigger": "Senior executive personal conduct — public statement, personal behavior, or past association — triggers simultaneous organized consumer boycott, social media amplification, and advertiser suspension decisions, creating a triple-track brand and revenue crisis that unfolds across 24–48 hours faster than standard crisis response can mobilize",
      "stakeholders": ["CEO", "Board Chair", "CHRO", "CMO", "CFO", "Communications Lead", "Brand Counsel", "VP Strategic Accounts"],
      "response": "Simultaneous activation of executive separation protocol, advertiser retention outreach, and brand narrative repositioning — Board Chair personally calls the top 10 advertisers by revenue contribution within 6 hours of the first advertiser suspension announcement with a concrete remediation timeline, while communications team executes a pre-staged brand statement that separates the institution from the individual without creating employment litigation exposure. Without pre-staged advertiser relationship protocols, brand teams spend 48 hours drafting statements while account managers have no authorization to commit remediation timelines — advertisers interpret the silence as institutional endorsement, and suspensions convert to permanent contract terminations.",
      "response_window": "4 hours",
      "financial_exposure": "$10M–$200M in advertiser revenue at risk within 72 hours; brand equity erosion of 5–15% requires $20M–$100M in marketing investment to restore over 12–24 months",
      "domain": 7,
      "frequency": "medium",
      "budget": 5000000,
      "compound": true
    ...
    {
      "number": 205,
      "protocol_code": "CP-205",
      "name": "Compound: Hostile Takeover Bid + Talent Retention Crisis",
      "trigger": "Unsolicited public acquisition bid at a premium simultaneously triggers board fiduciary defense obligations, shareholder activist pressure to accept, and a key talent retention crisis as acquirer's integration plans leak and top performers begin evaluating competing offers — creating a governance, legal, and human capital emergency that unfolds simultaneously",
      "stakeholders": ["Board Chair", "CEO", "General Counsel", "M&A Defense Counsel", "CHRO", "Investment Banker", "CFO", "Compensation Committee Chair"],
      "response": "Tri-track hostile takeover defense protocol activates simultaneously — M&A defense counsel and investment banker prepare board fiduciary analysis and defense mechanisms within 48 hours, while CHRO executes retention package authorizations for the top 50 key personnel identified in the pre-staged talent risk register, and communications team delivers a unified message to employees that preserves optionality without creating false promises. Without pre-staged retention authorizations and key talent identification, the board spends 2–3 weeks deliberating defensive strategy while the acquirer's recruiting team directly contacts top performers — by the time defensive decisions are made, 15–30% of key talent has already accepted retention packages from the acquirer or third parties.",
      "response_window": "48 hours",
      "financial_exposure": "$50M–$2B in enterprise value at risk if defense fails; talent attrition during a hostile bid reduces standalone value by 10–25%, undermining the board's ability to argue the company is worth more independent",
      "domain": 1,
      "frequency": "low",
      "budget": 25000000,
      "compound": true
    ...
    {
      "number": 206,
      "protocol_code": "CP-206",
      "name": "Compound: Product Safety Recall + Criminal Investigation + Mass Tort",
      "trigger": "Consumer safety incident triggers simultaneous CPSC or FDA mandatory recall, DOJ criminal investigation into executive knowledge of pre-existing safety data, and mass tort class action filing — creating three parallel legal tracks with directly conflicting strategies: recall cooperation, criminal defense privilege preservation, and civil litigation document hold obligations",
      "stakeholders": ["CEO", "General Counsel", "Chief Medical Officer", "Regulatory Affairs VP", "Criminal Defense Counsel", "Civil Litigation Counsel", "CFO", "Board Chair"],
      "response": "Three separate outside counsel teams activated simultaneously with a coordinating General Counsel who holds conflicts checks — criminal defense counsel manages executive privilege and Fifth Amendment considerations, civil litigation counsel implements litigation hold and manages discovery, and regulatory counsel manages the recall cooperation that is legally required regardless of criminal posture, with all three strategies reviewed for cross-track consistency before any external communication is issued. Without pre-staged three-track coordination, criminal defense counsel's advice to preserve privilege conflicts directly with civil discovery obligations and recall cooperation requirements — the conflict causes 2–4 week delays in all three tracks while a coordination structure is built from scratch under active government investigation.",
      "response_window": "6 hours",
      "financial_exposure": "$50M–$5B across recall costs, criminal fines, and mass tort settlements; coordinated three-track defense reduces total exposure by 30–50% compared to sequential track management",
      "domain": 4,
      "frequency": "low",
      "budget": 30000000,
      "compound": true
    ...
    {
      "number": 207,
      "protocol_code": "CP-207",
      "name": "Compound: Geopolitical Sanctions + Export Control Violation + Customer Force Majeure",
      "trigger": "New sanctions designation or export control rule expansion — OFAC, BIS, or EU — creates simultaneous technology export violations for products already shipped, customer contract force majeure claims from affected counterparties, and a supply chain compliance restructuring requirement under compressed government timelines",
      "stakeholders": ["CEO", "General Counsel", "Chief Compliance Officer", "CFO", "VP Global Sales", "Trade Sanctions Counsel", "Export Control Counsel", "Board Chair"],
      "response": "Tri-track sanctions response protocol activated — trade counsel files OFAC voluntary self-disclosure within the window that qualifies for penalty mitigation, customer-facing teams proactively communicate with affected counterparties before they file force majeure notices (converting adversarial claims into cooperative restructuring conversations), and compliance team executes immediate product and technology review to identify all exposure before government inquiry. Without proactive OFAC voluntary disclosure and simultaneous customer engagement, the government discovers the violation through third-party reporting rather than self-disclosure — losing the 25–75% penalty reduction that voluntary disclosure provides — while customers simultaneously file force majeure claims that convert into contract terminations.",
      "response_window": "24 hours",
      "financial_exposure": "$5M–$500M in sanctions penalties, debarment risk, and customer contract loss; voluntary disclosure reduces penalties by 25–75% compared to discovered violations",
      "domain": 4,
      "frequency": "low",
      "budget": 10000000,
      "compound": true
    ...
    {
      "number": 208,
      "protocol_code": "CP-208",
      "name": "Compound: Liquidity Crisis + Counterparty Default + Credit Line Revocation",
      "trigger": "Simultaneous cash flow crisis triggered by a major counterparty default and credit line revocation by a primary lender — individually each event is manageable, but together they eliminate both liquidity and the ability to access liquidity, creating a 48–72 hour insolvency window if restructuring or capital injection cannot be arranged before payroll, vendor payments, or bond coupon obligations fall due",
      "stakeholders": ["CEO", "CFO", "Board Chair", "Investment Banker", "Restructuring Counsel", "Chief Accounting Officer", "Primary Lender Relationship", "Creditors' Committee Counsel"],
      "response": "Simultaneous activation of emergency capital raise, creditor standstill negotiation, and asset liquidity assessment — restructuring counsel files for standstill agreements from all major creditors within 24 hours while investment banker initiates emergency bridge financing conversations and CFO executes a 30-day cash conservation protocol that extends the operational runway without triggering additional covenant violations. Without pre-staged creditor communication protocols and pre-authorized restructuring counsel engagement, the CFO spends 48 hours internally modeling options while the liquidity window closes — by the time external advisors are engaged, the creditors have already retained their own counsel and the negotiating dynamic has shifted from consensual restructuring to adversarial enforcement.",
      "response_window": "6 hours",
      "financial_exposure": "$10M–$2B in insolvency exposure; pre-staged restructuring response reduces the cost of capital in emergency financing by 200–500 basis points and avoids Chapter 11 filing costs of $20M–$100M",
      "domain": 3,
      "frequency": "low",
      "budget": 20000000,
      "compound": true
    ...
    {
      "number": 209,
      "protocol_code": "CP-209",
      "name": "Compound: Whistleblower SEC Submission + Media Leak + Internal Investigation Conflict",
      "trigger": "Simultaneous SEC whistleblower submission and media outlet contact by the same or related source — the media story publishes before the internal investigation can be structured, creating a public disclosure of unresolved allegations while the internal investigation team is conflicted by their prior exposure to the underlying conduct",
      "stakeholders": ["Board Chair", "General Counsel", "Audit Committee Chair", "SEC Outside Counsel", "Media Relations Counsel", "Special Investigative Counsel", "CFO", "Communications Lead"],
      "response": "Independent Special Investigative Counsel retained by the Audit Committee within 6 hours — separate from any attorney who has advised on the underlying subject matter — to lead the internal investigation under privilege while SEC outside counsel manages the whistleblower submission engagement, and media counsel coordinates a factual response to the published story that acknowledges the investigation without conceding facts that prejudice the SEC track. Without pre-staged Audit Committee retention protocols for independent investigative counsel, the General Counsel attempts to manage all three tracks simultaneously — creating a privilege conflict that the SEC uses to compel production of the internal investigation record and the media uses to characterize the response as a cover-up.",
      "response_window": "6 hours",
      "financial_exposure": "$10M–$300M in SEC fines, restatement costs, and class action exposure; the privilege conflict from uncoordinated internal investigation can double enforcement exposure",
      "domain": 4,
      "frequency": "medium",
      "budget": 12000000,
      "compound": true
    ...
    {
      "number": 210,
      "protocol_code": "CP-210",
      "name": "Compound: AI Model Failure + Regulatory Audit + Enterprise Customer Mass Churn",
      "trigger": "Deployed AI system produces widespread harmful, biased, or factually incorrect outputs affecting enterprise customers simultaneously — triggering an FTC or sector regulator audit, mass customer churn notifications, and reputational damage that compounds with each news cycle before the root cause is identified or the model is corrected",
      "stakeholders": ["CEO", "CTO", "Chief AI Officer", "General Counsel", "VP Customer Success", "Chief Risk Officer", "Communications Lead", "Regulatory Counsel"],
      "response": "Simultaneous activation of AI model suspension, enterprise customer retention protocol, and regulatory cooperation posture — affected model versions taken offline within 2 hours regardless of revenue impact while VP Customer Success personally contacts every enterprise account with a concrete remediation SLA and compensation offer, and regulatory counsel initiates proactive engagement with the auditing regulator before a formal inquiry is issued. Without pre-staged AI suspension authority and customer retention protocols, product teams spend 48–72 hours debating whether to suspend the revenue-generating model while enterprise customers receive no communication — each hour of silence converts concerned customers into churned customers, and each hour of model operation adds to the regulatory harm record.",
      "response_window": "2 hours",
      "financial_exposure": "$5M–$150M in enterprise customer churn; regulatory fines of $10M–$500M depending on sector (financial services, healthcare, federal contractors face highest exposure); brand damage requires $20M–$80M in remediation investment",
      "domain": 9,
      "frequency": "medium",
      "budget": 15000000,
      "compound": true
