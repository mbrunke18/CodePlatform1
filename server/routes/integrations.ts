  ...
  try {
    const availableIntegrations = [
      ...
      },
      {
        ...
        description: 'Readiness OS injects protocol context into Copilot Studio so every executive query during an activation returns protocol-aligned guidance — not generic AI answers.',
        capabilities: ['context_injection', 'executive_query_alignment', 'protocol_aware_responses', 'post_activation_learning'],
        logo: '/integrations/microsoft.svg',
        status: 'available',
        stack: 'microsoft',
      },
      {
        ...
        vendor: 'microsoft',
        category: 'directory',
        description: 'Stakeholder identity and role resolution from Entra ID — every Readiness Protocol knows exactly who to notify and what authority they hold before the trigger fires.',
        capabilities: ['identity_resolution', 'role_mapping', 'authority_chains', 'stakeholder_pre-staging'],
        logo: '/integrations/microsoft.svg',
        status: 'available',
        stack: 'microsoft',
      },
      {
        ...
        vendor: 'microsoft',
        category: 'ai_orchestration',
        description: 'All Readiness OS signal analysis, protocol staging, and hypothesis measurement runs on your organization\'s Azure OpenAI deployment — data stays inside your Microsoft tenant.',
        capabilities: ['signal_analysis', 'protocol_staging', 'hypothesis_measurement', 'tenant_isolation'],
        logo: '/integrations/microsoft.svg',
        status: 'available',
        stack: 'microsoft',
      },
