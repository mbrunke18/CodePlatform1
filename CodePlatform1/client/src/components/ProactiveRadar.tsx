          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card data-testid="card-system-status">
              ...
              <CardContent>
                ...
                <div className="mt-2 text-xs text-gray-600 dark:text-gray-300" data-testid="text-last-scan">
            ...
            <Card data-testid="card-data-streams">
              ...
              <CardContent>
                ...
                <div className="text-xs text-gray-600 dark:text-gray-300">Active Monitoring</div>
                <Progress 
            ...
            <Card data-testid="card-alert-triggers">
              ...
              <CardContent>
                ...
                <div className="text-xs text-gray-600 dark:text-gray-300">Ready to Alert</div>
                <Progress 
