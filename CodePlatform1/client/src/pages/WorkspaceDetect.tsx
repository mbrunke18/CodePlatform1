      ...
      <div className="min-h-screen bg-[#F8F7F4] dark:bg-[#0A0F2E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <nav className="flex items-center gap-2 text-sm mb-6">
            ...
            <span className="text-[#0A0F2E] dark:text-[#C9A84C] font-bold uppercase tracking-wider">DETECT</span>
          </nav>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <Badge className="bg-[#0A0F2E] text-[#C9A84C] border-[#C9A84C]/20 px-3 py-1 font-bold uppercase tracking-wider">
                    DETECT
                  </Badge>
                </div>
          ...
          <Card className="mb-8 border-[#E8E4DC] dark:border-[#C9A84C]/10 bg-white dark:bg-white/5">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-[#6B7280] dark:text-[#C9A84C]/60">Phase 2 of 4</span>
              </div>
              <div className="flex items-center gap-4">
            ...
            {signalCategories.map((category) => (
              <Card key={category.name} className="border-[#E8E4DC] dark:border-[#C9A84C]/10 bg-white dark:bg-white/5 hover:shadow-lg transition-shadow">
                <CardContent className="p-4">
                  ...
                  <p className="text-xs text-[#6B7280] dark:text-[#C9A84C]/60">{category.name}</p>
                </CardContent>
              </Card>
            ))}
          </div>
            ...
            <Card className="border-[#E8E4DC] dark:border-[#C9A84C]/10 bg-white dark:bg-white/5 hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-xs text-[#6B7280] dark:text-[#C9A84C]/60 whitespace-nowrap">14 min ago</span>
                </div>
              </CardContent>
            </Card>
            <Card className="border-[#E8E4DC] dark:border-[#C9A84C]/10 bg-white dark:bg-white/5 hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-xs text-[#6B7280] dark:text-[#C9A84C]/60 whitespace-nowrap">2 hours ago</span>
                </div>
              </CardContent>
            </Card>
            <Card className="border-[#E8E4DC] dark:border-[#C9A84C]/10 bg-white dark:bg-white/5 hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-xs text-[#6B7280] dark:text-[#C9A84C]/60 whitespace-nowrap">4 hours ago</span>
                </div>
              </CardContent>
            </Card>
            <Card className="border-[#E8E4DC] dark:border-[#C9A84C]/10 bg-white dark:bg-white/5 hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <Badge className="bg-[#2B8A6E] text-white border-none flex-shrink-0">Medium</Badge>
                  <span className="text-xs text-[#6B7280] dark:text-[#C9A84C]/60 whitespace-nowrap">6 hours ago</span>
                </div>
              </CardContent>
            </Card>
          </div>
